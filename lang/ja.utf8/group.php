...
$string['groupmembershipchangedmessagedeclinerequest'] = 'このグループに対するあなたの参加リクエストは拒否されました。';
...
$string['Joined'] = '登録';
$string['membersdescription:invite'] = 'これは「招待のみ」グループです。あなたはユーザをユーザプロファイルページより招待、または<a href="%s">一度に複数の招待を送信することができます</a>。';
