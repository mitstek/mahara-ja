 ...
 * @updated    2010-05-15 04:54:47 UTC
...
$string['addedtogroupmessage'] = '%s があなたをグループ「 %s 」に追加しました。グループを表示するには、下記リンクをクリックしてください。';
...
$string['joinedgroup'] = 'あなたは、グループメンバーになりました。';
...
$string['groupjointypeopen'] = 'このグループのメンバーシップは、オープンです。自由に参加してください!';
$string['groupjointypecontrolled'] = 'このグループのメンバーシップは、管理されています。あなたは、このグループに参加できません。';
$string['groupjointypeinvite'] = 'このグループのメンバーシップは、招待のみです。';
$string['groupjointyperequest'] = 'このグループのメンバーシップは、リクエストのみです。';
...
$string['addedtofriendslistmessage'] = '%s があなたをフレンドとして追加しました! これは、あなたのフレンドリストに %s が追加されたことも意味します。追加されたユーザのプロファイルページを閲覧するには、下記リンクをクリックしてください。';
$string['requestedfriendlistsubject'] = '新しいフレンドリクエスト';
$string['requestedfriendlistmessage'] = 'あなたがフレンドとして追加することを %a がリクエストしました。あなたは、下記リンクまたはフレンドリストページでフレンドを追加することができます。';
$string['requestedfriendlistmessagereason'] = 'あなたがフレンドとして追加することを %a がリクエストしました。あなたは、下記リンクまたはフレンドリストページでフレンドを追加することができます。リクエストの理由は:';
...
$string['cantviewmessage'] = 'あなたは、このメッセージを閲覧できません。';
