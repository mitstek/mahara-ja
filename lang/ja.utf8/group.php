 ...
 * @updated    2018-11-18 15:49:44 UTC
...
$string['feedbacknotifydescription1'] = 'グループページおよびアーティファクトにフィードバックが投稿された場合、どのグループメンバが通知を受信するか選択してください。';
$string['allowsendnow'] = 'フォーラム投稿をすぐに送信する';
$string['allowsendnowdescription'] = 'この設定を有効にした場合、グループメンバはフォーラム投稿をすぐに送信することを選択できます。チェックを外した場合、グループ管理者、チュータおよびモデレータのみフォーラム投稿をすぐに送信できます。';
