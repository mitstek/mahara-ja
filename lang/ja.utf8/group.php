 ...
 * @updated    2018-11-18 15:52:37 UTC
...
$string['viewreleasedsubject'] = 'あなたのページ「 %s 」が %s から %s さんによりリリースされました。';
$string['viewreleasedmessage'] = 'あなたのページ「 %s 」が %s から %s さんによりリリースされました。';
