 ...
 * @updated    2018-11-18 15:51:01 UTC
...
$string['invitefriendsdescription'] = 'この設定を有効にした場合、メンバーはフレンドに対してグループへの参加を招待できます。この設定に関わらず、グループ管理者は常に誰にでも招待を送信できます。';
$string['invitefriends'] = 'フレンドを招待する';
$string['Recommendations'] = 'レコメンデーション';
$string['suggestfriendsdescription'] = 'この設定を有効にした場合、グループホームページ内のボタンを使って、メンバーは簡単にこのグループへのレコメンデーション (推奨文) をフレンドに送信できます。';
