 ...
 * @updated    2010-07-22 15:33:04 UTC
...
$string['viewnotifydescription'] = 'チェックした場合、グループメンバーが自分のビューをグループ内で共有設定することで、すべてのグループメンバーに通知が送信されます。この設定を有効にした場合、規模の大きなグループでは多くの通知が発生する可能性があります。';
