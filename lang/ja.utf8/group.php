 ...
 * @updated    2012-09-05 15:20:40 UTC
...
$string['groupurl'] = 'グループホームページURI';
$string['groupurldescription'] = 'あなたのグループホームページのURIです。このフィールドの長さは半角3-30文字にしてください。';
$string['groupurltaken'] = 'このURIはすでに他のグループに取得されています。';
...
$string['cantmessageuserdeleted'] = 'アカウントが削除されているため、あなたはこのユーザにメッセージを送信できません。';
