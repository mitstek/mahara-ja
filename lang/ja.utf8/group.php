...
$string['allowsendnowdescription1'] = 'すべてのグループメンバがフォーラム投稿をすぐに送信するよう選択できます。この設定を無効にした場合、グループ管理者、チューターおよびモデレータのみ、フォーラム投稿をすぐに送信できます。';
...
$string['hidemembersfrommembersdescription1'] = 'このグループのメンバを隠します。グループ管理者のみメンバ一覧を閲覧できます。管理者はグループホームページに表示されます。';
