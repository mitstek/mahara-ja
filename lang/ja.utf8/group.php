 ...
 * @updated    2014-02-04 04:42:10 UTC
...
$string['viewnotifydescription'] = 'グループメンバーが自分のページをグループ内で共有または新しいページを作成することで、すべてのグループメンバーに通知が送信されます。この設定を有効にした場合、規模の大きなグループでは多くの通知が発生する可能性があります。';
