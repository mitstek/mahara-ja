...
$string['viewnotifydescription'] = 'この設定を有効にした場合、グループメンバーが自分のビューをグループ内で共有設定することですべてのグループメンバーに通知が送信されます。この設定を有効にした場合、規模の大きなグループでは多くの通知が発生する可能性があります。';
...
$string['groupconfirmleavehasviews'] = '本当にこのグループから離脱してもよろしいですか? 一部のあなたのビューではこのグループをアクセスコントロールに使用しています。このグループから離脱することでグループのメンバーがあなたのビューにアクセスできなくなります。';
