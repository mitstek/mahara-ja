 ...
 * @updated    2018-11-18 15:52:51 UTC
...
$string['membershiptype.request'] = 'リクエストメンバシップ';
...
$string['publiclyviewablegroupdescription'] = '誰でも (このサイトのメンバではない人も含めて) フォーラムを含む、このグループを閲覧できるようにしてもよろしいですか?';
$string['Type'] = 'タイプ';
$string['publiclyvisible'] = 'パブリックに閲覧可';
$string['Public'] = 'パブリック';
$string['usersautoadded'] = 'ユーザを自動追加してもよろしいですか?';
$string['usersautoaddeddescription'] = 'このグループに対して新しいユーザすべてを自動追加してもよろしいですか?';
...
$string['viewnotifydescription'] = 'この設定を有効にした場合、グループメンバが自分のビューをグループ内で共有設定することですべてのグループメンバに通知が送信されます。この設定を有効にした場合、規模の大きなグループでは多くの通知が発生する可能性があります。';
...
%s';
$string['cantremoveuserisadmin'] = 'チュータは管理者および他のチュータを削除できません。';
$string['cantremovemember'] = 'チュータはメンバを削除できません。';
$string['member'] = 'メンバ';
$string['members'] = 'メンバ';
$string['Members'] = 'メンバ';
...
$string['viewreleasedmessage'] = 'あなたが %s に送信したビューは %s さんによりリリースされました。';
$string['viewreleasedsuccess'] = 'ビューが正常にリリースされました。';
$string['groupmembershipchangesubject'] = 'グループメンバシップ: %s';
$string['groupmembershipchangedmessagetutor'] = 'あなたはこのグループのチュータに昇格しました。';
$string['groupmembershipchangedmessagemember'] = 'あなたはこのグループのチュータから降格しました。';
$string['groupmembershipchangedmessageremove'] = 'あなたはこのグループから登録抹消されました。';
$string['groupmembershipchangedmessagedeclinerequest'] = 'このグループへのあなたの参加リクエストは拒否されました。';
$string['groupmembershipchangedmessageaddedtutor'] = 'あなたはこのグループのチュータとして追加されました。';
$string['groupmembershipchangedmessageaddedmember'] = 'あなたはこのグループのメンバとして追加されました。';
...
$string['groupjointypeopen'] = 'このグループのメンバシップはオープンです。自由に参加してください!';
$string['groupjointypecontrolled'] = 'このグループのメンバシップは管理されています。あなたはこのグループに参加できません。';
$string['groupjointypeinvite'] = 'このグループのメンバシップは招待のみです。';
$string['groupjointyperequest'] = 'このグループのメンバシップはリクエストのみです。';
...
$string['groupconfirmleavehasviews'] = '本当にこのグループから離脱してもよろしいですか? 一部のあなたのビューではこのグループをアクセスコントロールに使用しています。このグループから離脱することでグループのメンバがあなたのビューにアクセスできなくなります。';
...
$string['cantrequestfrienship'] = 'あなたはこのユーザにフレンドシップをリクエストできません。';
...
$string['Joined'] = '登録';
$string['membersdescription:invite'] = 'これは「招待のみ」グループです。あなたはユーザをユーザプロファイルページより招待、または<a href="%s">一度に複数の招待を送信できます</a>。';
