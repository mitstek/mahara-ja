...
$string['requestdescription'] = '人はグループ管理者にメンバーシップリクエストを送信できます。';
$string['Controlled'] = '管理';
$string['controlleddescription'] = 'グループ管理者は同意なしにグループに人を追加できます。また、メンバーはグループを離れることはできません。';
...
$string['newmembersadded'] = '%d 名の新しいメンバーが追加されました。';
...
$string['useralreadyinvitedtogroup'] = 'この人はすでに招待されているか、このグループのメンバーになっています。';
...
$string['userremoved'] = 'グループメンバーが削除されました。';
$string['About'] = 'About';
$string['aboutgroup'] = '%s について';
$string['Joined'] = '登録';
$string['invitemembersdescription'] = 'あなたはプロファイルページ経由または<a href="%s">複数招待の同時送信</a>により人にこのグループへの参加を招待できます。';
$string['membersdescription:controlled'] = 'これは「管理メンバーシップ」グループです。あなたは人をプロファイルページより直接追加または<a href="%s">一度に多くの人を追加できます</a>。';
$string['submit'] = '送信';
