...
$string['groupconfirmdeletehasviews'] = '本当にこのグループを削除してもよろしいですか? 一部のあなたのビューではこのグループをアクセスコントロールに使用しています。このグループを削除することでグループのメンバーがあなたのビューにアクセスできなくなります。';
...
$string['thereispendingrequest'] = 'このグループには1 件の保留中メンバーシップリクエストがあります。';
