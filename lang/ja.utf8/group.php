 ...
 * @updated    2018-11-18 15:53:27 UTC
...
$string['viewreleasedmessage'] = 'あなたがグループ「 %s 」に送信したビューは %s さんによりリリースされました。';
...
$string['groupconfirmdeletehasviews'] = '本当にこのグループを削除してもよろしいですか? 一部のあなたのビューではこのグループをアクセスコントロールに使用しています。このグループを削除することでグループのメンバがあなたのビューにアクセスできなくなります。';
...
$string['therearependingrequests'] = 'このグループには%s 件の保留中メンバシップリクエストがあります。';
$string['thereispendingrequest'] = 'このグループには1 件の保留中メンバシップリクエストがあります。';
