 ...
 * @updated    2018-11-18 15:50:01 UTC
...
$string['allowsendnowdescription'] = 'この設定を有効にした場合、グループメンバーはフォーラム投稿をすぐに送信することを選択できます。チェックを外した場合、グループ管理者、チューターおよびモデレータのみ、フォーラム投稿をすぐに送信できます。';
