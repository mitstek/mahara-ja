...
* @updated    2008-05-05 07:39:07 GMT
...
$string['cannotremove'] = 'このインスティテューションに関する唯一のプラグインのため、この認証プラグインを削除することはできません。';
...
$string['theyautocreateusers'] = 'ユーザをこちらに自動作成させる';
$string['parent'] = '親認証局';
...
$string['xmlrpccouldnotlogyouin'] = '申し訳ございません、あなたをログインされることができませんでした :(';
