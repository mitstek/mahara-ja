...
<p>あなたが有効なLeap2Aファイルをアップロードしていない、またはこのバージョンのMaharaではあなたのLeap2Aファイルのバージョンをサポートされていないことが考えられます。仮にLeap2Aが有効であったとしてもインポートを失敗させるバグがMaharaに含まれている可能性もあります。</p>
...
$string['importportfoliodescription'] = 'Leap2Aファイルがある場合、ここで別のサイトからあなたのポートフォリオにコンテンツをインポートすることができます。サイト設定およびあなたがグループ内にアップロードまたは作成したコンテンツはインポートすることができません。';
