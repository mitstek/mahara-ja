 ...
 * @updated    2016-02-03 06:03:27 UTC
...
$string['Import'] = 'インポート';
$string['importexceedquota'] = 'あなたがアップロードしたLeap2Aファイルの新しいファイル合計サイズがあなたのクオータを超えます。いくつかのファイルを削除して、あなたは再度試みる必要があります。';
...
<p>戻って、再度お試しください。問題が持続する場合、サポートを求めるため、<a href="https://mahara.org/forums/">Maharaフォーラム</a>に投稿してください。あなたのファイルのコピーを準備してください。</p>';
...
$string['importportfoliodescription'] = 'Leap2Aファイルがある場合、ここで別のサイトからあなたのポートフォリオにコンテンツをインポートすることができます。サイト設定またはあなたがグループ内にアップロードまたは作成したコンテンツはインポートすることができません。';
