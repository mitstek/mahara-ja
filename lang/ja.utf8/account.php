...
$string['maildisabledbounce'] = '多くのメッセージがサーバに戻ってきたためあなたのメールアドレス宛のメール送信は停止されました。メールを有効にする前にあなたのメールアカウントが正常に動作しているか %s のアカウントプリファレンスで確認してください。';
$string['maildisableddescription'] = 'あなたのアカウント宛のメール送信は停止されました。アカウントプリファレンスページで<a href="%s">あなたのメールを再度有効</a>にできます。';
