 ...
 * @updated    2015-10-11 16:22:07 UTC
...
$string['maildisabledbounce'] = '多くのメッセージがサーバに戻ってきたため、あなたのメールアドレス宛のメール送信は停止されました。Eメールを有効にする前に、あなたのEメールアカウントが正常に動作しているかアカウントプリファレンスの %s で確認してください。';
