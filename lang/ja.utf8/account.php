 ...
 * @updated    2018-06-01 17:18:45 UTC
...
$string['enablemultipleblogsdescription1'] = 'デフォルトではあなたは1つの日誌のみ作成することができます。1つ以上の日誌を作成したい場合、このオプションを有効にしてください。';
...
あなたはユーザが属しているインスティテューションの管理者として記載されています。あなたは削除リクエストの承認または拒否を決定することができます。これをするには次のリンクにアクセスしてください: %s
...
<p>あなたはユーザが属しているインスティテューションの管理者として記載されています。あなたは削除リクエストの承認または拒否を決定することができます。これをするには次のリンクにアクセスしてください: <a href=\'%s\'>%s</a></p>
