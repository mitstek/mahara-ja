 ...
 * @updated    2026-09-23 00:59:04 UTC
...
$string['username_help'] = '<h1>ユーザ名</h1><p>あなたのユーザ名はスペースを除き、文字、数字および最も一般的な記号で構成される3〜30文字にする必要があります。</p>';
$string['usernameexists2'] = 'このユーザ名はすでに取得されています。別のものを選択してください。';
...
$string['friendsnobody1'] = '誰も私をフレンドとして追加できない';
$string['friendsauth1'] = '新しいフレンドは私の承認を必要とする';
$string['friendsauto1'] = '新しいフレンドは自動的に承認される';
$string['friendsdescr'] = 'フレンドコントロール';
$string['friendscontrol_help'] = '<h1>フレンドコントロール</h1><p>他の人があなたをフレンドとして追加できるかどうか選択してください。あなたが他の人に追加された場合、その人もあなたのフレンドになります。あなたがフレンドリストから誰かを削除した場合、あなたはその人のリストからも削除されます。';
$string['uploadcsv.friendscontrol_help'] = '<h1>フレンドコントロール</h1><p>アップロードしたアカウント保持者を他の人がフレンドとして追加できるかどうか選択してください。人が他の人に追加された場合、その人ともフレンドになります。フレンドリストから誰かを削除した場合、その人は他の人のフレンドリストからも削除されます。';
$string['adduser.friendscontrol_help'] = '<h1>フレンドコントロール</h1><p>他の人がアカウント保持者をフレンドとして追加できるかどうかを選択してください。他の人が追加した場合、その人ともフレンドになります。フレンドリストから誰かを削除した場合、その人は他の人のフレンドリストからも削除されます。';
$string['updatedfriendcontrolsetting'] = 'フレンドコントロールが更新されました。';
$string['wysiwygdescr'] = 'HTMLエディタ';
$string['accountprefs.wysiwyg_help'] = '<h1>HTMLエディタ</h1>
<p>HTMLエディタはサイトの多くの場所で利用できます。テキストを<strong>太字</strong>または<i>イタリック</i>にする等、あなたはテキストを書式設定できます。これがない場合、あなたはプレインテキストのみで入力できます。</p>';
$string['licensedefault'] = 'デフォルトライセンス';
$string['licensedefault_help'] = '<h1>デフォルトライセンス</h1>
<p>あなたが作成またはアップロードするコンテンツのデフォルトライセンスを設定してください。あなたはコンテンツごとにこれをオーバーライドできます。デフォルトは標準の著作権ですが、あなたは別のものも選択できます。不明な場合、特定のライセンスが必要な場合があるため、あなたの組織でご確認ください。</p>
<p>あなたが複数のインスティテューションに所属していて「インスティテューションデフォルトを使用する」を選択した場合、デフォルトとして使用するライセンスを持つインスティテューションは選択できません。システムがインスティテューションの1つを選択します。</p>';
$string['licensedefaultinherit'] = 'インスティテューションデフォルトを使用する';
$string['messagesdescr'] = '他の人からのメッセージ';
$string['messagesnobody1'] = '誰も私にメッセージを送信できない誰も私にメッセージを送信できない';
$string['messagesfriends1'] = 'フレンドのみ私にメッセージを送信できる';
$string['messagesallow1'] = '誰でも私にメッセージを送信できる';
$string['language'] = '言語';
...
$string['groupsideblocklabels_help'] = '<h1>次でラベル付けされたグループのみ表示する</h1><p>選択されたラベルのグループのみダッシュボードに表示されます。</p>';
$string['hiderealname'] = '実名を秘匿する';
$string['ANY.hiderealname_help'] = '<h1>実名を秘匿する</h1><p>あなたがプロファイル情報に表示名を設定および他の人に姓名で探されたくない場合、このオプションを使用してください。</p>';
...
$string['sendnotificationdescription2'] = 'アカウント削除リクエストは管理者の承認が必要です。承認された場合、ファイル、日誌エントリ、ポートフォリオを含むあなたのすべての個人コンテンツは完全に削除されて復元できなくなります。グループに投稿したファイル、日誌エントリ、ポートフォリオおよびフォーラムの投稿は残りますが、それらの横にあなたの名前は表示されなくなります。';
...
$string['cancel_request_join_inst'] = '「 %s 」への参加リクエストをキャンセルする';
