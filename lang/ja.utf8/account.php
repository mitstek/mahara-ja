 ...
 * @updated    2009-01-05 21:08:35 UTC
...
$string['changeusernamedesc'] = 'あなたが %s へのログインに使用するユーザ名です。あなたのユーザ名は、半角英数字3～30文字にしてください。ユーザ名には、空白を除く、半角英数字および標準的な記号を使用することができます。';
