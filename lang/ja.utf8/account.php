...
$string['enablemultipleblogsdescription'] = 'デフォルトではあなたは1つのブログのみMaharaに作成できます。あなたが2つ以上のブログを作成したい場合、このオプションをチェックしてください。';
$string['disablemultipleblogserror'] = '1つのブログのみ作成していない限り、あなたは複数ブログを無効にできません。';
...
$string['maildisabledbounce'] = '多くのメッセージがサーバに戻ってきたためあなたのメールアドレス宛のメール送信は停止されました。アカウントプレファレンスの %s でメールを有効にする前にあなたのメールアカウントが正常に動作しているか確認してください。';
...
$string['deleteaccountdescription'] = 'アカウントを削除した場合、今後、あなたのプロファイル情報およびビューを他のユーザが閲覧できないようになります。あなたが投稿したフォーラム投稿のコンテンツは引き続き表示されますが、あなたの氏名は表示されなくなります。';
