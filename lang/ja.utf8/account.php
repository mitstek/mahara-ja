 ...
 * @updated    2020-02-16 06:59:22 UTC
...
$string['enablemultipleblogsdescription'] = 'デフォルトではあなたは1つの日誌のみMaharaに作成できます。あなたが2つ以上の日誌を作成したい場合、このオプションをチェックしてください。';
...
$string['badmobileuploadtoken'] = '申し訳ございません、モバイルアップロードトークンが有効ではありません - トークンの長さは少なくとも半角6文字にしてください。';
...
$string['resizeonuploaduserdefaultdescription1'] = 'この設定を有効にした場合、「アップロード時、大きなイメージをリサイズする」オプションがデフォルトで有効にされます。また、最大高および幅を超えたイメージはアップロード時にリサイズされます。個別のイメージアップロード時、あなたはこのデフォルト設定を無効にできます。';
