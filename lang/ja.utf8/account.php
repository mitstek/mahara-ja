 ...
 * @updated    2020-02-16 06:54:24 UTC
...
$string['deleteaccountdescription'] = 'アカウントを削除した場合、あなたのすべてのコンテンツは完全に削除されます。あなたは元に戻せません。あなたのプロファイル情報およびページは他のユーザが閲覧できないようになります。あなたが投稿したフォーラム投稿のコンテンツは引き続き表示されますが、あなたの氏名は表示されなくなります。';
$string['sendnotificationdescription'] = 'あなたのアカウント削除を承認するよう管理者に通知が送信されます。あなたがアカウントの削除をリクエストした場合、あなたの個人コンテンツすべてが完全に削除されます。これはあなたがアップロードしたファイル、執筆した日誌エントリ、作成したページおよびコレクションが削除されることを意味します。あなたはそれらを元に戻せません。あなたがグループでファイルをアップロードしている場合、日誌エントリおよびポートフォリオを作成している場合、そこでフォーラムに投稿している場合、それらはそのままになりますがあなたの氏名は表示されなくなります。';
...
あなたはユーザが属しているインスティテューションの管理者として登録されています。あなたは削除リクエストの承認または拒否を決定できます。これを実行するには次のリンクにアクセスしてください: %s
...
<p>あなたはユーザが属しているインスティテューションの管理者として登録されています。あなたは削除リクエストの承認または拒否を決定できます。これを実行するには次のリンクにアクセスしてください: <a href=\'%s\'>%s</a></p>
...
あなたはユーザが属しているインスティテューションの管理者として登録されています。
...
<p>あなたはユーザが属しているインスティテューションの管理者として登録されています。</p>
