 ...
 * @updated    2026-06-12 00:41:26 UTC
...
$string['delete_collection_group'] = 'グループコレクションを削除する';
$string['delete_collection'] = 'コレクションを削除する';
$string['deletespecifiedcollection'] = 'コレクション「 %s 」を削除する';
$string['deletespecified_group_collection'] = 'グループコレクション「 %s 」を削除する';
