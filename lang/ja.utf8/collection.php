...
$string['about'] = 'About';
$string['access'] = 'アクセス';
$string['accesscantbeused'] = 'アクセスオーバーライドは保存されませんでした。選択されたビューアクセス (シークレットURL) は複数のビューで使用することができません。';
...
$string['incorrectaccesstype'] = '注意: アクセスタイプ「シークレットURL」はオーバーライドアクセスタイプとして設定することができません。この設定は無視され、既存のビューアクセスは保持されます。しかし、選択されたオーバーライドビューに他のアクセスタイプを含んでいる場合、既存のアクセスタイプは解除され、それらのアクセスタイプが適用されます。';
