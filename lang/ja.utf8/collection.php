 ...
 * @updated    2017-01-23 00:34:29 UTC
...
$string['collectiondescription'] = 'コレクションは相互にリンクして同一アクセスパーミッションを持つ一連のページです。あなたが好きなだけコレクションを作成できますが、ページを2つ以上のコレクションに表示することはできません。';
