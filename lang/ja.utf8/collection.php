...
$string['incorrectaccesstype'] = '注意: アクセスタイプ「シークレットURL」はオーバーライドアクセスタイプとして設定することができません。この設定は無視され既存のビューアクセスは保持されます。しかし、選択されたオーバーライドビューに他のアクセスタイプを含んでいる場合、既存のアクセスタイプは解除されそれらのアクセスタイプが適用されます。';
