 ...
 * @updated    2026-09-12 15:02:39 UTC
...
$string['proxyauthmodel_help'] = '<h1>プロクシ認証情報</h1><p>あなたのプロクシ認証モデルを選択してください。</p>';
...
$string['cli_close_site_info'] = 'あなたはこのコマンドラインPHPスクリプトで管理者以外の人に対してサイトをクローズおよび再オープンできます。これは管理ホームページで「サイトをクローズする」ボタンを押すのと同じです。';
