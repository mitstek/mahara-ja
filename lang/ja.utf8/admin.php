...
$string['institutionprivacypagedescription'] = 'サイトプライバシー保護方針に加えてあなたのインスティテューションに表示されるプライバシー保護方針を編集してください。あなたが最後に編集したバージョンは自動的に最新のプライバシー保護方針となります。あなたには参考として最新のサイトプライバシー保護方針が表示されています。';
...
$string['cookieconsentdesc'] = '「クッキーコンセント」ユーザプライバシーシステムを設定します。';
...
$string['newregistrationpolicyinfo'] = '<p>私たちは登録サイトによる週ごとのデータ更新の提供を必須とするよう登録データポリシーを更新しました。あなたの登録を承認または削除するには以下のリンクに従ってください。</p>';
...
$string['allowanonymouspagesdescription1'] = 'ユーザはページ作成者として他のユーザから氏名を隠すことができます。管理者は必要であれば作成者の氏名を確認できます。';
...
$string['privacyagreementdescription'] = 'あなたは「Yes」の選択により上のプライバシー保護方針の条項に同意することになります。';
...
$string['registerprivacy'] = 'プライバシー保護方針をお読みください。プライバシー保護方針に同意しない場合、あなたはサイトでアカウントを作成できません。';
...
$string['privacytermsdesc'] = 'あなたのサイトのプライバシー保護方針および利用条件を編集します。';
