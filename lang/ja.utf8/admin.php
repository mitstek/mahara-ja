...
$string['showselfsearchsideblockdescription1'] = '「私のポートフォリオを検索する」サイドブロックがサイト内のいくつかの場所に表示されます。';
$string['showtagssideblock'] = 'タグクラウドを有効にする';
$string['showtagssideblockdescription1'] = 'この設定を有効にした場合、ユーザに対して最も使用されたタグがサイト内のいくつかの場所に表示されます。';
$string['simple'] = 'シンプル';
