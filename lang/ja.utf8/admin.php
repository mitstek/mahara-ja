...
$string['showtagssideblockdescription1'] = 'この設定を有効にした場合、ユーザに対して人は使用頻度の高いタグ一覧のサイドバーをサイト内のいくつかの場所で閲覧できます。';
$string['simple'] = 'シンプル';
...
$string['tagssideblockmaxtagsdescription'] = 'ユーザタグクラウド内に表示されるデフォルトのタグ数です。';
...
$string['footercustomlink'] = 'あなたはここにURLを入力してデフォルトページ「 %s 」を上書きできます。デフォルト値を使用する場合、空白のままにしてください。';
...
$string['enablenetworkingdescription'] = 'あなたのMaharaサーバがMoodleおよび他のアプリケーションが動作しているサーバと通信できるようにします。';
...
$string['networkingpagedescription'] = 'Maharaのネットワーキング機能では同じまたは別のサーバで動作しているMaharaまたはMoodleと連携できるようにします。ネットワーキングが有効にされた場合、MoodleまたはMaharaにログインしたユーザのシングルサインオンを設定できます。';
...
$string['uploadgroupmemberscsvpagedescription2'] = '<p>あなたはこの機能により<acronym title="Comma Separated Values">CSV</acronym>ファイルを使用してこのインスティテューションで管理されるグループ内のグループメンバーを更新できます。</p>
...
$string['noleap2axmlfiledetected'] = 'leap2a.xmlファイルは検出されませんでした - 再度、あなたのエクスポートファイルを確認してください。';
$string['Or...'] = 'または ...';
...
$string['noinstitutionsstatsdescription'] = 'あなたのユーザに利用できるインスティテューションがないためインスティテューション統計を利用することはできません。';
