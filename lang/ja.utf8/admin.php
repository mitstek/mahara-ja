...
$string['surbldescription1'] = 'SURBL DNSBLと照合してURLをチェックします。';
...
$string['loginasoverridelegalaccept'] = '別のユーザとしてログインしているためあなたは法的表示に同意せずに%s常にログインすること%sを選択できます。';
$string['Add'] = '追加';
$string['all'] = 'すべて';
...
$string['registrationalloweddescription5'] = '人は登録フォームを使用してこのインスティテューションに登録できます。登録が無効にされた場合、非メンバーはインスティテューションのメンバーシップをリクエストすることはできません。また、メンバーはインスティテューションを離れたり自分のユーザアカウントを削除することはできません。';
