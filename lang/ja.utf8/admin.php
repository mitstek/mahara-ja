 ...
 * @updated    2015-10-29 19:31:54 UTC
...
$string['reopensitedetail'] = 'あなたのサイトはクローズされています。アップグレードが完了するまで、サイト管理者のみログインすることができます。';
...
$string['allowpublicprofilesdescription'] = 'この設定を有効にした場合、ログインユーザだけではなく、その他のユーザからもアクセス可能なプロファイルページを作成することができます。';
...
$string['showonlineuserssideblockdescriptionmessage'] = 'この設定を有効にした場合、ユーザに対してオンラインユーザ一覧のサイドバーが表示されます。';
...
$string['userscanhiderealnamesdescription'] = 'この設定を有効にした場合、ニックネームを設定したユーザはニックネームのみ検索対象として、実名を検索されないようにすることができます (サイト管理セクションでは常にユーザを実名で検索することができます)。';
...
$string['linksandresourcesmenupagedescription'] = '「リンクおよびリソース」メニューはほとんどのページですべてのユーザに表示されます。あなたは他のウェブサイトのリンクおよび%s管理ファイル%sセクションでアップロードしたファイルのリンクを追加することができます。';
...
$string['licenseurldup'] = 'URLはユニーク (固有) である必要があります。ここで %s は繰り返し使用されています。';
