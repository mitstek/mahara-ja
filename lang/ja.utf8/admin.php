...
$string['requireregistrationconfirmdescription'] = 'この設定を有効にした場合、アクティブになる前に自己登録ユーザアカウントはインスティテューション管理者に承認される必要があります。そうでない場合、それぞれのインスティテューションでインスティテューションへの新しいアカウントの登録時に確認が必要かどうか決定できます。';
...
$string['registrationconfirmdescription1'] = 'この設定を有効にした場合、登録はインスティテューション管理者によって承認される必要があります。チェックボックスが灰色の場合、サイト管理者がすべてのインスティテューションにこの設定を強制しています。';
