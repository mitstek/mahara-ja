 ...
 * @updated    2021-12-26 09:15:05 UTC
...
$string['homepageinfodescription4'] = 'サイト情報および利用状況をホームページに表示します。登録済みの人はこの情報を自分のダッシュボードで非表示にできます。';
...
$string['linksandresourcesmenupagedescription'] = '「リンクおよびリソース」メニュはほとんどのページですべての人に表示されます。あなたは他のウェブサイトへのリンクおよび%s管理ファイル%sセクションにアップロードしたファイルへのリンクを追加できます。';
...
$string['Or'] = 'または';
$string['userwillreceiveemailandhastochangepassword'] = '新しいアカウント詳細を記載したメールが送信されます。新しくアカウントが作成された人は初回ログイン時にパスワードの変更を求められます。';
...
$string['someusersnotinauthinstanceinstitution'] = 'あなたが選択した何名かの人はこの認証方法を使用するインスティテューションに属していません。';
