 ...
 * @updated    2021-12-26 09:21:27 UTC
...
$string['allowanonymouspagesdescription'] = 'この設定を有効にした場合、ユーザはページ作成者としての氏名を他のユーザから秘匿することができます。必要であれば、管理者は作成者名を確認できます。';
...
$string['dropdownmenudescriptioninstitution'] = 'この設定を有効にした場合、選択したインスティテューションテーマのメインナビゲーションがドロップダウンフォーマットを使用します。';
...
$string['recaptchakeysmissing'] = 'reCAPTCHAは有効にされましたが、あなたがプライベートおよび公開鍵を提供するまで機能しません。';
$string['recaptchanotpassed'] = 'reCAPTCHAが正しく入力されていません。再度お試しください。';
$string['recaptchaonregisterform'] = 'ユーザ登録フォームのreCAPTCHA';
$string['recaptchaonregisterformdesc'] = 'この設定を有効にした場合、ユーザは自分が人間であることを証明するため新しいアカウントの自己登録時に<a href="https://recaptcha.org/">reCAPTCHA</a>テストを通過する必要があります。';
$string['recaptchaprivatekey'] = 'reCAPTCHAプライベートキー';
$string['recaptchaprivatekeydesc'] = 'あなたのサイト用reCAPTCHAアカウントのプライベートキーです。';
$string['recaptchapublickey'] = 'reCAPTCHA公開鍵';
$string['recaptchapublickeydesc'] = 'あなたのサイト用reCAPTCHAアカウントの公開鍵です。';
...
$string['requireregistrationconfirmdescription'] = 'この設定を有効にした場合、アクティブになる前に自己登録ユーザアカウントはインスティテューション管理者に承認される必要があります。そうではない場合、それぞれのインスティテューションでインスティテューションへの新しいアカウントの登録時に確認が必要かどうか決定できます。';
...
$string['sitefilesaccessdescription'] = 'この設定を有効にした場合、ログインユーザはサブフォルダ内のサイトファイルにアクセスできるようになります。デフォルトではトップレベルのディレクトリのファイルのみアクセスできます。';
...
$string['registrationconfirmdescription1'] = 'この設定を有効にした場合、登録はインスティテューション管理者により承認される必要があります。チェックボックスが灰色の場合、サイト管理者がすべてのインスティテューションにこの設定を強制しています。';
...
$string['masqueradingreasonrequireddescription1'] = 'この設定を有効にした場合、管理者は別のユーザとしてマスカレーディングする時に理由を入力する必要があります。この理由は記録されます。また、「ユーザにマスカレーディングを通知する」設定が有効にされた場合、マスカレーディングに関する理由を含んだ通知がユーザにも送信されます。マスカレーディングセッションのロギングを動作させるには「ロギング設定」を有効にする必要があります。';
$string['masqueradingnotified'] = 'ユーザにマスカレーディングを通知する';
$string['masqueradingnotifieddescription1'] = 'この設定を有効にした場合、管理者がユーザをマスカレーディングした時に通知されます。通知には誰が、いつ、なぜ (「マスカレーディングの理由を要求する」が有効の場合) マスカレーディングしたのか記載されます。マスカレーディングセッションのロギングを動作させるには「ロギング設定」を有効にする必要があります。';
...
$string['showprogressbardescription'] = 'この設定を有効にした場合、プロファイルで何を完了すべきかヒントのあるプログレスバーがユーザにサイドブロックとして表示されます。プログレスバーには無効にするオプションがあります。';
...
$string['exporttoqueuedescription1'] = 'この設定を有効にした場合、サーバ負荷管理を改善するためLeap2Aによるユーザポートフォリオのエクスポート処理にエクスポートキューが使用されます。';
