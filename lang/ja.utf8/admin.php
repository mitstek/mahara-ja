...
$string['networkingpagedescription'] = 'Maharaのネットワーキング機能では同じまたは別のサーバで動作しているMaharaまたはMoodleと連携できるようにします。ネットワーキングが有効にされた場合、MoodleまたはMaharaにログインした人のシングルサインオンを設定できます。';
...
$string['resetpassworddescription'] = 'ここにテキストを入力した場合、人の現在のパスワードと置換されます。';
...
$string['loginasdenied'] = 'パーミッションなしで別の人としてログインを試みました。';
$string['loginastwice'] = 'すでにログインしているにもかかわらず別の人としてログインを試みました。';
