 ...
 * @updated    2011-07-19 11:39:27 UTC
...
$string['siteadmindescription'] = 'サイト管理者はサイト内であらゆる処理を実行することができ、どこへでも移動することができます。';
...
$string['registrationalloweddescription2'] = 'あなたのシステム内にあるこのインスティテューションに対して、ユーザが登録フォームで登録できるかどうか設定します。';
