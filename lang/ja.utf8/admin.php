 ...
 * @updated    2021-08-21 18:41:31 UTC
...
$string['dbnotutf8mb4warning'] = 'あなたはutf8mb4文字セット (4バイト UTF-8ユニコードエンコーディング) データベースを使用していません。Maharaは内部的にすべてのデータをutf8mb4として保存します。あなたはこのアップグレードを試せますが、データベースのutf8mb4への変換をお勧めします。';
...
$string['staticpagespagedescription1'] = 'ここであなたはホームページ、登録済みの人のダッシュボード、「About」ページ、フッタ内リンク等、いくつかの内蔵ページのコンテンツを編集できます。';
...
$string['networkingpagedescription'] = 'Maharaのネットワーキング機能では同一または別サーバで稼動中のMaharaまたはMoodleと連携できるようにします。ネットワーキングが有効にされた場合、MoodleまたはMaharaにログインする人のシングルサインオンを設定できます。';
...
$string['updateusersdescription'] = 'あなたのCSVファイル内に指定したインスティテューションに属する既存のユーザ名の人が含まれる場合、その人の詳細がファイルのデータにより上書きされることになります。注意して使用してください。';
...
$string['usereditdescription1'] = 'あなたはここでこのアカウントを管理できます。アカウントの管理には変更詳細、利用停止、削除およびインスティテューションのメンバーシップ変更を含みます。';
...
$string['institutionsettingsdescription'] = 'あなたが管理者のインスティテューションに関してこの人のメンバーシップ設定を変更できます。';
