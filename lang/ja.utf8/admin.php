 ...
 * @updated    2014-08-24 07:30:23 UTC
...
$string['dbcollationmismatch'] = 'あなたのデータベースカラムはデータベースデフォルトとは異なるコレーションを使用しています。すべてのカラムが、データベースと同じコレーションを使用していることを確認してください。';
...
$string['closesitedetail'] = 'あなたは管理者を除くすべてのユーザに対して、サイトをクローズすることができます。この処理はデータベースアップグレードの処理の準備に有用です。あなたがサイトを再オープンするか、アップグレードが正常に完了するまで、管理者のみログインすることができます。';
$string['Open'] = 'オープン';
...
$string['allowpublicviewsdescription'] = 'チェックした場合、ログインユーザだけではなく、その他のユーザからもアクセス可能なポートフォリオページを作成することができます。';
...
$string['anonymouscommentsdescription'] = 'チェックした場合、パブリックページまたはシークレットURLアクセス可能なページに対して、未ログインユーザがコメントを投稿することができます。';
...
$string['spamhausdescription'] = 'チェックした場合、Spamhaus DNSBLを使用して、URLがチェックされます。';
...
$string['surbldescription'] = 'チェックした場合、SURBL DNSBLを使用して、URLがチェックされます。';
...
<p>shortnameフィールドにはあなたが<a href="%s" title="%s">ここ</a>でグループを作成した時に使用した名称と同じにする必要があります。</p>
...
$string['registrationalloweddescription3'] = 'あなたのシステム内にあるこのインスティテューションに対して、ユーザが登録フォームで登録できるかどうか設定します。登録が無効にされた場合、非メンバーはインスティテューションのメンバーシップをリクエストできません。同様に、メンバーがインスティテューションから離脱できない、または自分のユーザアカウントを削除できないようになります。';
