...
<p>この作業のインストラクションに関して、Mahara wikiの<a href=" https://wiki.mahara.org/index.php/System_Administrator\'s_Guide/Clean_URL_Configuration" target="_blank">「クリーンURL設定 (英語)」</a>をご覧ください。</p>';
...
$string['adminfilespagedescription1'] = 'これらは%s「リンクおよびリソース」メニュー%sに含むことのできるファイルです。パブリックディレクトリのファイルはパブリックメニューに追加できるのに対して、ホームディレクトリのファイルはログインメニューに追加することができます。';
...
$string['uploadcsvpagedescription3'] = '<p>あなたはこの機能により、<acronym title="Comma Separated Values">CSV</acronym>ファイルを使用して新しいユーザをアップロードすることができます。</p>
