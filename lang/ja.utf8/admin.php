...
<p>あなたがサイトを登録する場合、送信される情報を<strong><a href="%sadmin/registersite.php">サイト登録ページ</a></strong>でプレビューーーできます。</p>';
...
$string['groupmemberscsvfiledescription'] = '更新するグループメンバを含むファイル';
...
<p>通常、このこのZIPファイルはMaharaに実装されているバルクエクスポートを使用して生成されます。</p>
...
$string['institutionstaffuserspagedescription1'] = 'ここであなたはどのユーザをあなたのインスティテューションのスタッフにするか選択できます。現在のスタッフは「現在のスタッフ」フィールドに潜在的なスタッフは「インスティテューションメンバ」フィールドに一覧表示されます。';
...
$string['customtheme.backgroundfg'] = 'テキストヘッダ背景色';
...
$string['profilecompletenesspreview'] = 'あなたは「プロファイル完了プレビューーー」サイドブロックでプロファイル完了がどのように表示されるかプレビューーーできます。';
