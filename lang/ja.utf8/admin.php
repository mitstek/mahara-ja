 ...
 * @updated    2016-10-30 14:41:40 UTC
...
$string['institutionadminuserspagedescription1'] = 'ここであなたはどのユーザがインスティテューションを管理する者になるか選択することができます。現在の管理者は「現在の管理者」フィールドに潜在的な管理者は「インスティテューションメンバー」フィールドに一覧表示されます。';
$string['adminusersupdated'] = '管理者が更新されました。';
$string['staffuserspagedescription1'] = 'ここであなたはどのユーザがサイトのスタッフになるか選択することができます。現在のスタッフは「インスティテューションスタッフ」フィールドに潜在的な管理者は「潜在的なスタッフ」フィールドに一覧表示されます。';
