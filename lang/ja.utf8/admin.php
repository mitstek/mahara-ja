...
$string['usereditdescription1'] = 'あなたはここでこのユーザアカウントを管理できます。アカウントの管理には変更詳細、利用停止、削除およびインスティテューションのメンバーシップ変更を含みます。';
...
$string['unabletodeletealladmins1'] = 'あなたはサイト管理者すべてを削除できません。';
