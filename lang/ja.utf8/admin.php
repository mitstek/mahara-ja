...
$string['skins'] = 'ページスキン';
$string['skinsinstitutiondescription1'] = 'この設定を有効にした場合、このインスティテューションのメンバーは自分のページに「スキン」を使用できます。';
...
$string['noleap2axmlfiledetected'] = 'leap2a.xmlファイルが見つかりませんでした - 再度あなたのエクスポートファイルを確認してください。';
$string['Or...'] = 'または ...';
...
$string['registrationalloweddescription4'] = 'この設定を有効にした場合、人は登録フォームを使用してこのインスティテューションに登録できます。登録が無効にされた場合、非メンバーはインスティテューションのメンバーシップをリクエストできません。また、メンバーはインスティテューションを離れたり自分のユーザアカウントを削除できません。';
...
$string['updateinstitutionuserquotasdesc1'] = 'この設定を有効にした場合、あなたが上で選択したデフォルトクオータを既存のメンバーすべてに適用します。';
$string['approve'] = '承認';
$string['deny'] = '拒否';
