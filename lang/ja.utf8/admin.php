 ...
 * @updated    2016-10-30 14:40:22 UTC
...
$string['allowpublicprofilesdescription1'] = 'ユーザはログインユーザのみではなく、外部からもアクセスできるプロファイルページを設定することができます。';
...
$string['commentsortorderdescription'] = 'ページに表示する場合のアーティファクトコメントの並べ替え順を設定します。';
...
$string['homepageinfodescription2'] = 'この設定を有効にした場合、Maharaに関する情報および利用状況がMaharaホームページに表示されます。登録済みユーザにはこれらの情報をダッシュボードに表示しないオプションがあります。';
...
$string['disableexternalresourcesdescription1'] = 'ユーザによる別のホストからのイメージ等の埋め込みを防ぐため、外部リソースの埋め込みを無効にします。';
...
$string['userscanhiderealnamesdescription1'] = 'ユーザが表示名を設定した場合、実名で検索できないようにします。他のユーザは表示名のみで検索することができます。サイトの管理セクションでは常に実名でユーザを検索することができます。';
...
$string['exporttoqueuedescription2'] = 'サーバ負荷管理を改善するため、ユーザポートフォリオのLeap2Aによるエクスポートに関してエクスポートキューが処理するようにします。';
