...
$string['uploadgroupmemberscsverrornoadminlisted'] = 'あなたのファイルの %s 行目に誤りがあります: グループ省略名 (shortname)「 %s 」にはロール「admin」を指定されたグループメンバーがありません。';
...
<p>あなたが多くのアカウントをインポートする場合、注意してください。インポート処理には長時間を要する場合があります。</p>';
...
$string['changeusernamedescription'] = 'この人のユーザ名を変更します。ユーザ名の長さは半角3-236文字にしてください。ユーザ名にはスペースを除く文字、数字および一般的な記号を含むことができます。';
$string['resetpassword'] = 'パスワードをリセットする';
$string['resetpassworddescription'] = 'ここにテキストを入力した場合、人の現在のパスワードと入れ替えられます。';
...
$string['loginasdenied'] = 'パーミッションなしで別の人としてのログインを試みました。';
