...
$string['sitefilesdescription'] = '「リンクおよびリソースメニュ」およびサイトビューに置くことのできるファイルをアップロードおよび管理します。';
...
$string['cronnotrunning'] = 'cronが動作していません。cronの設定に関するインストラクションは<a href="https://wiki.mahara.org/wiki/System_Administrator%27s_Guide/Installing_Mahara">installation guide</a>をご覧ください。';
...
$string['anonymouscommentsdescription'] = 'この設定を有効にした場合、パブリックビューまたはシークレットURLアクセス可能なビューに対して未ログインユーザがコメントを投稿できます。';
...
$string['showselfsearchsideblockdescription'] = 'サイトのマイポートフォリオセクション内に「私のポートフォリオを検索する」サイドブロックを表示します。';
$string['showtagssideblock'] = 'タグクラウドを有効にする';
$string['showtagssideblockdescription'] = 'この設定を有効にした場合、ユーザに対して最も使用されたタグが、サイトのマイポートフォリオセクション内のサイドブロックに表示されます。';
$string['simple'] = 'シンプル';
...
$string['smallviewheadersdescription'] = 'この設定を有効にした場合、ビューの閲覧または編集時、ブロック内にスモールヘッダおよびサイトナビゲーションが表示されます。';
...
$string['userscanchooseviewthemesdescription'] = 'この設定を有効にした場合、ユーザはビューの編集時、テーマを選択できます。選択したテーマを使用して他のユーザにビューが表示されます。';
...
$string['adminfilespagedescription'] = 'あなたはここで%s「リンクおよびリソース」メニュ%sに含めれるファイルをアップロードできます。パブリックディレクトリのファイルはパブリックの「リンクおよびリソース」メニュに追加できるのに対してホームディレクトリのファイルはログイン後の「リンクおよびリソース」メニュに追加できます。';
...
$string['leap2aimportfailed'] = '<p><strong>申し訳ございません - Leap2Aファイルのインポートに失敗しました。</strong></p><p>これはあなたが有効なLeap2Aファイルをアップロードに選択しなかったからだと考えられます。また、Leap2Aファイルが有効な場合、Maharaのバグがあなたのファイルのアップロードを失敗させていることも考えられます。</p><p><a href="add.php">戻ってファイルのアップロードを再度お試しください</a>。この問題が続く場合、エラー状況を<a href="https://mahara.org/forums/">Maharaフォーラム</a>に投稿してください。その場合、あなたのファイルのコピーを準備してください!</p>';
...
$string['registrationalloweddescription2'] = 'あなたのシステム内にあるこのインスティテューションに対してユーザが登録フォームで登録できるかどうか設定します。登録が無効にされた場合、非メンバはインスティテューションのメンバシップをリクエストできません。同様にメンバがインスティテューションから離脱できない、または任意に自分のユーザアカウントを削除できないようになります。';
