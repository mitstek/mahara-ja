 ...
 * @updated    2021-12-26 09:23:59 UTC
...
$string['recaptchaonregisterformdesc3'] = '新しいアカウントを自己登録または「お問い合わせ」フォームを使用するユーザは<a href="https://www.google.com/recaptcha/">reCAPTCHA</a>テストに合格して自分が人間であることを証明する必要があります。';
...
$string['pendingregistrationspagedescription2'] = '<p>このページではあなたのインスティテューションで自己登録およびメンバシップをリクエストしたユーザを閲覧できます。あなたは登録リクエストを承認または拒否できます。<p>
<p>登録を承認した場合、ユーザにはアカウントの有効化に関して詳細なインストラクションを記載した通知が送信されます。ユーザが有効化リンクをクリックした場合、インスティテューションのメンバとして追加されます。有効化リンクは24時間で有効期限となりユーザの詳細は削除されます。まだ登録したい場合、同じ手続きを再度開始する必要があります。</p>
...
$string['unsuspendinstitutiondescription_instadmin'] = '利用停止されたインスティテューションのユーザはログインできません。インスティテューションの利用停止を解除するには管理者にご連絡ください。';
