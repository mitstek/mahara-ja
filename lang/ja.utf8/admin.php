 ...
 * @updated    2015-10-22 18:35:03 UTC
...
$string['cronnotrunning1'] = '<span class="error">Cronが動作していません。</span><br />cronのセットアップに関するインストラクションは<a href="https://wiki.mahara.org/System_Administrator%27s_Guide/Installing_Mahara">installation guide</a>をご覧ください。あなたがすでにcronをセットアップしている場合、直近の1つまたはそれ以上の処理が正しく実行されませんでした。';
...
$string['requireregistrationconfirmdescription'] = 'チェックした場合、アクティブになる前に自己登録ユーザアカウントはインスティテューション管理者に承認される必要があります。そうでない場合、それぞれのインスティテューションでインスティテューションへの新しいアカウントの登録時に確認が必要かどうか決定することができます。';
...
$string['sitefilesaccessdescription'] = 'チェックした場合、ログインユーザはサブフォルダ内のサイトファイルにアクセスすることができるようになります。デフォルトではトップレベルのディレクトリのファイルのみアクセスすることができます。';
