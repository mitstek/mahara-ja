...
$string['sitefilesdescription'] = '「リンクおよびリソースメニュ」およびサイトページに配置できるファイルをアップロードおよび管理します。';
...
$string['linksandresourcesmenu'] = 'リンクおよびリソースメニュ';
$string['linksandresourcesmenupagedescription'] = '「リンクおよびリソース」メニュはほとんどのページですべてのユーザに表示されます。あなたは他のウェブサイトのリンクおよび%s管理ファイル%sセクションでアップロードしたファイルへのリンクを追加できます。';
...
$string['adminfilespagedescription'] = 'あなたはここで%s「リンクおよびリソース」メニュ%sに含むことのできるファイルをアップロードできます。パブリックディレクトリのファイルはパブリックの「リンクおよびリソース」メニュに追加できるのに対してホームディレクトリのファイルはログイン後の「リンクおよびリソース」メニュに追加できます。';
...
$string['institutionusersinstructionsrequesters'] = '左側のユーザ一覧にはあなたのインスティテューションに参加をリクエストした、すべてのユーザが表示されます。あなたは表示されるユーザ数を減らすため検索ボックスを使用できます。あなたがユーザをインスティテューションに追加したい場合、またはユーザのメンバシップリクエストを拒否したい場合、1名またはそれ以上のユーザを選択して右矢印をクリックすることにより最初にユーザを右側ボックスに移動してください。「メンバを追加する」ボタンをクリックして右側ボックスのすべてのユーザをインスティテューションに追加できます。「リクエストを拒否する」ボタンをクリックして右側ボックスのユーザのメンバシップリクエストを拒否できます。';
$string['institutionusersinstructionsnonmembers'] = '左側のユーザ一覧にはあなたのインスティテューションのメンバではない、すべてのユーザが表示されます。あなたは表示されるユーザ数を減らすため検索ボックスを使用できます。あなたがユーザに対してインスティテューションへの参加を招待したい場合、1名またはそれ以上のユーザを選択して右矢印をクリックすることにより最初にユーザを右側ボックスに移動してください。「ユーザを招待する」ボタンをクリックして右側ボックスのすべてのユーザに招待を送信できます。招待を受け入れるまでこれらのユーザはインスティテューションと関連付けされません。';
