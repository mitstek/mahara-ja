...
$string['makeusersintostaff'] = '選択したインスティテューションメンバーをスタッフにする';
$string['makestaffintousers'] = '選択したスタッフを通常のインスティテューションメンバーに戻す';
...
$string['usereditdescription1'] = 'あなたはここでこのアカウントを管理できます。アカウント管理には詳細変更、利用停止、削除およびインスティテューションのメンバーシップ変更を含みます。';
...
$string['loginastwice'] = 'すでにログインしているにも拘わらず、別の人としてのログインを試みました。';
...
$string['registrationalloweddescription5'] = '人は登録フォームを使用してこのインスティテューションに登録できます。登録が無効にされた場合、非メンバーはインスティテューションのメンバーシップをリクエストできません。また、メンバーは自分でインスティテューション離脱またはアカウント削除できません。';
...
$string['showonlineusersdescription'] = 'このインスティテューションのメンバーに表示されるオンライン中の人です。人に複数インスティテューションが許可されている場合、そしてインスティテューションの設定が異なる場合、最も制約の少ないインスティテューション設定が使用されます。';
...
$string['institutionsettingsdescription'] = 'あなたが管理者であるインスティテューションに関してこの人のメンバーシップ設定を変更できます。';
...
$string['institutionusersinstructionsnonmembers2'] = '「 %1$s 」フィールドの一覧ではまだあなたのインスティテューションのメンバーではない人すべてが表示されます。あなたは特定の人を探すため検索ボックスを使用できます。インスティテューションへの参加に人を招待したい場合、最初に「 %1$s 」フィールドで選択して右矢印ボタンをクリックして「 %2$s 」フィールドに移動してください。「人を招待する」ボタンにより「 %2$s 」フィールド内の人すべてに招待を送信します。これらの人は招待を受け入れるまであなたのインスティテューションと関連付けられません。サイト管理者には「メンバーを追加する」ボタンが表示されすぐにインスティテューションに人を追加できます。';
$string['institutionusersinstructionslastinstitution2'] = '「 %1$s 」フィールドの一覧ではまだあなたのインスティテューションのメンバーではない人、選択されたインスティテューションを離れた人すべてが表示されます。あなたは特定の人を探すため検索ボックスを使用できます。インスティテューションへの参加に人を招待したい場合、最初に「 %1$s 」フィールドで選択して右矢印ボタンをクリックして「 %2$s 」フィールドに移動してください。「人を招待する」ボタンにより「 %2$s 」フィールド内の人すべてに招待を送信します。これらの人は招待を受け入れるまであなたのインスティテューションと関連付けられません。サイト管理者には「メンバーを追加する」ボタンが表示されすぐにインスティテューションに人を追加できます。';
$string['institutionusersinstructionsmembers2'] = '「 %1$s 」フィールドの一覧ではあなたのインスティテューションのメンバーすべてが表示されます。あなたは特定の人を探すため検索ボックスを使用できます。インスティテューションからメンバーを削除したい場合、最初に「 %1$s 」フィールドで選択して右矢印ボタンをクリックして「 %2$s 」フィールドに移動してください。「メンバーを削除する」ボタンにより「 %2$s 」フィールド内の人すべてをインスティテューションから削除します。アカウントは削除されません。';
...
$string['usersrequested'] = 'メンバーシップをリクエストした人';
$string['userstobeadded'] = 'メンバーとして追加される人';
$string['userstoaddorreject'] = '追加/拒否される人';
$string['addmembers'] = 'メンバーを追加する';
$string['inviteuserstojoin'] = '人にインスティテューションへの参加を招待する';
$string['userswhohaveleft'] = 'インスティテューション %s を離れた人';
...
$string['userstoberemoved'] = '削除されるメンバー';
...
$string['moveuserstoinviteinstitution'] = '選択した旧 %s のメンバーを招待済みに変更する';
$string['moveusersfrominviteinstitution'] = '選択した招待済みの人を旧 %s のメンバーに変更する';
...
$string['institutionuserserrortoomanyusers'] = 'これらの人は追加されませんでした。メンバー数はインスティテューションで許可される最大メンバー数を超えることはできません。あなたは少数の人を追加するか、インスティテューションから人を削除するか、サイト管理者に最大メンバー数を増やすよう依頼できます。';
$string['institutionuserserrortoomanyinvites'] = 'あなたの招待は送信されませんでした。既存のメンバー + 未処理の招待者数はインスティテューションで許可される最大メンバー数を超えることはできません。あなたは少数の人を招待するか、インスティテューションから人を削除するか、サイト管理者に最大メンバー数を増やすよう依頼できます。';
...
$string['maxmembersexceeded'] = 'このインスティテューションにはすでに %s のメンバーが登録されています。一部のメンバーを削除するか、アカウント上限を増やしてください。';
...
<p>登録を承認した場合、人にはアカウントの有効化に関して詳細なインストラクションを記載した通知が送信されます。人が有効化リンクをクリックした場合、インスティテューションのメンバーとして追加されます。有効化リンクは24時間で有効期限切れとなり人の詳細は削除されます。まだ登録したい場合、同じ手続きを再度開始する必要があります。</p>
...
$string['privacylastversion'] = 'プライバシー保護方針には最大半角15文字のユニークなバージョン名が必要です。このプライバシー保護方針の最新バージョンは「 %s 」です。';
