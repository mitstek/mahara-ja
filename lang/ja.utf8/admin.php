...
<<<<<<< HEAD
$string['dbnotutf8mb4_binwarning'] = 'あなたはutf8mb4文字セット (4-Byte UTF-8 Unicode Encoding) データベースを使用していません。Maharaは内部的にすべてのデータをutf8mb4として保存します。あなたはこのアップグレードを試みることができますが、あなたのデータベースを文字セット「utf8mb4」 および照合順序 「utf8mb4_bin」 を使用するよう変換をお勧めします。';
