 ...
 * @updated    2021-12-26 09:21:35 UTC
...
$string['institutionadminuserspagedescription1'] = 'ここであなたはどのユーザがインスティテューションを管理する者になるか選択できます。現在の管理者は「現在の管理者」フィールドに潜在的な管理者は「インスティテューションメンバ」フィールドに一覧表示されます。';
$string['adminusersupdated'] = '管理者が更新されました。';
$string['staffuserspagedescription1'] = 'ここであなたはどのユーザをサイトのスタッフにするか選択できます。現在のスタッフは「インスティテューションスタッフ」フィールドに潜在的な管理者は「潜在的なスタッフ」フィールドに一覧表示されます。';
