...
$string['inactivefor1'] = '現在、「 %s 」 はアクティブではありません。';
...
$string['owngroupsonlydescription'] = 'ユーザが所有または所属しているグループのみ閲覧できるようにします。ユーザはグループ内の他のユーザのみ検索できます。この設定はconfig.ｐｈｐファイルで隔離インスティテューションを有効にする必要があります。';
