...
$string['notificationsettingsdescription'] = 'ここであなたは新しいユーザが受信する通知のデフォルトオプションを設定できます。ユーザはこれらの設定を自分の「設定 → 通知」ページでオーバーライドできます。<br />あなたがメールオプションのどちらか選択した場合、通知はユーザの受信ボックスにも到着しますが、自動的に既読としてマークされます。';
