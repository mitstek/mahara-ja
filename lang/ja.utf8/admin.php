 ...
 * @updated    2021-12-26 09:26:30 UTC
...
$string['sitefilesaccessdescription1'] = '登録ユーザがサブフォルダ内のサイトファイルにアクセスできるようにします。デフォルトではトップレベルのディレクトリにのみアクセスできます。';
...
$string['defaultmultipleblogsdescription1'] = 'デフォルトでユーザが日誌を複数持てるようにします。ユーザはこれをアカウント設定でオーバーライドできます。';
