 ...
 * @updated    2015-10-29 19:31:22 UTC
...
$string['showonlineuserssideblockdescriptionmessage'] = 'この設定を有効にした場合、ユーザに対して、オンラインユーザ一覧のサイドブロックが表示されます。';
...
$string['showtagssideblockdescription1'] = 'この設定を有効にした場合、ユーザに対して、最も使用されたタグがサイト内のいくつかの場所に表示されます。';
$string['simple'] = 'シンプル';
...
$string['registrationalloweddescription3'] = 'あなたのシステム内にあるこのインスティテューションに対して、ユーザが登録フォームで登録できるかどうか設定します。登録が無効にされた場合、非メンバーはインスティテューションのメンバーシップをリクエストできません。同様にメンバーがインスティテューションから離脱できない、または自分のユーザアカウントを削除できないようになります。';
...
$string['institutionusersinstructionsmembers'] = '左側のユーザ一覧にはあなたのインスティテューションのすべてのユーザが表示されます。あなたは表示されるユーザ数を減らすため、検索ボックスを使用することができます。ユーザをインスティテューションから削除するには最初に1名またはそれ以上のユーザを左側のボックスで選択した後、右矢印をクリックしてください。あなたが選択したユーザが右側のボックスに移動されます。「ユーザを削除する」ボタンをクリックすることで、右側ボックスのすべてのユーザが削除されます。左側ボックスのユーザはインスティテューションに参加したままの状態です。';
$string['institutionusersinstructionsinvited'] = '左側のユーザ一覧にはインスティテューションへの参加の招待が送信されたすべてのユーザおよび誰が承認または拒否したか表示されます。あなたは表示されるユーザ数を減らすため、検索ボックスを使用することができます。インスティテューションへの招待を取り消すには最初に1名またはそれ以上のユーザを左側のボックスで選択した後、右矢印をクリックしてください。あなたが選択したユーザが右側のボックスに移動されます。「招待を取り消す」ボタンをクリックすることで、右側ボックスのすべてのユーザへの招待が取り消されます。左側ボックスのユーザはインスティテューションに招待されたままの状態で、いつでもインスティテューションに参加することができます。';
