...
未ログイン数: %s';
$string['cli_deleteinactivegroups_info'] = 'このコマンドラインPHPスクリプトではあなたが古いグループを削除できます。これは現在メンバーがいないグループのみに動作します。「onlyadmins」フラグが設定された場合、オーナー/管理者が1名のみのグループを対象に含むことができます。';
