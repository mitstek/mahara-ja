...
$string['dropdownmenudescriptioninstitution1'] = 'この設定を有効にした場合、メインナビゲーションにドロップダウンメニュを使用します。';
...
$string['menuitemdeleted'] = 'メニュアイテムが削除されました。';
$string['menuitemsaved'] = 'メニュアイテムが保存されました。';
$string['menuitemsloaded'] = 'メニュアイテムが読み込まれました。';
$string['name'] = '名称';
$string['nositefiles'] = '利用できるサイトファイルはありません。';
$string['public'] = 'パブリック';
$string['savingmenuitem'] = 'メニュアイテムの保存中';
$string['type'] = 'タイプ';
