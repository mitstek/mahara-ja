...
$string['institutionusersinstructionsnonmembers1'] = '「 %1$s 」フィールドのユーザ一覧では、あなたのインスティテューションへの参加をまだリクエストしていないユーザすべてが表示されます。表示されるユーザ数を減らすため、あなたは検索ボックスを使用することができます。ユーザをインスティテューションに参加するよう招待するには1名またはそれ以上のユーザを選択して右矢印をクリックすることにより、最初にユーザを「 %2$s 」フィールドに移動してください。「ユーザを招待する」ボタンにより、「 %2$s 」フィールド内のユーザすべてに招待状を送信します。招待を受け入れるまで、これらのユーザはインスティテューションと関連付けられません。';
$string['institutionusersinstructionslastinstitution1'] = '「 %1$s 」フィールドのユーザ一覧では、あなたのインスティテューションへの参加をまだリクエストしていないユーザ、および選択されたインスティテューションを離れたユーザすべてが表示されます。表示されるユーザ数を減らすため、あなたは検索ボックスを使用することができます。ユーザをインスティテューションに参加するよう招待するには1名またはそれ以上のユーザを選択して右矢印をクリックすることにより、最初にユーザを「 %2$s 」フィールドに移動してください。「ユーザを招待する」ボタンにより、「 %2$s 」フィールド内のユーザすべてに招待状を送信します。招待を受け入れるまで、これらのユーザはインスティテューションと関連付けられません。';
$string['institutionusersinstructionsmembers1'] = '「 %1$s 」フィールドのユーザ一覧では、インスティテューションのメンバーすべてを表示します。表示されるユーザ数を減らすため、あなたは検索ボックスを使用することができます。インスティテューションからユーザを削除するには1名またはそれ以上のユーザを選択して右矢印をクリックすることにより、最初にユーザを「 %2$s 」フィールドに移動してください。あなたが選択したユーザは「 %2$s 」フィールドに移動されます。「ユーザを削除する」ボタンにより、「 %2$s 」フィールド内のユーザすべてをインスティテューションから削除します。';
$string['institutionusersinstructionsinvited1'] = '「 %1$s 」フィールドのユーザ一覧では、インスティテューションに参加するよう招待状が送信され、まだ承認または拒否していないユーザすべてが表示されます。表示されるユーザ数を減らすため、あなたは検索ボックスを使用することができます。インスティテューションへの招待を取り消すには、1名またはそれ以上のユーザを選択して右矢印をクリックすることにより、最初にユーザを「 %2$s 」フィールドに移動してください。あなたが選択したユーザは「 %2$s 」フィールドに移動されます。「招待を取り消す」ボタンにより、「 %2$s 」フィールド内のユーザすべてに対する招待を削除します。他のユーザのインスティテューションへの招待は保持され、いつでも参加することができます。';
