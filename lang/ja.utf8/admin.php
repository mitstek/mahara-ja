 ...
 * @updated    2016-10-30 14:39:09 UTC
...
$string['homepageinfodescription3'] = 'Maharaに関する情報および利用状況がMaharaホームページに表示されます。登録済みユーザにはこれらの情報をダッシュボードに表示しないオプションがあります。';
...
$string['uploadgroupcsverrorshortnamealreadytaken1'] = 'あなたのファイルの %s 行目にエラーが発生しました: 省略名「 %s 」はすでに取得されています。有効な代替は「 %s 」です。';
...
$string['updategroupsdescription2'] = 'CSVファイル内のグループ省略名に合致するグループ詳細がCSVファイル内の情報で上書きされます。使用に注意してください。';
