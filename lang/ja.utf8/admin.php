...
$string['usereditdescription1'] = 'あなたはここでこのユーザアカウントを管理できます。アカウント管理には詳細変更、利用停止、削除およびインスティテューションのメンバーシップ変更を含みます。';
...
$string['registrationalloweddescription5'] = '人は登録フォームを使用してこのインスティテューションに登録できます。登録が無効にされた場合、非メンバーはインスティテューションのメンバーシップをリクエストできません。また、メンバーはインスティテューションを離れたり自分のユーザアカウントを削除できません。';
...
$string['institutiontagsdesc'] = 'インスティテューションタグが有効にされている場合、メンバーが利用できるタグを設定します。';
$string['approve'] = '承認';
$string['deny'] = '拒否';
...
$string['cli_deleteinactivegroups_onlyadmins'] = 'メンバーがオーナー/管理者のみのグループも含みます。';
$string['cli_deleteinactivegroups_onlydryrun'] = 'ここでは以下の設定によるドライランのみ実行します。
インスティテューション: %s
次の日付以前: %s
「group」テーブルから削除するグループ数: %s
オーナー/管理者のみのグループも削除する: %s
%s';
