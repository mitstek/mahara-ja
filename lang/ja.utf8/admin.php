 ...
 * @updated    2015-10-11 07:39:57 UTC
...
$string['cronnotrunning2'] = '<strong class="error text-danger">Cronが動作していません。</strong><br />cronのセットアップに関するインストラクションは<a href="http://wiki.mahara.org/System_Administrator\'s_Guide/Installing_Mahara">installation guide</a>をご覧ください。あなたがすでにcronをセットアップしている場合、直近の1つまたはそれ以上の処理が正しく実行されませんでした。';
...
$string['institutionautosuspenddescription1'] = '有効期限切れインスティテューションを自動的に利用停止します。';
...
$string['sitefilesaccessdescription1'] = '登録ユーザがサブフォルダ内のサイトファイルにアクセスできるようにします。デフォルトではトップレベルのディレクトリのみにアクセスすることができます。';
