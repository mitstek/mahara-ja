...
<p>あなたが「更新を週に1回送信してもよろしいですか?」をこの設定を有効にした場合、Maharaは週に1回、あなたのインストール済みMaharaに関する更新情報をmahara.orgに自動送信します。</p>
...
$string['requireregistrationconfirmdescription1'] = 'すべての新しい自己登録ユーザはアクティブになる前にインスティテューション管理者から承認される必要があります。そうではない場合、それぞれのインスティテューションは新しいアカウント登録に承認を必要とするかどうか決定できます。';
