 ...
 * @updated    2021-12-26 09:21:56 UTC
...
$string['allowgroupcategoriesdescription'] = 'この設定を有効にした場合、管理者はユーザがグループに割り当てることのできるカテゴリを作成できます。';
...
$string['anonymouscommentsdescription'] = 'この設定を有効にした場合、パブリックページまたはシークレットURLアクセス可能なページに対して未ログインユーザがコメントを投稿できます。';
...
$string['institutionexpirynotificationdescriptioninfo'] = 'サイトおよびインスティテューション管理者に対してサイト有効期限切れ前に通知メッセージが送信されます。';
$string['language'] = '言語';
$string['none'] = 'なし';
...
$string['showonlineuserssideblockdescriptionmessage'] = 'この設定を有効にした場合、ユーザにオンラインユーザ一覧のサイドブロックが表示されます。';
$string['showselfsearchsideblock'] = 'ポートフォリオ検索を有効にする';
$string['showselfsearchsideblockdescription1'] = '「私のポートフォリオを検索する」サイドブロックがサイト内の一部の場所に表示されます。';
$string['showtagssideblock'] = 'タグクラウドを有効にする';
$string['showtagssideblockdescription1'] = 'この設定を有効にした場合、ユーザに対して最も使用されたタグがサイト内の一部の場所に表示されます。';
$string['simple'] = 'シンプル';
...
$string['whocancreategroupsdescription'] = 'ここでは新しいグループを作成できるユーザを選択します。';
...
$string['registrationalloweddescription3'] = 'あなたのシステム内にあるこのインスティテューションに対してユーザが登録フォームで登録できるかどうか設定します。登録が無効にされた場合、非メンバはインスティテューションのメンバシップをリクエストできません。同様にメンバがインスティテューションから離脱できない、または自分のユーザアカウントを削除できないようになります。';
...
$string['institutionusersinstructionsrequesters'] = '左側のユーザ一覧にはあなたのインスティテューションに参加をリクエストした、すべてのユーザが表示されます。あなたは表示されるユーザ数を減らすため検索ボックスを使用できます。あなたがユーザをインスティテューションに追加したい場合、またはユーザのメンバシップリクエストを拒否したい場合、1名またはそれ以上のユーザを選択して右矢印をクリックすることで最初にユーザを右側ボックスに移動してください。「メンバを追加する」ボタンをクリックすることで右側ボックスのすべてのユーザをインスティテューションに追加できます。「リクエストを拒否する」ボタンをクリックすることで右側ボックスのユーザのメンバシップリクエストを拒否できます。';
...
$string['institutionusersinstructionsmembers'] = '左側のユーザ一覧にはあなたのインスティテューションのすべてのユーザが表示されます。あなたは表示されるユーザ数を減らすため検索ボックスを使用できます。ユーザをインスティテューションから削除するには最初に1名またはそれ以上のユーザを左側のボックスで選択した後、右矢印をクリックしてください。あなたが選択したユーザが右側のボックスに移動されます。「ユーザを削除する」ボタンをクリックすることで右側ボックスのすべてのユーザが削除されます。左側ボックスのユーザはインスティテューションに参加したままの状態です。';
$string['institutionusersinstructionsinvited'] = '左側のユーザ一覧にはインスティテューションへの参加の招待が送信されたすべてのユーザおよび誰が承認または拒否したか表示されます。あなたは表示されるユーザ数を減らすため検索ボックスを使用できます。インスティテューションへの招待を取り消すには最初に1名またはそれ以上のユーザを左側のボックスで選択した後、右矢印をクリックしてください。あなたが選択したユーザが右側のボックスに移動されます。「招待を取り消す」ボタンをクリックすることで右側ボックスのすべてのユーザへの招待が取り消されます。左側ボックスのユーザはインスティテューションに招待されたままの状態でいつでもインスティテューションに参加できます。';
