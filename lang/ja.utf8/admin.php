...
$string['institutionsettingsdescription'] = 'あなたが管理者しているインスティテューションに関してこの人のメンバーシップ設定を変更できます。';
...
$string['cli_deleteinactiveusers_userunabletoclean'] = 'アカウント「 %s 」(ID %s) を完全に削除することはできません。';
