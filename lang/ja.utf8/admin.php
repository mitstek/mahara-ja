 ...
 * @updated    2026-04-05 14:30:55 UTC
...
$string['notificationsettingsdescription'] = 'ここであなたは新しいアカウント保持者が受信する通知のデフォルトオプションを設定できます。人はこれらの設定を自分の「アカウントメニュー → 設定 → 通知」ページでオーバーライドできます。<br>あなたがメールオプションのどちらを選択した場合でも通知は受信ボックスに到着しますが、自動的に既読マークされます。';
$string['allow_inst_admins_to_manage_issue_reports'] = 'インスティテューション管理者がイシュレポートを受信する';
$string['allow_inst_admins_to_manage_issue_reports_desc'] = 'インスティテューション管理者はイシュレポートを通知として受信できます。インスティテューション管理者はサイト管理者と同様にレポートを受信するかどうか決定できます。';
...
$string['add_block_to_view_add_anyway'] = '指定された種類のブロックタイプがすでに存在していてもさらにそれを追加します。';
