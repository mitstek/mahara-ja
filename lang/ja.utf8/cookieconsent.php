 ...
 * @updated    2026-07-23 07:47:35 UTC
...
$string['cookieconsentintro11'] = '「クッキー命令」として知られる命令2009/136/ECはEU全体におけるクッキーの同意に関する要件を定めています。これは命令2002/58/ECを改正するものであり、電子通信におけるデータ保護およびプライバシを対象としています。';
$string['cookieconsentintro21'] = '新しい命令は2011年5月25日に施行されました。クッキーに関する主な規定は改正された命令の第5条第3項に記載されています。';
...
$string['cookieconsentintro41'] = '要するにデバイスに情報を保存したり、デバイスから情報を取得したりする前に人はインフォームドコンセントを与える必要があります。これはプライバシを保護した上で組織が人に知らせずに情報収集することを防ぐことを目的としています。';
$string['cookieconsentintro53'] = '下の%クッキーコンセント%sを有効にした場合、画面下部にあなたのプライバシページへのリンクを含むバナーが表示されます。あなたのプライバシページにクッキーの使用に関する情報が含まれていることを確認してください。';
