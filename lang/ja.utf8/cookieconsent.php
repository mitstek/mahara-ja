...
$string['cookieconsentintro1'] = '「クッキー命令」または「クッキー法」として知られる欧州議会および理事会の2009/136/EC命令は欧州におけるクッキー同意に関する必要条件を定義した法律文書です。これは基本的に前の命令「2002/58/EC」の修正案です。そしてウェブのデータおよびプライバシ、その他の電子コミュニケーションに対して広範に関係します。';
$string['cookieconsentintro2'] = '新しい命令は2011年5月25日に発効されました。本文は26ページに渡りますがクッキーに関する最も重要な段落は20ページにあります。これは前の命令「2002/58/EC」の記事5(3)を修正したものです。';
...
$string['cookieconsentintro51'] = '最初に下記の%sSilktideによるクッキーコンセントプラグイン%sを有効にして必要なオプションを設定した後、あなたの変更を保存してください。あなたはクッキーコントロールを有効にするため修正に関する詳細インストラクション、またはあなたのテーマヘッダファイルまたは「$cfg->additionalhtmlhead」設定の更新方法に関して記載された別ページにリダイレクトされます。';
$string['cookieconsentenable'] = 'クッキーコンセントを有効にしてもよろしいですか?';
$string['cookieconsentenabled'] = 'クッキーコンセントが有効にされ設定が保存されました。';
...
$string['instructiontext1'] = '%s クッキーを設定するJavaScriptを探します。例には %s を使用できます。';
...
$string['itdidntwork1'] = '最初に「<b>%s</b>」を「<b>%s</b>」の代わりに使用してください。これにより<tt>document.write()</tt>を使用するJavaScriptプラグインを調整します。';
...
$string['consentmodeimplicit'] = '暗黙 - クッキーを設定してビジターによる使用停止を許可します。';
...
$string['bannerpositiondesc'] = '画面トップまたはボトムのどちらにコンセントバナーを表示するか選択してください。';
$string['bannerpositiontop'] = 'トップ';
$string['bannerpositionpush'] = 'トップからプッシュする (実験用)';
$string['bannerpositionbottom'] = 'ボトム';
$string['tabposition'] = 'タブポジション';
$string['tabpositiondesc'] = 'プライバシ設定タブが表示される場所を選択してください。';
$string['tabpositionbottomright'] = '右ボトム';
$string['tabpositionbottomleft'] = '左ボトム';
...
$string['pagerefreshdesc1'] = 'あなたがクッキーの同意を意識しているサーバサイドのアプリケーションを使用している場合、この設定を有効にすることにより同意された後にページがリロードされます。';
$string['ignoredonottrack'] = '行動追跡拒否 (do not track) を無視する';
$string['ignoredonottrackdesc1'] = 'この設定を有効にすることによりクッキーコンセントは訪問者のブラウザの「行動追跡拒否 (do not track)」ヘッダを無視します。';
...
$string['necessaryDefaultDescription'] = 'このウェブサイトの一部のクッキーは厳密に必要であるため無効にできません。';
...
$string['notificationTitleImplicit'] = 'あなたが私たちのウェブサイトで最良の経験を得ることを保証するため私たちはクッキーを使用します。';
...
$string['savePreference'] = 'プレファレンスを保存する';
...
$string['allSitesSettingsDialogSubtitle'] = 'あなたはこのプラグインを使用するすべてのウェブサイトに対してこれらのクッキーに同意できます。';
