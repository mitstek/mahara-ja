 ...
 * @updated    2017-01-24 00:32:12 UTC
...
$string['cookieconsentenable'] = 'クッキコンセントを有効にする';
...
$string['hideprivacytabdesc'] = 'オリジナルの埋め込みプライバシ設定リンクを使用する場合 (例 あなたのテーマテンプレート内)、あなたは標準プライバシ設定タブを無効にしても良いでしょう。';
$string['featureoptions'] = '機能オプション';
$string['pagerefresh'] = 'ページリフレッシュ';
$string['pagerefreshdesc'] = 'あなたにクッキ同意を認識する必要のあるサーバサイドアプリケーションがある場合、このオプションを選択することで同意後にページがリロードされます。';
$string['ignoredonottrack'] = '行動追跡拒否 (do not track) を無視する';
$string['ignoredonottrackdesc'] = 'この設定を有効にした場合、クッキコンセントは訪問者のブラウザの「行動追跡拒否 (do not track) 」ヘッダを無視することを意味します。';
$string['usessl'] = 'SSLを使用する';
$string['usessldesc'] = 'SSLを使用してページにクッキコンセントを表示する場合、あなたはこのオプションを選択する必要があります。';
