...
$string['cookieconsentintro1'] = '「クッキー命令」または「クッキー法」として知られる欧州議会および理事会の2009/136/EC命令は欧州におけるクッキー同意に関する必要条件を定義した法律文書です。これは基本的に前の命令「2002/58/EC」の修正案です。そしてウェブのデータおよびプライバシー、その他の電子コミュニケーションに対して広範に関係します。';
...
$string['necessaryDefaultDescription'] = 'このウェブサイトのいくつかのクッキーは厳密に必要であるため無効にできません。';
...
$string['privacySettingsDialogSubtitle'] = 'あなたが誰であるか記憶するためこのサイトのいくつかの機能ではあなたの同意を必要とします。';
