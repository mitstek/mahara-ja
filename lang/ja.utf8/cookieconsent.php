 ...
 * @updated    2017-01-24 00:33:52 UTC
...
$string['cookieconsentintro1'] = '「クッキ命令」または「クッキ法」として知られる欧州議会および理事会の2009/136/EC命令は欧州におけるクッキ同意に関する必要条件を定義した法律文書です。これは基本的に前の命令「2002/58/EC」の修正案です。そしてウェブのデータおよびプライバシ、その他の電子コミュニケーションに対して広範に関係します。';
$string['cookieconsentintro2'] = '新しい命令は2011年5月25日に発効されました。本文は26ページに渡りますがクッキに関する最も重要な段落は20ページにあります。これは前の命令「2002/58/EC」の記事5(3)を修正したものです。';
$string['cookieconsentintro3'] = '「加盟国は情報の保存またはすでに保存されている情報へのアクセスに関して命令95/46/ECに従って明確および包括的な情報を提供されている購読者またはユーザの端末装置において、特に処理の目的に関する同意を得る必要があります。これは技術的保存または電子証券取引ネットワークに関する通信伝送を実現するための唯一のアクセス手段、購読者またはユーザからサービスの提供を求められている厳密に必要な情報社会サービス提供者を阻むものであってはなりません」';
...
$string['cookieconsentintro4'] = '要するにコンピュータ、モバイルフォンまたは他のデバイスから情報を保存または検索する前にユーザの同意が必要であることを意味します。この目的はエンドユーザのプライバシを増すこと、そして国民が知ることなしに組織が情報を取得することを防ぐことにあります。';
$string['cookieconsentintro51'] = '最初に下記の%sSilktideによるクッキコンセントプラグイン%sを有効にして必要なオプションを設定した後、あなたの変更を保存してください。あなたはクッキコントロールを有効にするため修正に関する詳細インストラクション、またはあなたのテーマヘッダファイルまたは「$cfg->additionalhtmlhead」設定の更新方法に関して記載された別ページにリダイレクトされます。';
$string['cookieconsentenable'] = 'クッキコンセントを有効にしますか?';
$string['cookieconsentenabled'] = 'クッキコンセントが有効にされ設定が保存されました。';
$string['cookieconsentdisabled'] = 'クッキコンセントが無効にされました。';
$string['cookieconsent2'] = '追加サイト修正';
$string['additionalmodifications'] = 'クッキコントロールを完全に有効にしたい場合、あなたのテーマヘッダファイルまたは<tt>$cfg->additionalhtmlhead</tt>設定を修正または更新する必要があります。';
$string['instructiontext1'] = '%s クッキを設定するJavaスクリプトを探します。例には %s を含めます。';
...
$string['itdidntwork2'] = 'これが手助けとならない場合、%sクッキコンセントコード例ページをチェックするか%s、%sクッキコンセントLinkedInグループ%sにご相談ください。';
$string['generaloptions'] = '一般オプション';
$string['cookietypes'] = 'クッキタイプ';
$string['cookietypesdesc'] = 'あなたのサイトで使用しているクッキタイプを選択してください。';
...
$string['consentmodedesc1'] = 'ブラウザの「行動追跡拒否 (do not track)」設定が有効にされている場合、(下記「機能オプション」でオーバーライドされない限り」) クッキコンセントは常に明示モードを使用します。';
$string['consentmodedesc2'] = '最新バージョンのInternet Explorerでは「行動追跡拒否 (do not track)」設定がデフォルトで有効にされています。';
$string['consentmodeexplicit'] = '明示 - ビジターが承諾するまでクッキを設定しません。';
$string['consentmodeimplicit'] = '暗黙 - クッキを設定してビジターによる使用停止を許可します。';
$string['stylingoptions'] = 'スタイリングオプション';
$string['pluginstyle'] = 'スタイル';
$string['pluginstyledesc'] = 'クッキコンセントの概観を変更します。';
...
$string['tabpositiondesc'] = 'プライバシ設定タブが表示される場所を選択してください。';
...
$string['hideprivacytab'] = 'プライバシ設定タブを秘匿する';
$string['hideprivacytabdesc1'] = 'あなた独自のプライバシ設定リンクをインラインで使用したい場合 (例 あなたのテンプレート内)、この標準プライバシ設定タブを無効にしてください。';
$string['featureoptions'] = '機能オプション';
$string['pagerefresh'] = 'ページリフレッシュ';
$string['pagerefreshdesc1'] = 'あなたがクッキの同意を意識しているサーバサイドのアプリケーションを使用している場合、この設定を有効にすることにより同意された後にページがリロードされます。';
$string['ignoredonottrack'] = '行動追跡拒否 (do not track) を無視する';
$string['ignoredonottrackdesc1'] = 'この設定を有効にすることによりクッキコンセントは訪問者のブラウザの「行動追跡拒否 (do not track)」ヘッダを無視します。';
$string['usessl'] = 'SSLを使用する';
$string['usessldesc1'] = 'クッキコンセントのページのいずれかがSSL上に表示される場合、あなたはこの設定を有効にする必要があります。';
...
$string['analyticsDefaultDescription'] = 'あなたの経験を改善するためこのウェブサイトサイトの利用に関して匿名で記録します。';
$string['advertisingDefaultDescription'] = '過去の行動および興味に基づき、あなたに広告が自動的に選択されます。';
$string['necessaryDefaultTitle'] = '厳密に必要';
$string['necessaryDefaultDescription'] = 'このウェブサイトの一部のクッキは厳密に必要であるため無効にできません。';
$string['defaultTitle'] = 'デフォルトクッキタイトル';
$string['defaultDescription'] = 'デフォルトクッキ説明';
$string['learnMore'] = '詳細情報';
$string['closeWindow'] = 'ウィンドウを閉じる';
$string['notificationTitle'] = 'このサイトにおけるあなたの経験は次のクッキにより改善されます';
$string['notificationTitleImplicit'] = 'あなたが私たちのウェブサイトで最良の経験を得ることを保証するため私たちはクッキを使用します。';
$string['customCookie'] = 'このウェブサイトでは特定の承認が必要なカスタムタイプのクッキを使用しています。';
$string['seeDetails'] = '詳細を表示する';
$string['seeDetailsImplicit'] = 'あなたの設定を変更する';
$string['hideDetails'] = '詳細を秘匿する';
$string['allowCookies'] = 'クッキを許可する';
...
$string['privacySettingsDialogTitleA'] = 'プライバシ設定';
$string['privacySettingsDialogTitleB'] = '(このウェブサイトに対して)';
$string['privacySettingsDialogSubtitle'] = 'あなたが誰であるか記憶するためこのサイトの一部の機能ではあなたの同意を必要とします。';
...
$string['notUsingCookies'] = 'このウェブサイトはクッキを使用しません。';
$string['allSitesSettingsDialogTitleA'] = 'プライバシ設定';
$string['allSitesSettingsDialogTitleB'] = '(すべてのウェブサイトに対して)';
$string['allSitesSettingsDialogSubtitle'] = 'あなたはこのプラグインを使用するすべてのウェブサイトに対してこれらのクッキに同意できます。';
