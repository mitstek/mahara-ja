...
$string['pagerefreshdesc1'] = 'あなたがクッキーの同意を意識しているサーバサイドのアプリケーションを使用している場合、この設定を有効にすることで同意された後にページがリロードされます。';
$string['ignoredonottrack'] = '行動追跡拒否 (do not track) を無視する';
$string['ignoredonottrackdesc1'] = 'この設定を有効にすることでクッキーコンセントは訪問者のブラウザの「行動追跡拒否 (do not track)」ヘッダを無視します。';
