...
<p>[<b>あなたの組織名</b>]は<a href="https://mahara.org">Mahara</a>により構築されています。Maharaは (GNU General Public License 一般公衆利用許諾契約書の下)、無償のオープンソースソフトウェアとして提供されます。下記条件に同意することにより、あなたにMaharaのコピー、使用および修正が許可されていることを意味します:</p>
...
<p>[<b>サイト名</b>]のユーザとして、どのような個人情報を他のユーザが利用できるようにするか決定することができます。デフォルトでは管理者、コース作成者またはチューター権限が割り当てられたユーザを除き、ユーザに対してあなたが希望する名前のみ表示されます。この名前は通知レポートまたは訪問ログの一覧にも表示されます。</p>
...
<p>[<b>サイト名</b>]サイト管理者はすべてのユーザに対して安全で常に利用可能なeポートフォリオシステムを提供するため、あらゆる適切な措置をとることを保証します。あなたのユーザとしての権利が保護されていないと思われた場合、また以下の内容に関してご質問をお持ちの場合、すぐに私たちに<a href="contact.php">ご連絡ください</a>。
...
<p>サイト管理者により設定された一定期間または一定の休眠期間により、あなたの[<b>サイト名</b>]アカウントは無効となります。あなたのアカウントの有効期限が切れる前、メールによるリマインダが送信されます。将来的に再利用できるようあなたのパーソナルコンピュータに最新のポートフォリオを保存されることをお勧めします。</p>

<p>あなたが[<b>サイト名</b>]にアップロードした、すべてのファイルおよびコンテンツは国内の著作権法に従うものとします。あなたは自分のものではない著作物に対して複製および公開することのできる適切な許諾があることを保証する義務があります。著作物の盗用はあなたの属する教育機関のポリシーに従い処分されるものとします。</p>
...
<p>システム変更およびユーザのフィードバックに基づき、私たちは使用条件を若干変更する場合があります。あなたがこのサイトを訪問するたび、使用条件の確認をお勧めします。使用条件の主要な変更に関して私たちは[<b>サイト名</b>]ホームページでユーザに告知します。</p>';
