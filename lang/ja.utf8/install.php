...
<p>[<b>サイト名</b>]を使用するためにはあなたのブラウザのクッキを有効にする必要があります。[<b>サイト名</b>]で使用するクッキには個人情報が保存されることはありません。</p>
...
<p>サイト管理者により設定された一定期間または一定の休眠期間によりあなたの[<b>サイト名</b>]アカウントは無効となります。あなたのアカウントの有効期限が切れる前、メールによるリマインダが送信されます。将来的に再利用できるようあなたのパーソナルコンピュータに最新のポートフォリオを保存されることをお勧めします。</p>
