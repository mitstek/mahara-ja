...
<p>不快感を与えるコンテンツを保存、または表示することを目的としてあなたのポートフォリオを使用できません。あなたのポートフォリオ内に不適切なコンテンツがあるとの報告をサイト管理者が受けた場合、学生運営ポリシーまたは同等のあなたの教育機関のポリシーに従った調査のためあなたのアカウントは停止され[<b>サイト名</b>]へのアクセスは凍結されます。運営ポリシーが存在しない場合、適切なスタッフメンバー、またはあなたの教育機関または組織に付託されます。</p>
