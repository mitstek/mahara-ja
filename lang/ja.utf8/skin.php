 ...
 * @updated    2016-06-12 17:03:02 UTC
...
$string['skinpreview'] = '「 %s 」のプレビュ';
$string['skinpreviewedit'] = '「 %s 」のプレビュ - クリックして編集する';
...
$string['skincustomcssdescription'] = 'カスタムCSSはスキンプレビュイメージには反映されません。';
...
$string['fontuploadinstructions'] = '<br />必要なフォントファイルをアップロードする場合、あなたは<a href="https://www.fontsquirrel.com/fontface/generator/" target="_blank">FontSquirrel Online Generator</a>によって生成されたZIPファイルを直接アップロードするか、
...
<li><a href="https://www.google.com/fonts/" target="_blank">Googleフォント</a>にアクセスしてください。</li>
