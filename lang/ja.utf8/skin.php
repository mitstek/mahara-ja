 ...
 * @updated    2016-05-12 13:10:15 UTC
...
$string['clicktoedit'] = 'このスキンを編集するためにクリックする';
...
$string['notcompatiblewithpagetheme'] = 'このページテーマ「 %s 」はページスキンをサポートしていません。あなたが異なるテーマを選択するまで、あなたが選択したスキンはページアピアランスに影響を及ぼしません。';
