...
$string['skinpreview'] = '「 %s 」のプレビューー';
$string['skinpreviewedit'] = '「 %s 」のプレビューー - クリックして編集する';
...
$string['skincustomcssdescription'] = 'カスタムCSSはスキンプレビューーイメージには反映されません。';
