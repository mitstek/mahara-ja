 ...
 * @updated    2024-04-09 05:42:37 UTC
...
プラグインを再度有効にするにはあなたのサイトの「拡張機能管理」ページにアクセスしてください。';
$string['next'] = '次へ';
...
$string['confirmdeletetag'] = '本当にあなたのポートフォリオすべてのアイテムからこのタグを削除してもよろしいですか?';
$string['deletetagdescription'] = 'あなたのポートフォリオすべてのアイテムからこのタグを削除します。';
