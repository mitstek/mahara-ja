...
$string['pluginexplainaddremove'] = 'Maharaプラグインは常にインストールされるためURLを知っていてアクセスしようと思うユーザはアクセスできます機能を有効または無効にする代わりに以下のプラグインの横にある「表示」または「秘匿」リンクをクリックしてプラグインを表示または秘匿できます。';
