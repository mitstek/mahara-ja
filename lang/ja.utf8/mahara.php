 ...
 * @updated    2011-05-16 14:40:03 UTC
...
$string['pluginexplainaddremove'] = 'Maharaプラグインは常にインストールされるため、URIを知っているユーザはアクセスすることができます。機能を有効または無効にする代わりに、以下のプラグインの横にある「表示」または「非表示」リンクをクリックすることで、プラグインを表示または非表示にすることができます。';
...
$string['registerstep3fieldsoptional'] = '<h3>任意のプロファイルイメージを選択する</h3><p>あなたは正常に %s にユーザ登録されました! あなたのアバターとして表示する、任意のプロファイル写真を選択することができます。</p>';
...
$string['institutionaladministration'] = 'インスティテューション管理';
