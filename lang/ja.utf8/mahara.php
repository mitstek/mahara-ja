...
$string['institutionnotfound'] = 'インスティテューション「 %s 」が見つかりませんでした。';
...
$string['institutionmembershipdescription'] = 'あなたがインスティテューションのメンバーである場合、ここにインスティテューションが一覧表示されます。ここにインスティテューションが一覧表示されます。あなたはインスティテューションのメンバーシップをリクエストすることもできます。また、保留中のメンバーシップ招待を承認または拒否できます。';
