...
$string['showusermenu'] = 'ユーザメニュを表示する';
...
$string['pluginexplainaddremove'] = 'Maharaプラグインは常にインストールされるためURLを知っていてアクセスしようと思うユーザはアクセスできます機能を有効または無効にする代わりに以下のプラグインの横にある「表示」または「非表示」リンクをクリックしてプラグインを表示または非表示にできます。';
