 ...
 * @updated    2017-03-16 06:25:17 UTC
...
$string['licensemandatoryerror'] = 'ライセンスフィールドは必須フィールドです。';
...
$string['javascriptnotenabled'] = 'あなたのブラウザではJavaScriptが有効にされていません。あなたがログインするにはこのサイトではJavaScriptを有効にする必要があります。';
...
$string['registerstep3fieldsmandatory'] = '<h3>必須プロファイルフィールドに入力する</h3><p>以下のフィールドは必須フィールドです。あなたの登録を完了するにはすべての必須フィールドに入力してください。</p>';
