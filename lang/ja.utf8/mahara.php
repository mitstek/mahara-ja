 ...
 * @updated    2018-01-16 23:48:54 UTC
...
$string['javascriptnotenabled'] = 'あなたのブラウザでJavaScriptが有効にされていません。あなたがログインするにはこのサイトではJavaScriptを有効にする必要があります。';
...
$string['pwchangerequestsentfullinfo'] = 'あなたのアカウントのパスワード変更に使用できるリンクを記載したメールがまもなく送信されます。<br>メールを受信できない場合、あなたが入力した内容が間違っているか、サイトへのアクセスに外部認証を使用しています。';
