 ...
 * @updated    2017-03-16 06:27:46 UTC
...
$string['registerstep3fieldsoptional'] = '<h3>任意のプロファイルイメージを選択する</h3><p>あなたは正常に %s にユーザ登録されました。あなたのアバタとして表示する任意のプロファイル画像を選択できます。</p>';
$string['registerstep3fieldsmandatory'] = '<h3>必須プロファイルフィールドに入力する</h3><p>以下のフィールドは必須です。あなたのユーザ登録を完了するにはすべての必須フィールドに入力してください。</p>';
...
$string['controlyourprivacylinked'] = 'あなたの<a href="%s">プライバシ</a>をコントロールする';
