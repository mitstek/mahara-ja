 ...
 * @updated    2017-03-16 06:44:01 UTC
...
$string['pluginexplainaddremove'] = 'Maharaプラグインは常にインストールされるため、URLを知っていてアクセス権のあるユーザはアクセスすることができます。機能を有効または無効にする代わりに以下のプラグインの横にある「表示」または「非表示」リンクをクリックすることでプラグインを表示または非表示にすることができます。';
