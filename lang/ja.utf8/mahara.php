...
%s のあなたのアカウントは %s で無効となります。

アカウントが無効にされた場合、あなたのアカウントを管理者が再度有効にするまでログインできません。

サイトにログインすることであなたのアカウントが無効になることを防げます。

%s サイト管理者';
$string['accountprefs'] = 'プレファレンス';
$string['accountsuspended'] = '%s 現在、あなたのアカウントは利用停止されています。
あなたの利用停止理由は次のとおりです: %s';
...
あなたはインスティテューション %s に追加されました。
';
$string['accountupdatednewinstitutionhtml'] = '
<p>あなたはインスティテューション %s に<strong>追加</strong>されました。</p>
';
$string['accountupdatedpasswordreset'] = '
以下のリンクを使用してあなたのパスワードを変更してください:
...
$string['activityprefs'] = '活動プレファレンス';
$string['add'] = '追加';
...
$string['cantbedeletedbeingusedascoverimage'] = 'このアーティファクトは既存のポートフォリオのカバーイメージで使用されているため削除できません。';
$string['cantchangepassword'] = '申し訳ございません、このインタフェースではパスワードを変更できません - 代わりにあなたのインスティテューションのインタフェースを使用してください。';
...
$string['country.af'] = 'アフガニスタン・イスラム共和国';
...
$string['country.sh'] = 'セントヘレナ、アセンションおよびトリスタンダクーニャ';
...
$string['country.ve'] = 'ベネズエラ (ボリバル共和国)';
...
$string['countryisocustomise'] = 'あなたのサイトの国名を調整するにはそれぞれの翻訳の「mahara.php」言語ファイルを編集するか、<a href="https://git.mahara.org/catalyst/mahara/-/wikis/Development/Language-strings#custom-lang-strings-in-local">localディレクトリにストリングを作成してください</a>。';
...
$string['debugemail'] = '注意: このメールは %s <%s> 宛のメールですが「sendallemailto」設定によりあなたに送信されています。';
$string['decline'] = '拒否';
...
$string['emailinvalid'] = 'メールアドレスが有効ではありません。';
...
$string['image'] = 'イメージ';
$string['imagebrowserdescription'] = '外部イメージURLを貼り付けるか、以下のイメージブラウザを使用してあなたのイメージを選択またはアップロードしてください。';
...
既存のアカウントを整理するか、このインスティテューションに関する最大アカウント数の増加をご依頼くださいすべてのサイト管理者は制限を増加できます。

--
%s チーム';
$string['institutionmembershipfullmessagetextuser'] = '%s さん、こんにちは。

%s がインスティテューション「 %s 」(%s) への移動を希望していますがインスティテューションメンバ数上限に達しています。
...
$string['nodeletepermission'] = 'あなたにはこのアーティファクトを削除するためのパーミッションがありません。';
$string['noeditpermission'] = 'あなたにはこのアーティファクトを編集するためのパーミッションがありません。';
...
$string['none'] = 'なし';
$string['nopathfound'] = 'このアーティファクトのパスは見つかりませんでした。';
$string['nopeopleonlinefound'] = 'オンライン中の人は見つかりませんでした。';
$string['noprogressitems'] = 'このインスティテューションにプロファイル完了アイテムはありません。';
$string['nopublishpermissiononartefact'] = 'あなたには %s を公開するためのパーミッションがありません。';
...
$string['notifyadministratorreview'] = '本当に管理者がこのページを再度レビュするための準備ができましたか?';
...
$string['objectionablematerialreportedowner'] = '誰かがあなたのページに好ましくないコンテンツが含まれていると報告しました。あなたのページをレビュして必要に応じて調整してください。';
$string['objectionablematerialreportedreply'] = 'あなたが変更した場合、または詳しい説明を求める場合、管理者に知らせるため「好ましくないコンテンツをレビュする」ボタンをクリックしてください。';
$string['objectionablematerialreportreplied'] = '管理者がページをレビュしましたがまだ好ましくないコンテンツが含まれているようです。詳細はあなたの通知を確認してください。あなたは変更後、「好ましくないコンテンツをレビュする」ボタンをクリックして管理者にメッセージを送信できます。または詳しい説明を求めることができます。';
$string['objectionnotreviewed'] = '異議レビュ未了';
$string['objectionnotreviewedreply'] = 'レビュ未了の異議に返信する:

%s';
$string['objectionreview'] = '好ましくないコンテンツをレビュする';
$string['objectionreviewonview'] = 'ページからのみ好ましくないコンテンツへ返信できます';
$string['objectionreviewsent'] = '異議レビュがページオーナに送信されました。あなたが調整して別のレビュを送信したい場合、「まだ好ましくない」をクリックしてください。';
$string['off'] = 'Off';
...
$string['pluginbrokenanddisabled'] = '誰かが %s プラグインのロードを試みましたがロードできませんでした。
...
$string['pluginexplainaddremove'] = 'Maharaプラグインは常にインストールされているため、URLを知っている人であればアクセスできます。機能を有効または無効にする代わりに以下のプラグインの横にある「表示」または「秘匿」リンクをクリックしてプラグインを表示または秘匿できます。';
...
$string['privacystatement'] = 'プライバシ保護方針';
...
$string['progresspagedescription'] = 'コレクションのポートフォリオ完了ページです。';
...
$string['removefooterlinksupgradewarning'] = 'あなたのサイトは利用条件またはプライバシ保護方針のカスタムリンクを使用します。次のリンク「 %s 」は削除されました。あなたはサイトの「管理メニュー」 → 「サイト設定」 → 「法律」セクションに直接コンテンツを入力する必要があります。';
...
$string['reviewcomplaint'] = 'クレームのレビュ';
$string['reviewcomplaintdesc'] = 'あなたが作成者に何を変更すべきか詳細に伝えるために一緒に送信するメッセージを入力してください。フィールドを空白にした場合、代わりにオリジナルのクレームが送信されます。';
$string['reviewnotification'] = 'まだ好ましくないコンテンツが存在しているか確認するためポートフォリオをレビュするよう管理者に通知されました。';
$string['reviewnotificationdesc'] = 'まだ好ましくないコンテンツが存在している場合、レビュしてください。';
$string['reviewrequestsent'] = 'あなたのレビュリクエストが送信されました。';
...
$string['share'] = '共有';
$string['sharesubtitle'] = 'あなたのプライバシを管理する';
$string['show'] = '表示';
...
$string['youraccounthasbeensuspendedtext3'] = 'あなたは %s の同意を拒否したため %s のアカウントが利用停止されました。';
