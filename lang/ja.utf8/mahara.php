...
$string['javascriptnotenabled'] = 'あなたのブラウザではこのサイトに対してJavaScriptが有効にされていません。Maharaではあなたがログインする前にJavaScriptを有効にする必要があります。';
$string['cookiesnotenabled'] = 'あなたのブラウザではクッキーが有効にされていないかこのサイトからのクッキーがブロックされています。Maharaではあなたがログインする前にクッキーを有効にする必要があります。';
...
$string['yournewpassword'] = 'あなたの新しいパスワードです。あなたのパスワードは少なくとも半角英数字6文字にしてください。そしてパスワードには半角数字1文字および半角英文字2文字以上を含む必要があります。';
...
$string['forgotpassemaildisabled'] = '申し訳ございません、あなたが入力したユーザ名またはメールアドレスを持つユーザのメールアドレスは無効にされています。あなたのパスワードをリセットするには管理者にご連絡ください。';
...
$string['requiredfieldempty'] = '必須フィールドが空白です。';
...
$string['dashboarddescription'] = 'あなたのダッシュボードビューはあなたがログインして最初にホームページ上で閲覧することになるビューです。このビューはあなたのみアクセスできます。';
...
$string['organisedescription'] = 'あなたのポートフォリオを<a href="%s">ビュー</a>に整理できます。異なる閲覧者に対して異なるビューを作成します - あなたがビューに含む構成要素を選択します。';
