 ...
 * @updated    2015-09-11 15:25:44 UTC
...
$string['registerstep3fieldsoptional'] = '<h3>任意のプロファイルイメージを選択する</h3><p>あなたは正常に %s にユーザ登録されました! あなたのアバタとして表示する、任意のプロファイルアイコンを選択することができます。</p>';
...
$string['forgotpassemaildisabled'] = '申し訳ございません、あなたが入力したEメールアドレスまたはユーザ名のメール送信は無効にされています。あなたのパスワードをリセットするには、管理者にご連絡ください。';
