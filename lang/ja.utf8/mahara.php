...
<<<<<<< HEAD
 * @updated    2025-05-19 00:59:51 UTC
=======
 * @updated    2018-01-16 23:48:48 UTC
...
=======
$string['tagsdesc'] = 'このアイテムにのタグを検索または入力してください。';
$string['tagsdescprofile'] = 'このアイテムにのタグを検索または入力してください。「プロファイル」がタグ付けされたアイテムはあなたのサイドバーに表示されます。';
>>>>>>> 92099ba5d5a5390b497675e7809f65e21f9a5091
...
$string['institutiontagsdescription'] = 'インスティテューションタグはインスティテューションにより事前に定義されます。インスティテューションのすべてのメンバはインスティテューションタグを利用できます。あなたは好きなだけタグを作成できます。';
...
エクスポートツールを使用してあなたのポートフォリオのコンテンツを保存することをお勧めします。この機能の使用に関するインストラクションはユーザガイドに登録されています。
>>>>>>> 92099ba5d5a5390b497675e7809f65e21f9a5091
...
=======
<p>エクスポートツールを使用してあなたのポートフォリオのコンテンツを保存することをお勧めします。この機能の使用に関するインストラクションはユーザガイドに登録されています。</p>
>>>>>>> 92099ba5d5a5390b497675e7809f65e21f9a5091
...
=======
$string['registerprivacy'] = 'ここで収集したデータは私たちの<a href="privacy.php">プライバシ保護方針</a>に従って保存されます。';
...
既存のユーザアカウントを整理するか、このインスティテューションに関する最大ユーザアカウント数の増加をご依頼ください。すべてのサイト管理者は制限を増加できます。
...
$string['newuserscantpostlinksorimages1'] = '申し訳ございません、匿名または新しく登録されたユーザによるリンクの投稿は許可されていません。あなたの投稿からリンクまたはURLを取り除いた上で再度お試しください。';
$string['notinstallable'] = 'インストール不可';
>>>>>>> 92099ba5d5a5390b497675e7809f65e21f9a5091
