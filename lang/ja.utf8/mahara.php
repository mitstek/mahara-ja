 ...
 * @updated    2026-06-04 05:48:42 UTC
...
$string['license_help'] = '<h1>ライセンス</h1>
...
$string['instconf_artefactids_license_help'] = '<h1>ライセンス</h1>
<p>あなたがアップロードまたは作成するコンテンツのライセンスを選択してください。</p>
<hr>
<h2>詳細</h2>
<p>あなた自身のコンテンツに関して、他の人がどのように再利用できるか選択してください。他の人が作成したコンテンツに関して、あなたが再利用を許可されているライセンスを選択してください。</p>
<p>不明な点がある場合、コンテンの作成者またはあなたの組織にご確認ください。デフォルトのライセンスは標準的な著作権 (「All rights reserved」) ですが、あなたの組織によっては異なるライセンスが求められる場合があります。判断に迷う場合、あなたの組織の法務部門にご相談ください。</p>';
$string['editpost_filebrowser_license_help'] = '<h1>ライセンス</h1>
<p>あなたがアップロードまたは作成するコンテンツのライセンスを選択してください。</p>
<hr>
<h2>詳細</h2>
<p>あなた自身のコンテンツに関して、他の人がどのように再利用できるか選択してください。他の人が作成したコンテンツに関して、あなたが再利用を許可されているライセンスを選択してください。</p>
...
$string['institution_list'] = 'インスティテューション: %s';
...
$string['Create'] = '作成';
$string['Reusable_content'] = '再利用可能コンテンツ';
$string['Engage'] = '参加';
$string['Manage'] = '管理';
$string['settings'] = '設定';
$string['personalise'] = 'パーソナライズ';
$string['people'] = '人';
...
$string['alertssuccess'] = '成功アラート';
$string['alertsinfo'] = '情報アラート';
