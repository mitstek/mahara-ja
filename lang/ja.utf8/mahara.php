 ...
 * @updated    2017-03-16 06:25:11 UTC
...
$string['confirmdeletetag'] = '本当にあなたのポートフォリオのすべてのアイテムから、このタグを削除してもよろしいですか?';
$string['deletetagdescription'] = 'あなたのポートフォリオのすべてのアイテムから、このタグを削除します。';
...
$string['profilecompletenesspreview'] = 'プロファイル完了プレビューーー';
