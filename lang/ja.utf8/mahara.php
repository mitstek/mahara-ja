...
<p>あなたの新しいアカウントが <a href="">%s</a> に作成されました。あなたの詳細は以下のとおりです:</p>
...
$string['captchadescription'] = 'イメージの右側に表示されている文字を入力してください。入力する文字は大文字小文字の区別をしません。';
...
$string['registerstep1description'] = 'ようこそ! このサイトを利用するには最初に登録してください。また、あなたは<a href="terms.php">利用条件</a>に同意する必要があります。ここで収集したデータは私たちの<a href="privacy.php">プライバシ保護方針</a>に従って保存されます。';
...
<p>上記内容に関するご質問はお気軽に<a href="contact.php">お問い合わせください</a>。</p>
...
$string['notphpuploadedfile'] = 'アップロード処理中にファイルが消失しました。通常これは起こりません。詳細はあなたの管理者にお尋ねください。';
...
$string['filetypenotallowed'] = 'あなたはこのタイプのファイルのアップロードを許可されていません。詳細はあなたの管理者にお尋ねください。';
