 ...
 * @updated    2016-01-27 06:51:17 UTC
...
$string['tagsdescprofile'] = 'このアイテムにカンマで区切ったタグを入力してください。「プロファイル」タグが付けられたアイテムはあなたのサイドバーに表示されます。';
...
$string['registerstep3fieldsoptional'] = '<h3>任意のプロファイルイメージを選択する</h3><p>あなたは正常に %s にユーザ登録されました! あなたのアバタとして表示すは任意のプロファイル写真を選択することができます。</p>';
