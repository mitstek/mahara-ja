...
$string['usermenu1'] = 'アカウントメニュ';
$string['profilepage'] = 'プロファイルページ';
$string['mainmenu'] = 'メインメニュ';
$string['showmainmenu'] = 'メインメニュを表示する';
$string['showadminmenu'] = '管理メニュを表示する';
$string['showusermenu1'] = 'アカウントメニュを表示する';
$string['showsearch'] = '検索を表示する';
$string['showmenu'] = '%s のメニュを表示する';
$string['at'] = '@';
$string['From'] = 'From';
$string['To'] = 'To';
$string['ascending'] = '昇順';
...
$string['pluginexplainaddremove'] = 'Maharaプラグインは常にインストールされているため、URLを知っている人であればアクセスできます。機能を有効または無効にする代わりに以下のプラグインの横にある「表示」または「非表示」リンクをクリックしてプラグインを表示または非表示にできます。';
...
$string['profilecompletenesspreview'] = 'プロファイル完了プレビュ';
...
$string['cookiesnotenabled'] = 'あなたのブラウザはクッキが有効にされていないかクッキがブロックされています。あなたがログインするにはこのサイトではクッキを有効にする必要があります。';
...
$string['removefooterlinksupgradewarning'] = 'あなたのサイトは利用条件またはプライバシ保護方針のカスタムリンクを使用します。次のリンク「 %s 」は削除されました。あなたはサイトの「管理メニュ」 → 「サイト設定」 → 「法律」セクションに直接コンテンツを入力する必要があります。';
