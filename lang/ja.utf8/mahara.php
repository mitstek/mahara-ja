 ...
 * @updated    2017-03-16 06:25:06 UTC
...
$string['pluginexplainaddremove'] = 'Maharaプラグインは常にインストールされるためURLを知っているユーザはアクセスできます。機能を有効または無効にする代わりに以下のプラグインの横にある「表示」または「秘匿」リンクをクリックしてプラグインを表示または秘匿できます。';
...
$string['pluginbrokenanddisabled'] = 'ユーザが %s プラグインのロードを試みましたが、ロードできませんでした。
...
$string['newuserscantpostlinksorimages'] = '申し訳ございません、新しく登録されたユーザによるリンクの投稿は許可されていません。あなたの投稿からリンクまたはURLを取り除いた上で再度お試しください。';
