...
<p>あなたの新しいアカウントが <a href="">%s</a> に作成されました。あなたの詳細情報は以下のとおりです:</p>
...
$string['registerstep1description'] = 'ようこそ! このサイトを利用するには最初にユーザ登録してください。また、あなたは<a href="terms.php">利用条件</a>に同意する必要があります。ここで収集したデータは私たちの<a href="privacy.php">プライバシー保護方針</a>に従って保存されます。';
$string['registerstep3fieldsoptional'] = '<h3>任意のプロファイルイメージを選択する</h3><p>あなたは正常にユーザ登録されました! あなたのアバタとして表示する任意のプロファイルアイコンを選択することができます。</p>';
...
$string['clambroken'] = 'あなたの管理者がファイルのアップロードに関して、ウイルスチェックを有効にしましたが、設定が正しくないようです。あなたのファイルは正常にはアップロードされませんでした。あなたの管理者にメール通知が送信されましたので管理者は問題を修正することができます。このファイルのアップロードを後でお試しください。';
...
$string['notphpuploadedfile'] = 'アップロード処理中にファイルを喪失しました。これは通常起きることではありません。詳細はあなたの管理者にお尋ねください。';
