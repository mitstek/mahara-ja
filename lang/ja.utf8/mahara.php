...
$string['registerstep1description'] = 'ようこそ! このサイトを利用するには最初にユーザ登録してください。また、あなたは<a href="terms.php">利用条件</a>に同意する必要があります。ここで収集したデータは私たちの<a href="privacy.php">プライバシー保護方針</a>に従って保管されます。';
