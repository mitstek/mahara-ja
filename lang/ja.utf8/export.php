 ...
 * @updated    2009-11-16 21:13:42 UTC
...
$string['clicktopreview'] = 'クリックしてプレビュする';
...
$string['exportpagedescription'] = 'ここではあなたのポートフォリオをエクスポートできます。このツールはサイト設定を除くあなたのポートフォリオ情報すべて、およびビューをエクスポートします。';
...
$string['justsomeviews'] = '一部のマイビューのみ';
