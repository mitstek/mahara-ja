 ...
 * @updated    2013-12-24 15:51:13 UTC
...
$string['reallyaddaccesstoemptyview'] = 'あなたのビューにはブロックが含まれていません。本当にこれらのユーザに対してビューへのアクセス権を与えますか?';
...
$string['submitthisviewto'] = 'このビューを評価のため';
$string['forassessment'] = 'に送信する';
$string['accessfromdate2'] = '%s 以前、だれもこのビューを閲覧できません。';
$string['accessuntildate2'] = '%s 以降、だれもこのビューを閲覧できません。';
$string['accessbetweendates2'] = '%s 以前または %s 以降、だれもこのビューを閲覧できません。';
...
$string['feedbackonthisartefactwillbeprivate'] = 'このアーティファクトのフィードバックはオーナーのみ閲覧することができます。';
...
$string['placefeedbacknotallowed'] = 'あなたはこのビューへのフィードバック投稿を許可されていません。';
$string['print'] = 'プリント';
$string['thisfeedbackispublic'] = 'このフィードバックはパブリック (公開) にされています。';
...
$string['submitviewconfirm'] = 'あなたが「 %s 」を「 %s 」に評価のため送信する場合、チューターによるビューの採点完了まであなたのビューを編集することができません。本当にこのビューを送信してもよろしいですか?';
$string['submitviewtogroup'] = '評価のため「 %s 」を「 %s 」に送信する';
$string['cantsubmitviewtogroup'] = 'あなたはこのビューの評価を目的として、このグループに送信することはできません。';
...
$string['editaccesspagedescription2'] = '<p>デフォルトではあなたのみビューを閲覧することができます。ここではあなたのビュー情報を閲覧させたいユーザを選択することができます。パブリック、ログインユーザ、フレンドにアクセス権を与えるには「追加」をクリックしてください。個別のユーザまたはグループを検索するには検索ボックスを使用してください。すべての追加されたユーザまたはグループは右側のウィンドウ枠に表示されます。</p>
...
$string['canteditsubmitted'] = '%s による評価を目的として送信されたため、あなたはこのビューを編集することはできません。あなたのビューをチューターがリリースするまでお待ちください。';
...
$string['confirmcancelcreatingview'] = 'このビューの作成は完了していません。本当にキャンセルしてもよろしいですか?';
$string['editblockspagedescription'] = '<p>どのブロックをあなたのビューで表示するか、以下のタブより選択してください。あなたのビューレイアウトにブロックをドラッグ&ドロップすることができます。詳細はヘルプアイコン (?) をクリックしてください。</p>';
$string['displaymyview'] = 'マイビューを表示する';
$string['editthisview'] = 'このビューを編集する';
$string['success.addblocktype'] = 'ブロックが正常に追加されました。';
$string['err.addblocktype'] = 'あなたのビューにブロックを追加できませんでした。';
...
$string['blocksintructionnoajax'] = 'あなたのビューに追加するブロックを選択してください。あなたはブロックタイトルバーの矢印を使ってブロックの配置を変更することができます。';
$string['blocksinstructionajax'] = 'あなたのビューレイアウトにブロックを追加するにはこの下にドラッグしてください。あなたのビュー内でドラッグすることでブロックの配置を変更することができます。';
...
$string['viewcolumnspagedescription'] = '最初にあなたのビューのカラム数を選択してください。あなたは次のステップでカラム幅を変更することができます。';
...
$string['access'] = 'アクセス';
$string['noaccesstoview'] = 'あなたにはこのビューにアクセスするパーミッションがありません。';
$string['Template'] = 'テンプレート';
$string['allowcopying'] = 'コピーを許可する';
$string['templatedescription'] = 'この設定を有効にした場合、あなたのビューを閲覧できるユーザに対して自分のビューとしてコピーできるようにします。';
$string['choosetemplatepagedescription'] = '<p>ここでは新しいビュー作成の出発点として、あなたがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため、該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>';
$string['choosetemplategrouppagedescription'] = '<p>ここでは新しいビュー作成の出発点として、このグループがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため、該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>
<p><strong>注意:</strong> 現在、グループではブログまたはブログ記事をコピーすることはできません。</p>';
$string['choosetemplateinstitutionpagedescription'] = '<p>ここでは新しいビュー作成の出発点として、このインスティテューションがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため、該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>
...
$string['copyfornewmembersdescription'] = '%s のすべての新しいメンバーに対してこのビューのパーソナルコピーを自動作成します。';
$string['copyfornewgroups'] = '新しいグループにコピーする';
$string['copyfornewgroupsdescription'] = '以下のグループタイプの新しいグループすべてに対してこのビューをコピーします:';
...
$string['viewcopywouldexceedquota'] = 'このビューを追加することであなたのファイルクオータを越えてしまいます。';
$string['blockcopypermission'] = 'ブロックのコピーパーミッション';
$string['blockcopypermissiondesc'] = 'このビューを他のユーザがコピーできるようにした場合、あなたはこのブロックをどのようにコピーできるか選択することができます。';
$string['comment'] = 'コメント';
