...
$string['ownerformatdescription'] = '他のユーザがあなたのビューを閲覧する場合、あなたの氏名をどのように表示しますか?';
...
$string['viewssharedtogroupbyothers'] = 'このグループで共有されている他のメンバのビュー';
...
$string['submitviewconfirm'] = 'あなたが「 %s 」を「 %s 」に評価のため送信する場合、チュータによるビューの採点完了まであなたのビューを編集できません。本当にこのビューを送信してもよろしいですか?';
...
$string['overridingstartstopdatesdescription'] = 'あなたは開始日および終了日をオーバーライドできます。アクセス開始日およびアクセス終了日をどのように設定したとしても開始日以前および終了日以降には他のユーザはビューを閲覧できません。';
...
$string['canteditsubmitted'] = '%s による評価を目的として送信されたため、あなたはこのビューを編集できません。あなたのビューをチュータがリリースするまでお待ちください。';
$string['Submitted'] = '送信済み';
$string['submittedforassessment'] = '評価のため送信済み';
$string['addtutors'] = 'チュータを追加する';
...
$string['editblockspagedescription'] = '<p>どのブロックをあなたのビューで表示するか、以下のタブより選択してください。あなたのビューレイアウトにブロックをドラッグ&ドロップできます。詳細はヘルプアイコン (?) をクリックしてください。</p>';
...
$string['blocksintructionnoajax'] = 'あなたのビューに追加するブロックを選択してください。あなたはタイトルバーの矢印ボタンを使ってブロックの配置を変更できます。';
$string['blocksinstructionajax'] = 'あなたのビューレイアウトにブロックを追加するにはこの下にドラッグしてください。あなたのビュー内でドラッグすることでブロックの配置を変更できます。';
...
$string['viewcolumnspagedescription'] = '最初にあなたのビューのカラム数を選択してください。あなたは次のステップでカラム幅を変更できます。';
...
$string['choosetemplatepagedescription'] = '<p>ここでは新しいビュー作成の出発点としてあなたがコピーを許可されているビューを検索できます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビュを表示できます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>';
$string['choosetemplategrouppagedescription'] = '<p>ここでは新しいビュー作成の出発点としてこのグループがコピーを許可されているビューを検索できます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビュを表示できます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>
<p><strong>注意:</strong> 現在、グループではブログまたはブログ記事をコピーできません。</p>';
$string['choosetemplateinstitutionpagedescription'] = '<p>ここでは新しいビュー作成の出発点としてこのインスティテューションがコピーを許可されているビューを検索できます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビュを表示できます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>
...
$string['copyfornewmembersdescription'] = '%s のすべての新しいメンバに対してこのビューのパーソナルコピーを自動作成します。';
...
$string['searchowners'] = 'オーナを検索する';
$string['owner'] = 'オーナ';
$string['Owner'] = 'オーナ';
$string['owners'] = 'オーナ';
$string['show'] = '表示';
$string['searchviewsbyowner'] = 'ビューをオーナで検索します:';
