...
$string['thisfeedbackisprivate'] = 'このフィードバックはプライベート (非公開) です。';
...
$string['choosetemplateinstitutionpagedescription'] = '<p>ここでは新しいビュー作成の出発点として、このインスティテューションがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることで、あなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため、該当する「ビューをコピーする」ボタンをクリックして、コピーされたビューの修正を開始してください。</p>
