...
$string['changeviewtheme'] = 'あなたがこのビューに選択したテーマは廃止されています。異なるテーマを選択してください。';
...
$string['templatedescriptionplural'] = 'この設定を有効にした場合、あなたのビューを閲覧できるユーザに対して、自分のビューとしてコピーできるようにします。';
