...
$string['submitviewconfirm'] = 'あなたが「 %s 」を「 %s 」に評価のために送信する場合、チュータによるページの採点完了まであなたのページを編集できません。本当にこのページを送信してもよろしいですか?';
...
$string['choosetemplatepageandcollectiondescription'] = '<p>ここでは新しいページ作成の出発点としてあなたがコピーを許可されているページを検索できます。ページの名称をクリックすることであなたはそれぞれのページのプレビューを表示できます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。あなたは関連する「コレクションをコピーする」ボタンをクリックしてページが属しているコレクション全体もコピーできます。</p>';
...
$string['copyfornewusersdescription'] = '新しいユーザが作成された場合、このページをユーザポートフォリオにパーソナルコピーとして自動作成します。';
