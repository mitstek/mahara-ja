...
$string['retainviewrightsgroupdescription1'] = '選択したページまたはコレクションが他のユーザによりコピーされた後、グループメンバがこのページまたはコレクションを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すればコピー後にユーザが閲覧アクセスを無効にできます。このページまたはコレクションのコピーからコピーされたページまたはコレクションが同じアクセス権を保持することはありません。';
...
$string['choosetemplatesitepageandcollectiondescription1'] = '<p>ここでは新しいページ作成の出発点としてサイトレベルでコピー可能なページを検索できます。ページの名称をクリックすることによりあなたはそれぞれのページのプレビュを
...
$string['copyfornewmembersdescription1'] = '%s のすべての新しいメンバに対して選択したページまたはコレクションのパーソナルコピーを自動作成します。';
