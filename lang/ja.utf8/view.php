 ...
 * @updated    2010-03-09 05:26:25 UTC
...
$string['reallyaddaccesstoemptyview'] = 'あなたのビューにはアーティファクトが含まれていません。本当にこれらのユーザに対してビューへのアクセス権を与えますか?';
...
$string['accessfromdate'] = '%s 以前、だれもこのビューを閲覧できません。';
$string['accessuntildate'] = '%s 以降、だれもこのビューを閲覧できません。';
$string['accessbetweendates'] = '%s 以前または %s 以降、だれもこのビューを閲覧できません。';
...
$string['nobodycanseethisview'] = 'だれもこのビューを閲覧できません。';
...
$string['moveblockleft'] = 'このブロックを左に移動する';
