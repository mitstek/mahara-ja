...
$string['editaccessgrouppagedescription'] = 'デフォルトではページおよびコレクションを追加および編集できるグループメンバーのみグループコレクションおよびページを閲覧できます。あなたは複数アイテムをチェックボックスで選択して同じ設定にできます。選択完了後、続けるにはスクロールダウンして「保存」をクリックしてください。';
...
$string['editaccesssitepagedescription'] = 'デフォルトではサイトコレクションおよびページをサイト管理者のみ閲覧できます。あなたは複数アイテムをチェックボックスで選択して同じ設定にできます。選択完了後、続けるにはスクロールダウンして「保存」をクリックしてください。';
...
$string['retainviewrightsdescription1'] = 'このページまたはコレクションが他のユーザによりコピーされた後、あなたが選択したページまたはコレクションを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すればコピー後にユーザが閲覧アクセスを無効にできます。このページまたはコレクションのコピーからコピーされたページまたはコレクションが同じアクセス権を保持することはありません。';
$string['retainviewrightsgroupdescription1'] = '選択したページまたはコレクションが他のユーザによりコピーされた後、グループメンバーがこのページまたはコレクションを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すればコピー後にユーザが閲覧アクセスを無効にできます。このページまたはコレクションのコピーからコピーされたページまたはコレクションが同じアクセス権を保持することはありません。';
