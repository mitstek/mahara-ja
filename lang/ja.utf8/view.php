 ...
 * @updated    2016-07-18 15:38:00 UTC
...
$string['submitviewconfirm'] = 'あなたが「 %s 」を「 %s 」に評価のため送信する場合、チューターによるページの採点完了まであなたのページを編集することができません。本当にこのページを送信してもよろしいですか?';
...
$string['editsecreturlsintable'] = '個別に設定する必要があるためこのページでは<b>シークレットURL</b>を設定できません。シークレットURLを設定するには<a href="%sview/share.php">コレクションおよびページの一覧</a>に戻ってください。';
...
$string['templatedescription'] = 'この設定を有効にした場合、あなたのページを閲覧できるユーザに対して自分のページとしてコピーできるようにします。';
$string['templatedescriptionplural'] = 'この設定を有効にした場合、あなたのページを閲覧できるユーザに対して自分のページとしてコピーできるようにします。';
$string['retainviewrightsdescription'] = 'このページまたはコレクションが他のユーザによりコピーされた後、あなたがこのページまたはコレクションを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すればコピー後にユーザが閲覧アクセスを無効にすることができます。このページのコピーからコピーされたページまたはコレクションは同じアクセスを保持することはありません。';
$string['retainviewrightsgroupdescription'] = 'このページが他のユーザによりコピーされた後、グループメンバーがこのページを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すればコピー後にユーザが閲覧アクセスを無効にすることができます。このページのコピーからコピーされたページは同じアクセスを保持することはありません。';
$string['choosetemplatepagedescription'] = '<p>ここでは新しいページ作成の出発点としてあなたがコピーを許可されているページを検索することができます。ページの名称をクリックすることであなたはそれぞれのページのプレビューを表示することができます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。</p>';
$string['choosetemplatepageandcollectiondescription'] = '<p>ここでは新しいページ作成の出発点としてあなたがコピーを許可されているページを検索することができます。ページの名称をクリックすることであなたはそれぞれのページのプレビューを表示することができます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。あなたは関連する「コレクションをコピーする」ボタンをクリックすることにより、ページが属しているコレクション全体コピーすることができます。</p>';
$string['choosetemplategrouppagedescription'] = '<p>ここでは新しいページ作成の出発点としてこのグループがコピーを許可されているページを検索することができます。ページの名称をクリックすることであなたはそれぞれのページのプレビューを表示することができます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。</p>
<p><strong>注意:</strong> 現在、グループでは日誌または日誌エントリをコピーすることはできません。</p>';
$string['choosetemplateinstitutionpagedescription'] = '<p>ここでは新しいページ作成の出発点としてこのインスティテューションがコピーを許可されているページを検索することができます。ページの名称をクリックすることであなたはそれぞれのページのプレビューを表示することができます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。</p>
...
$string['copyfornewmembersdescription'] = '%s のすべての新しいメンバーに対してこのページのパーソナルコピーを自動作成します。';
$string['copyfornewgroups'] = '新しいグループにコピーする';
$string['copyfornewgroupsdescription'] = '以下のグループタイプの新しいグループすべてに対してこのページをコピーします:';
