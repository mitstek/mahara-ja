...
$string['submitviewconfirm'] = 'あなたが「 %s 」を「 %s 」に評価のため送信する場合、チュータによるページの採点完了まであなたのページを編集できません。本当にこのページを送信してもよろしいですか?';
...
$string['editblockspagedescription'] = '<p>あなたのページを作成するには以下のタブよりコンテンツブロックをドラッグ以下のタブより選択してブロックをドラッグ&ドロップすることであなたのページを作成しますドロップしてください。</p>';
...
$string['blocksinstructionajax'] = 'このエリアではあなたのページがどのように表示されるかプレビュを表示します。<br />あなたのページレイアウトにブロックを追加するにはこの行の下にドラッグしてください。あなたのページ内でドラッグすることでブロックの配置を変更できます。';
...
$string['retainviewrightsdescription'] = 'このページまたはコレクションが他のユーザによりコピーされた後、あなたがこのページまたはコレクションを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すればコピー後にユーザが閲覧アクセスを無効にできます。このページのコピーからコピーされたページまたはコレクションは同じアクセスを保持することはありません。';
$string['retainviewrightsgroupdescription'] = 'このページが他のユーザによりコピーされた後、グループメンバがこのページを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すればコピー後にユーザが閲覧アクセスを無効にできます。このページのコピーからコピーされたページは同じアクセスを保持することはありません。';
$string['choosetemplatepagedescription'] = '<p>ここでは新しいページ作成の出発点としてあなたがコピーを許可されているページを検索できます。ページの名称をクリックすることであなたはそれぞれのページのプレビュを表示できます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。</p>';
$string['choosetemplatepageandcollectiondescription'] = '<p>ここでは新しいページ作成の出発点としてあなたがコピーを許可されているページを検索できます。ページの名称をクリックすることであなたはそれぞれのページのプレビュを表示できます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。あなたは関連する「コレクションをコピーする」ボタンをクリックしてページが属しているコレクション全体をコピーできます。</p>';
$string['choosetemplategrouppagedescription'] = '<p>ここでは新しいページ作成の出発点としてこのグループがコピーを許可されているページを検索できます。ページの名称をクリックすることであなたはそれぞれのページのプレビュを表示できます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。</p>
<p><strong>注意:</strong> 現在、グループでは日誌または日誌エントリをコピーできません。</p>';
$string['choosetemplateinstitutionpagedescription'] = '<p>ここでは新しいページ作成の出発点としてこのインスティテューションがコピーを許可されているページを検索できます。ページの名称をクリックすることであなたはそれぞれのページのプレビュを表示できます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため該当する「ページをコピーする」ボタンをクリックしてコピーされたページの修正を開始してください。</p>
...
$string['copyfornewmembersdescription'] = '%s のすべての新しいメンバに対してこのページのパーソナルコピーを自動作成します。';
