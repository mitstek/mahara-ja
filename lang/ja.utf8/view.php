 ...
 * @updated    2022-04-19 22:31:26 UTC
...
$string['rownr'] = '行 %s';
$string['nrrows'] = '%s 行';
$string['addnewblockdrag'] = 'ドラッグして新しいブロックを追加する';
...
$string['retainviewrightsgroupdescription2'] = '他の人がコピーしたページまたはコレクションの中から選択したものをこのグループのメンバーが閲覧できるようアクセス権を与えます。希望すればコピー後に閲覧アクセスを無効にできます。このページまたはコレクションのコピーからコピーされたページまたはコレクションが同じアクセス権を保持することはありません。';
...
$string['copyfornewmembersdescription2'] = '%s のすべての新しいメンバーに対して選択したページまたはコレクションのパーソナルコピーを自動作成します。選択したページまたはコレクションをこれらの人が後で同様にコピーできるようにしたい場合、コピーを許可してください。';
