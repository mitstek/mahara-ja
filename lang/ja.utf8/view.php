...
$string['feedbackonthisartefactwillbeprivate'] = 'このアーティファクトのフィードバックはオーナーのみ閲覧できます。';
...
$string['cantsubmitviewtogroup'] = 'あなたはこのビューの評価を目的としてこのグループに送信することはできません。';
...
$string['editaccesspagedescription2'] = '<p>デフォルトではあなたのみビューを閲覧できます。ここではあなたのビュー情報を閲覧させたいユーザを選択することができます。パブリック、ログインユーザ、フレンドにアクセス権を与えるには「追加」をクリックしてください。個別のユーザまたはグループを検索するには検索ボックスを使用してください。すべての追加されたユーザまたはグループは右側のウィンドウ枠に表示されます。</p>
<p>追加処理を終了して続けるには「保存」ボタンをクリックしてください。</p>';
$string['overridingstartstopdate'] = '開始/終了日のオーバーライド';
$string['overridingstartstopdatesdescription'] = 'あなたは開始日および終了日をオーバーライドすることができます。アクセス開始日およびアクセス終了日をどのように設定したとしても開始日以前および終了日以降には他のユーザはビューを閲覧できません。';
...
$string['choosetemplatepagedescription'] = '<p>ここでは新しいビュー作成の出発点としてあなたがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>';
$string['choosetemplategrouppagedescription'] = '<p>ここでは新しいビュー作成の出発点としてこのグループがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>
<p><strong>注意:</strong> 現在、グループではブログまたはブログ記事をコピーすることはできません。</p>';
$string['choosetemplateinstitutionpagedescription'] = '<p>ここでは新しいビュー作成の出発点としてこのインスティテューションがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため該当する「ビューをコピーする」ボタンをクリックしてコピーされたビューの修正を開始してください。</p>
