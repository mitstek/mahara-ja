 ...
 * @updated    2016-07-21 11:04:23 UTC
...
$string['anonymisedescription'] = 'ページの作成者としてのあなたの氏名を他のユーザから隠します。必要であれば管理者はあなたの氏名を確認することができます。';
$string['Locked'] = 'ロック';
...
$string['editaccesspagedescription6'] = 'デフォルトではあなたのページおよびコレクションをあなたのみ閲覧できます。このページではあなたの他に誰がアクセスできるか決定します。';
