 ...
 * @updated    2013-12-24 15:50:21 UTC
...
$string['reallyaddaccesstoemptyview'] = 'あなたのページにはブロックが含まれていません。本当にこれらのユーザに対してページへのアクセス権を与えますか?';
...
$string['retainviewrightsgroupdescription'] = 'このページが他のユーザによりコピーされた後、グループメンバーがこのページを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すれば、コピー後にユーザが閲覧アクセスを無効にすることができます。このページのコピーからコピーされたページは同じアクセスを保持することはありません。';
$string['choosetemplatepagedescription'] = '<p>ここでは新しいページ作成の出発点として、あなたがコピーを許可されているページを検索することができます。ページの名称をクリックすることであなたはそれぞれのページのプレビューを表示することができます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため、該当する「ページをコピーする」ボタンをクリックして、コピーされたページの修正を開始してください。</p>';
...
$string['choosetemplategrouppagedescription'] = '<p>ここでは新しいページ作成の出発点として、このグループがコピーを許可されているページを検索することができます。ページの名称をクリックすることであなたはそれぞれのページのプレビューを表示することができます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため、該当する「ページをコピーする」ボタンをクリックして、コピーされたページの修正を開始してください。</p>
<p><strong>注意:</strong> 現在、グループでは日誌または日誌エントリをコピーすることはできません。</p>';
$string['choosetemplateinstitutionpagedescription'] = '<p>ここでは新しいページ作成の出発点として、このインスティテューションがコピーを許可されているページを検索することができます。ページの名称をクリックすることであなたはそれぞれのページのプレビューを表示することができます。あなたがコピーしたいページを見つけた場合、ページのコピーを作成するため、該当する「ページをコピーする」ボタンをクリックして、コピーされたページの修正を開始してください。</p>
