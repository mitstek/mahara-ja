...
$string['editaccesspagedescription6'] = 'デフォルトではあなたのページおよびコレクションをあなたのみ閲覧できます。このページではあなたに加えて誰がアクセスできるか決定します。';
...
$string['canteditsubmitted'] = '変更後。あなたはチューターがページをリリースするまで待つ必要があります。';
