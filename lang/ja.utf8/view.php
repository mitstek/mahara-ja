 ...
 * @updated    2026-06-02 07:49:58 UTC
...
$string['institutionviewscollections2'] = 'インスティテューションポートフォリオ';
...
$string['Viewscollections2'] = 'ポートフォリオ';
...
$string['delete_view'] = 'ページを削除する';
$string['deletespecifiedview'] = 'ページ「 %s 」を削除する';
$string['deletespecifiedview_group'] = 'グループページ「 %s 」を削除する';
...
$string['detailslinkalt1'] = 'コメントおよび詳細';
$string['Browse'] = '閲覧';
$string['Search'] = '検索';
