...
$string['editaccesspagedescription5'] = 'あなたのページおよびコレクションに対して、デフォルトではあなたのみ閲覧することができます。このページでは、あなたの他に誰がそれらにアクセスできるか決定します。あなたのページを共有するにはグループおよび人の横にある「追加」ボタンをクリックしてください。';
