...
$string['anonymisedescription'] = 'ページの作成者としてのあなたの氏名を他のユーザから隠します。必要であれば管理者はあなたの氏名を確認できます。';
$string['Locked'] = 'ロック';
...
$string['collectionsubmissionexceptionmessage'] = '以下の理由から、このコレクションを送信できません:';
$string['cantsubmitemptycollection'] = 'このコレクションにはページが含まれていません。';
$string['viewsubmissionexceptiontitle'] = 'ページを送信できませんでした。';
$string['viewsubmissionexceptionmessage'] = '以下の理由から、このページを送信できません:';
