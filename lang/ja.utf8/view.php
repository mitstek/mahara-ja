...
$string['retainviewrightsgroupdescription2'] = '他のユーザがコピーしたページまたはコレクションの中から選択したものをこのグループのメンバーが閲覧できるようアクセス権を与えます。希望すればコピー後にユーザが閲覧アクセスを無効にできます。このページまたはコレクションのコピーからコピーされたページまたはコレクションが同じアクセス権を保持することはありません。';
