 ...
 * @updated    2011-06-08 17:16:58 UTC
...
$string['newsecreturl'] = '新しいシークレットURI';
...
$string['retainviewrightsdescription'] = 'このページまたはコレクションが他のユーザによりコピーされた後、あなたがこのページまたはコレクションを閲覧できるようにした場合、このチェックボックスをチェックしてください。希望すれば、コピー後にユーザが閲覧アクセスを無効にすることができます。このページのコピーからコピーされたページまたはコレクションは、同じアクセスを保持することはありません。';
$string['retainviewrightsgroupdescription'] = 'このページが他のユーザによりコピーされた後、グループメンバーがこのページを閲覧できるようにした場合、このチェックボックスをチェックしてください。希望すれば、コピー後にユーザが閲覧アクセスを無効にすることができます。このページのコピーからコピーされたページは、同じアクセスを保持することはありません。';
