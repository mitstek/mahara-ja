 ...
 * @updated    2012-07-19 03:46:11 UTC
...
$string['editsecreturlsintable'] = '個別に設定する必要があるため、このページでは<b>シークレットURI</b>を設定できません。シークレットURIを設定するには、<a href="%s">コレクションおよびページの一覧</a>に戻ってください。';
...
$string['templatedescriptionplural1'] = 'このチェックボックスをチェックした場合、あなたのページまたはコレクションを閲覧できるユーザに対して、ファイルおよびフォルダを含めて自分のページとしてコピーできるようにします。';
$string['retainviewrightsdescription1'] = 'このページまたはコレクションが他のユーザによりコピーされた後、あなたがこのページまたはコレクションを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すれば、コピー後にユーザが閲覧アクセスを無効にすることができます。このページまたはコレクションのコピーからコピーされたページまたはコレクションは同じアクセスを保持することはありません。';
$string['retainviewrightsgroupdescription1'] = 'このページまたはコレクションが他のユーザによりコピーされた後、グループメンバーがこのページまたはコレクションを閲覧できるようにしたい場合、このチェックボックスをチェックしてください。希望すれば、コピー後にユーザが閲覧アクセスを無効にすることができます。このページまたはコレクションのコピーからコピーされたページまたはコレクションは同じアクセスを保持することはありません。';
...
$string['copyfornewusersdescription1'] = '新しいユーザが作成された場合、このこのページまたはコレクションをユーザポートフォリオ内にパーソナルコピーとして自動作成します。';
$string['copyfornewmembers'] = '新しいインスティテューションメンバーにコピーする';
$string['copyfornewmembersdescription1'] = '%s のすべての新しいメンバーに対して、このページまたはコレクションのパーソナルコピーを自動作成します。';
$string['copyfornewgroups'] = '新しいグループにコピーする';
$string['copyfornewgroupsdescription1'] = '以下のグループタイプの新しいグループすべてに対して、このページまたはコレクションをコピーします:';
