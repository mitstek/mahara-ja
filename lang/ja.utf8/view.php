...
$string['viewcolumnspagedescription'] = '最初にあなたのビューのカラム数を選択してください。次のステップで、あなたはカラム幅を変更することができます。';
...
$string['templatedescription'] = 'この設定を有効にした場合、あなたのビューを閲覧できるユーザに対して、自分のビューとしてコピーできるようにします。';
$string['choosetemplatepagedescription'] = '<p>ここでは新しいビュー作成の出発点として、あなたがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため、該当する「ビューをコピーする」ボタンをクリックして、コピーされたビューの修正を開始してください。</p>';
$string['choosetemplategrouppagedescription'] = '<p>ここでは新しいビュー作成の出発点として、このグループがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため、該当する「ビューをコピーする」ボタンをクリックして、コピーされたビューの修正を開始してください。</p>
<p><strong>注意:</strong> 現在、グループではブログまたはブログ記事をコピーすることはできません。</p>';
$string['choosetemplateinstitutionpagedescription'] = '<p>ここでは新しいビュー作成の出発点として、このインスティテューションがコピーを許可されているビューを検索することができます。ビューの名称をクリックすることであなたはそれぞれのビューのプレビューを表示することができます。あなたがコピーしたいビューを見つけた場合、ビューのコピーを作成するため、該当する「ビューをコピーする」ボタンをクリックして、コピーされたビューの修正を開始してください。</p>
