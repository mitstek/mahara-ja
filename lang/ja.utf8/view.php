...
$string['retainviewrightsdescription2'] = '他のユーザによりコピーされたページまたはコレクションに対して、あなたが選択したページまたはコレクションにアクセスできるようにします。希望すればコピー後にユーザが閲覧アクセスを無効にすることができます。このページまたはコレクションのコピーからコピーされたページまたはコレクションは同じアクセスを保持することはありません。';
$string['retainviewrightsgroupdescription2'] = '他のユーザによりコピーされたページまたはコレクションに対して、このグループのメンバーが選択したページまたはコレクションにアクセスできるようにします。希望すればコピー後にユーザが閲覧アクセスを無効にすることができます。このページまたはコレクションのコピーからコピーされたページまたはコレクションは同じアクセスを保持することはありません。';
