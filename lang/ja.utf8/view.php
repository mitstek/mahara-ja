...
$string['templatedescription'] = 'この設定を有効にした場合、あなたのページを閲覧できるユーザに対して、自分のページとしてコピーできるようにします。';
$string['templatedescriptionplural'] = 'この設定を有効にした場合、あなたのページを閲覧できるユーザに対して、自分のページとしてコピーできるようにします。';
...
$string['copyfornewmembersdescription'] = '%s のすべての新しいメンバーに対して、このページのパーソナルコピーを自動作成します。';
$string['copyfornewgroups'] = '新しいグループにコピーする';
$string['copyfornewgroupsdescription'] = '以下のグループタイプの新しいグループすべてに対して、このページをコピーします:';
