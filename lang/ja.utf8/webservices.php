...
$string['grouptypectrl'] = '管理 - グループ管理者は同意なしにグループに人を追加できます。また、メンバはグループを離れることはできません。';
...
$string['hidemembership'] = 'メンバシップを隠す';
...
$string['internal'] = '内部';
$string['introduction'] = 'アカウントオーナの自己紹介';
...
$string['preferredname'] = 'アカウントオーナの優先名';
...
$string['remoteuser'] = 'リモートアカウントオーナ';
$string['remoteuserid'] = 'リモートアカウントオーナID';
...
$string['studentid'] = '学生の任意のIDコードナンバー';
$string['studentidinst'] = 'インスティテューションからの任意のIDコードナンバー';
...
$string['userfavs'] = 'アカウントオーナのお気に入り';
$string['userid'] = 'アカウントオーナのID';
$string['useridsort'] = 'IDで並べ替えます: 昇順 [asc] または降順 [desc]';
$string['username'] = 'アカウントオーナのユーザ名';
