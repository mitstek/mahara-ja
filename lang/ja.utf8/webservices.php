...
$string['blogpostowner'] = '日誌エントリオーナー';
...
$string['favsownerusername'] = 'お気に入りオーナーのユーザ名';
...
$string['groupmemberactions'] = 'グループメンバーシップアクション';
...
$string['grouptypereq'] = 'リクエスト - 人はグループ管理者にメンバーシップリクエストを送信できます。';
$string['grouptypesubmitpage'] = 'ページを送信する - メンバーはグループにページを送信できます。';
$string['hidemembership'] = 'メンバーシップを隠す';
...
$string['memberactionexplicit'] = 'メンバーアクション: 追加または削除';
$string['memberrole'] = 'メンバーロール:';
$string['memberroleexplicit'] = 'メンバーロール: 管理者、チューター、メンバー';
$string['memberroleonlyadmin'] = 'メンバーロール: 管理者';
$string['memberuserid'] = 'メンバーID';
$string['memberusername'] = 'メンバーユーザ名';
...
$string['portfolioowneremail'] = 'ポートフォリオオーナーのメールアドレス';
$string['portfolioownerid'] = 'ポートフォリオオーナーのMahara ID';
...
$string['usernamevalid'] = '半角英数字3～30文字にしてください。半角英数字および標準的な記号を使用できます。';
