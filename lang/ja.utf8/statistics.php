...
$string['artefact_type_book'] = 'アーティファクト: 著書および出版物';
...
<p><strong>注意:</strong> このレポートはあなたが「インスティテューション」ドロップダウンメニューで「すべてのインスティテューション」を選択した場合のみ利用できます。これは週末のみ更新されます。</p>';
...
<p><strong>注意:</strong> このレポートはあなたが「インスティテューション」ドロップダウンメニューで「すべてのインスティテューション」を選択した場合のみ利用できます。</p>';
<<<<<<< HEAD
...
<li>注意: そのステータスオプションがフレームワークで利用可能ではない場合、ステータスはゼロを表示します。/li>
</ul>
<p>選択された期間中に作成されたポートフォリオが一覧表示されます。それらの現在のアクセスパーミッションが表示されます。</p>';
$string['reportdesctitle'] = 'このレポートには以下を含みます:';
$string['reportdescuseractivity'] = '<ul>
