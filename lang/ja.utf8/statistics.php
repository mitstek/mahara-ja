 ...
 * @updated    2022-05-05 23:19:09 UTC
...
$string['view_type_progress'] = '完了ページ進捗数';
$string['plugin_artefact_annotation_version'] = 'アーティファクトプラグイン「アノテーション」バージョン';
...
$string['plugin_artefact_internal_version'] = 'アーティファクトプラグイン「内部」バージョン';
$string['plugin_artefact_peerassessment_version'] = 'アーティファクトプラグイン「ピアアセスメント」バージョン';
...
$string['plugin_auth_webservice_version'] = '認証プラグイン「ウェブサービス」 バージョン';
$string['plugin_auth_xmlrpc_version'] = '認証プラグイン「XML-RPC」バージョン';
$string['plugin_blocktype_annotation_version'] = '認証プラグイン「アノテーション」バージョン';
...
$string['plugin_blocktype_socialprofile_version'] = 'ブロックタイププラグイン「ソーシャルメディア」バージョン';
...
$string['plugin_blocktype_comment_version'] = 'ブロックタイププラグイン「コメント」バージョン';
$string['plugin_blocktype_textbox_version'] = 'ブロックタイププラグイン「ノート」バージョン';
$string['plugin_blocktype_peerassessment_version'] = 'ブロックタイププラグイン「ピアアセスメント」バージョン';
$string['plugin_blocktype_signoff_version'] = 'ブロックタイププラグイン「承認および検証」バージョン';
...
$string['plugin_export_pdf_version'] = 'エクスポートプラグイン「PDF」バージョン';
...
$string['plugin_search_elasticsearch_version'] = '検索プラグイン「Elasticsearch」バージョン';
$string['plugin_module_assessmentreport_version'] = 'モジュール「評価通知」バージョン';
$string['plugin_module_framework_version'] = 'モジュール「スマートエビデンス」バージョン';
$string['plugin_module_lti_version'] = 'モジュール「LTI」バージョン';
$string['plugin_module_mobileapi_version'] = 'モジュール「モジュールAPI」バージョン';
$string['plugin_module_monitor_version'] = 'モジュール「モニタ」バージョン';
$string['plugin_module_multirecipientnotification_version'] = 'モジュール「複数受信者通知」バージョン';
$string['plugin_module_submissions_version'] = 'モジュール「提出」バージョン';
$string['release'] = 'リリース';
...
$string['logins'] = 'ログイン';
$string['reports'] = 'レポート';
$string['reportsdesc'] = 'サイトおよび学習アナリティクスデータに関する統計を表示します。';
...
<li>個別の標準に拘わらず、ポートフォリオ全体のスマートエビデンス評価のそれぞれのステータスの合計値</li>
</ul>
...
<p>選択された期間に作成されたアカウントの人が一覧表示されます。</p>';
...
<li>個別の人と共有されているポートフォリオ数 (ページまたはコレクション)</li>
<li>グループと共有されているポートフォリオ数</li>
<li>インスティテューションと共有されているポートフォリオ数</li>
<li>すべての登録済みの人と共有されているポートフォリオ数</li>
...
$string['deactivateuser'] = 'アカウントを無効化する';
...
$string['expireuser'] = 'アカウントを有効期限切れにする';
...
$string['undeleteuser'] = 'アカウントの削除を取り消す';
$string['unexpireuser'] = 'アカウントの有効期限切れを取り消す';
$string['unsuspenduser'] = '人の利用停止を取り消す';
$string['updatecollection'] = 'コレクションを更新する';
$string['updateuser'] = 'アカウントを更新する';
...
$string['usersinfo'] = '人概要';
$string['viewsinfo'] = 'ページ概要';
$string['usersbyinstitution'] = 'インスティテューション別の人';
$string['groupsbytype'] = 'タイプ別グループ';
$string['earliestdate'] = 'このレポートのデータは %s 以降のもののみ利用できます。';
