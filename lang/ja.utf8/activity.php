 ...
 * @updated    2015-10-12 15:44:36 UTC
...
$string['recurseall'] = 'すべてを再帰的に処理する';
...
$string['newviewaccessmessage'] = 'あなたはビュー「 %s 」のアクセスリストに %s により追加されました。';
...
$string['objectionablecontentviewartefact'] = 'アーティファクト「 %s 」の好ましくないコンテンツ - 報告者: %s';
...
$string['institutionrequestmessage'] = 'あなたは「インスティテューションメンバ」ページでユーザをインスティテューションに追加できます:';
