 ...
 * @updated    2008-08-14 14:35:10 UTC
...
$string['mysqldbtypedeprecated'] = 'あなたは、設定ファイルにdbtype「mysql」を使用しています。「mysql5」に変更してください - 「mysql」は廃止されました。';
...
あなたが共有ホスティングサービスを利用している場合、ホスティングプロバイダに依頼する以外、safe_modeを無効にするためにできることは多くありません。別のホスティングサービスへの変更ｋを考えても良いでしょう。';
