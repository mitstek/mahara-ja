 ...
 * @updated    2024-11-24 03:41:52 UTC
...
エラー内容は次のとおりです:';
$string['dbnotutf8'] = 'あなたはUTF-8データベースを使用していません。Maharaはすべてのデータを内部的にUTF-8で保存します。あなたのデータベースを削除した後、UTF-8エンコーディングで再作成してください。';
$string['dbnotutf8mb4_bin'] = 'あなたはutf8mb4文字セット (4バイト UTF-8ユニコードエンコーディング) データベースを使用していません。Maharaはすべてのデータを内部的にutf8mb4として保存します。あなたのデータベースを文字セット「utf8mb4」および照合順序「utf8mb4_bin」で削除および再作成してください。';
