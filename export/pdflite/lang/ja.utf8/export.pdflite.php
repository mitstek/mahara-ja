...
$string['exportpdfdisabled'] = 'PDF liteエクスポート依存関係がありません。PDF liteエクスポートは無効にされています。詳細は<a href="%s">「プラグイン管理」</a>をご覧ください。';
$string['isexperimental'] = 'これは実験的なエクスポートオプションです。PDFエクスポートオプションのインストールおよび有効化に依存します。';
