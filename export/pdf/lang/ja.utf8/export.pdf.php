 ...
 * @updated    2022-10-17 01:03:47 UTC
...
$string['description'] = 'これによりあなたのポートフォリオのPDFファイルを含むZIPファイルが作成されます。あなたはこれを再度インポートできませんが、PDFは標準的なPDFビューアで閲覧できます。';
...
$string['pdfchromestartederror'] = 'Chromeブラウザを開始できません。詳細情報はエラーログをご覧ください';
