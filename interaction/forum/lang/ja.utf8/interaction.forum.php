 ...
 * @updated    2016-10-19 17:39:32 UTC
...
$string['autosubscribeusers'] = 'ユーザを自動的に購読させますか?';
...
$string['Open'] = 'オープン';
$string['Order'] = '並べ替え順';
$string['orderdescription'] = '他のフォーラムに対してあなたがこのフォーラムを配置したい場所を選択してください。';
$string['Post'] = '投稿';
$string['postbyuserwasdeleted'] = '%s による投稿が削除されました。';
$string['postdelay'] = '投稿遅延';
$string['postdelaydescription'] = '新しい投稿が購読者に送信される前、経過する必要のある最小時間 (分) です。投稿者はこの時間内に投稿内容を編集できます。';
...
$string['closetopicsdescription'] = 'この設定を有効にした場合、このフォーラム内の新しいトピックがデフォルトでクローズされます。モデレータおよびグループ管理者のみ、閉鎖トピックに返信できます。';
