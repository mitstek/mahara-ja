...
$string['cantedittopic'] = 'あなたは、このトピックを編集できません。';
...
$string['postdelaydescription'] = '新しい投稿がメール購読者に送信される前、経過する必要のある最小時間 (分) です。投稿者は、この時間中、投稿内容を編集することができます。';
...
$string['indentfullindent'] = '完全に拡張する';
$string['indentmaxindent'] = '最大インデントレベルまで拡張する';
