 ...
 * @updated    2016-09-29 16:49:14 UTC
...
$string['existingtokens'] = 'このサービスにトークンユーザが存在するため認証済みサービスユーザにスイッチできません。';
...
$string['errornotemptydefaultparamarray'] = '名称「 %s 」のウェブサービスパラメータ記述は単一または複数構造です。デフォルトは空の配列にのみすることができます。ウェブサービス記述を確認してください。';
$string['erroronlyarray'] = '配列のみ許可されます。';
$string['erroroptionalparamarray'] = '名称「 %s 」のウェブサービスパラメータ記述は単一または複数構造です。VALUE_OPTIONALに設定することはできません。ウェブサービス記述を確認してください。';
