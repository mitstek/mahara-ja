 ...
 * @updated    2026-09-23 00:56:08 UTC
...
$string['registrationnosuchkey'] = '申し訳ございません、このキーでの登録はできないようです。恐らく、あなたが登録を完了するため24時間以上待機していたと思われます。そうではない場合、これは私たちに責任があります。';
...
$string['enableservice1'] = 'サービス利用可能状況';
...
$string['serviceshortnamemustbeunique1'] = 'この省略名はすでに別のサービスグループで使用されています。代わりに「 %s 」を使用してください。';
...
$string['webservice_oauth_server.user_help'] = '<h1>サービスオーナ</h1>
<p>インスティテューション管理者権限のあるアカウントを選択してください。このアカウントでログインした場合、人をログアウトするトークンが使用されるため、専用の「Webサービス」アカウントの作成をお勧めします。別のアカウント使用でこの問題を回避できます。</p>';
...
$string['webservice_oauth_server.application_uri_help'] = '<h1>アプリケーションURI</h1>
<p>このサイトからのメールリンクをたどったときにアプリケーションのホームページにリダイレクトするURLを入力してください。config.phpで「$cfg-&gt;emailexternalredirect」を「true」に設定する必要があります。</p><p>これはポートフォリオ作成者がLMS経由でのみログインする場合に使用します。その後、新しいページの通知はLTIリンクを含むLMS活動にリダイレクトされます。</p>';
...
$string['cannotdelete'] = 'まだこのアプリケーションのトークンを認証方法として使用している人がいるため、あなたは外部アプリケーション「 %s 」を削除できません。';
...
$string['generate_token'] = 'トークンを生成する';
...
$string['service'] = 'サービス';
$string['custom_service'] = 'カスタムサービス';
$string['serviceusers'] = '認証済みユーザ';
$string['servicenamelabel'] = '名称';
$string['serviceconfig.name_help'] = '<h1>名称</h1><p>このサービスの人間が解読可能な名称です。</p>';
$string['serviceshortnamelabel'] = '省略名';
$string['serviceconfig.shortname_help'] = '<h1>省略名</h1><p>このサービスグループを外部サービスから参照する際に使用される機械可読な名称です。</p>';
...
$string['invalidstudentid'] = '無効な学籍番号「 %s 」です。';
