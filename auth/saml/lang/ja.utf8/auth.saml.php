 ...
 * @updated    2017-02-09 15:37:08 UTC
...
$string['errorduplicateidp1'] = 'アイデンティティプロバイダ (%s) はすでに別のインスティテューション (%s) で使用されています。XMLに1つの有効かつユニークなアイデンティティプロバイダが含まれていることを確認してください。';
