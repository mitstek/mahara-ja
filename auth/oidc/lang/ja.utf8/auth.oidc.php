...
$string['logintolinkdesc'] = '<p><b>現在、あなたはOpenID Connectアカウント「 %s 」にログインしています。このユーザを既存のローカル %s アカウントにリンクするには以下のフォームを使用してローカルアカウントでログインしてください。リンク完了後、あなたはOpenID Connectでログインできるようになります。</b></p>';
