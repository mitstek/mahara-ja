 ...
 * @updated    2023-07-10 01:47:59 UTC
...
$string['errorauthnoidtoken'] = 'OpenID Connect id_token を受信していません。';
$string['errorauthunknownstate'] = '不明なステータス';
$string['errorbadinstitution'] = 'ユーザを作成するインスティテューションを決定できませんでした。';
...
$string['logintolinkdesc'] = '<p><b>現在、あなたはOpenID Connectユーザ「 %s 」にログインしています。このユーザを既存の %s アカウントにリンクするには以下のフォームを使用してローカルアカウントでログインしてください。リンク完了後、あなたはOpenID Connectでログインできるようになります。</b></p';
$string['settings_title'] = 'インスタンス名';
$string['settings_autocreateusers'] = '自動的にユーザを作成する';
$string['settings_clientid'] = 'クライアントID';
$string['settings_clientsecret'] = 'クライアントシークレット';
$string['settings_authendpoint'] = '認証エンドポイント';
$string['settings_authendpoint_default'] = '認証/ログインのエンドポイント
<br />
例: https://mahara.org/auth/saml/sp/module.php/oidc/authorize.php';
$string['settings_logoutendpoint'] = 'ログアウトエンドポイント';
$string['settings_logoutendpoint_default'] = '私たちのトークンのヒントでログアウトするエンドポイント
<br />
例: https://mahara.org/auth/saml/sp/module.php/oidc/logout.php';
$string['settings_tokenendpoint'] = 'トークンエンドポイント';
$string['settings_tokenendpoint_default'] = 'トークンをリフレッシュするエンドポイント
<br />
例: https://mahara.org/auth/saml/sp/module.php/oidc/token.php';
$string['settings_resource'] = 'リソース';
$string['settings_resource_default'] = 'イシュア名<br />例: https://mahara.org/';
...
$string['oidc_make_group_readable'] = '以下のファイルはウェブサーバが読めるようにグループ所有権を変更する必要があります：';
$string['installoidc'] = 'OIDCをクライアントとして使用したい場合、あなたのインスティテューションを編集してOIDC認証インスタンスを追加してください。
<br /><br />
しかし、あなたのサイトをOIDCアイデンティティサーバとして使用したい場合、不足した設定変数を設定して<a href="%s"> OpenID Connectクライアントレジストリ</a>にセットアップのためアクセスする必要があります。
<br />
インストール完了後、あなたは外部システムがこのIDサーバに接続するために必要な<a href="%s">設定</a>情報を共有できるようになります。
<br />
その後、あなたはOIDCのcronタスクを設定して期限切れのトークンを消去できます。cron設定情報は<a href="%s">cron情報ページ</a>から入手できます。
<br /><br />';
$string['oidc_idp_missing_settings'] = '<strong>設定なし</strong><br />';
$string['oidc_idp_not_set'] = 'サイトがIDサーバとして有効にされていません。有効にするには$cfg->saml_as_idpをtrueに設定してください。';
