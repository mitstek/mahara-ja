 ...
 * @updated    2015-08-02 14:12:42 UTC
...
%s でのアカウント登録ありがとうございます。あなたのメールアドレスを確認するため、下記リンクをクリックしてください。
...
<p>%s でのアカウント登録ありがとうございます。あなたのメールアドレスを確認するため、下記リンクをクリックしてください。
...
$string['registrationreasondesc'] = 'あなたが選択したインスティテューションへの登録申請理由、および管理者があなたの申請を処理することに関して有益であると思われる詳細を記述してください。この情報なしでは登録を完了することはできません。';
...
このインスティテューションを管理する者として登録されているため、あなたはこの登録リクエストを承認または拒否する必要があります。この処理を実行するには次のリンクにアクセスしてください: %s
...
<p>このインスティテューションを管理する者として登録されているため、あなたはこの登録リクエストを承認または拒否する必要があります。この処理を実行するには次のリンクにアクセスしてください:<a href=%s>%s</a></p>
