...
%s でのアカウント登録ありがとうございます。あなたのメールアドレスを確認するため以下のリンクをクリックしてください。
インスティテューション管理者に通知されあなたの申請を承認するかどうか検討されます。あなたにはその結果が通知されます。
...
<p>%s でのアカウント登録ありがとうございます。あなたのメールアドレスを確認するため以下のリンクをクリックしてください。
インスティテューション管理者に通知されあなたの申請を承認するかどうか検討されます。あなたにはその結果が通知されます。</p>
...
$string['registrationreasondesc'] = 'あなたが選択したインスティテューションへの登録申請理由および管理者があなたの申請を処理することに関して有益であると思われる詳細を記述してください。この情報なしでは登録を完了することはできません。';
