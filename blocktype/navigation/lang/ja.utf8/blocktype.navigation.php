 ...
 * @updated    2015-09-20 16:16:17 UTC
...
$string['description'] = 'ページのコレクションをシンプルなナビゲーションリストとして表示します。';
$string['nocollections'] = 'コレクションはありません。<a href="%scollection/edit.php?new=1">コレクションを作成してください</a>。';
