...
<li>「管理メニュ → ウェブサービス → 設定」で「外向きのウェブサービスリクエストを許可する」を有効にした上で「Rest」プロトコルを有効にしてください。</li>
<li>「管理メニュ → ウェブサービス → 接続マネージャ」に移動してあなたが接続を確立したいインスティテューションを選択してください。そしてドロップダウンメニュで「PluginBlocktypeCourseinfo:courseinfo - Course completion」オプションを選択して「追加」をクリックしてください。</li>
