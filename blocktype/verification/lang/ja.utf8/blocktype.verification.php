...
$string['addcomment'] = 'レビュコメントを追加する';
...
<div><strong>下書きとして保存する:</strong> あなたのみあなたのコメントを閲覧できます。あなたはまだ変更できます。<br>
...
$string['availabilitydatedescription'] = 'ステートメントが利用可能になる日付を選択してください。この日付以前、レビュアにはこの日付までレビュを実施できない旨を知らせるアラートが表示されます。この日付はアクセス通知にも記載されます。あなたが日付を追加しない場合、ステートメントはいつでも作成できます。';
...
$string['cancel'] = 'キャンセル';
$string['commentformplaceholder'] = 'コメントを執筆可能な人がこのページを表示した場合、レビュコメントフォームが表示されます。';
$string['description'] = 'レビュ詳細を表示する';
...
$string['title'] = 'ポートフォリオレビュ';
$string['toverifyspecific'] = 'レビュ予定:  %s';
$string['unverify'] = 'あなたが続けた場合、このレビュは削除されます。';
...
$string['verificationmodaltitle'] = 'レビュ: %s';
$string['verifiedon'] = '%s にレビュ済み';
$string['verifiedonby'] = '<a href="%s">%s</a> - %s';
$string['verifiedspecific'] = 'レビュ済み:  %s';
