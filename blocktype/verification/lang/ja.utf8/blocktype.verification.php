 ...
 * @updated    2026-06-18 15:13:09 UTC
...
$string['text_help'] = '<h1>ステートメントテキスト</h1><p>あなたが承認を希望するステートメントのテキストを入力してください。レビュー担当者にはステートメントを確認するためのチェックボックスが表示されます。このフィールドを空白のままにした場合、レビュアが独自のステートメントを記入できるようコメントフィールドを有効にしてください。</p>';
