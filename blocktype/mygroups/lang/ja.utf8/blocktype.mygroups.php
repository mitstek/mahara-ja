 ...
 * @updated    2014-09-22 21:37:05 UTC
...
$string['limittodesc'] = 'ブロックに表示される最大グループ数です。あなたのグループすべてを表示するには、空白のままにしてください。';
$string['limittodescsideblock'] = 'あなたの「マイグループ」リストに表示される最大グループ数です。あなたのグループすべてを表示するには、空白のままにしてください。';
