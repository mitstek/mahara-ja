 ...
 * @updated    2019-12-10 03:46:54 UTC
...
$string['indexingusernamedescription'] = '(任意) インデックスからの読み込みと異なる場合、インデックスへの書きみ時にHTTP基本認証でElasticsearchに渡すユーザ名です。';
$string['indexingpassword'] = '認証書き込みパスワード';
$string['indexingpassworddescription'] = '(任意) インデックスからの読み込みと異なる場合、インデックスへの書きみ時にHTTP基本認証でElasticsearchに渡すパスワードです。';
