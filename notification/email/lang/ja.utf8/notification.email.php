...
これは %s からの自動生成通知です。あなたの通知プレファレンスを更新するには %s にアクセスしてください。';
...
$string['unsubscribefailed1'] = 'あなたは購読解除に失敗しました。あなたがすでに購読解除しているか、手動で購読解除する必要があります。ログインしてサイトの関連セクションにアクセスしてください。';
