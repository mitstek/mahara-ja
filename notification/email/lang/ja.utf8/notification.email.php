 ...
 * @updated    2018-03-02 05:16:31 UTC
...
$string['unsubscribefailed'] = 'あなたは購読解除に失敗しました。あなたがすでに購読解除しているか手動で購読解除する必要があります。ログインしてMaharaの関連セクションにアクセスしてください。';
$string['unsubscribe_watchlist'] = 'これをあなたのウォッチリストから削除するには %s にアクセスしてください。';
$string['unsubscribe_watchlist_heading'] = 'あなたの「 %s 」のウォッチリストを削除する';
