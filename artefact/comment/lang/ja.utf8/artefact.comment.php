 ...
 * @updated    2026-05-25 09:57:13 UTC
...
$string['commentremovedbyowner'] = 'オーナによりコメントが削除されました。';
...
$string['feedbackembeddedmediadirname'] = 'メディアレコーディング';
$string['feedbackembeddedmediadesc'] = 'テキストエディタで作成されたオーディオおよびビデオファイルです。';
...
$string['importedfeedback'] = 'インポート済みフィードバック';
$string['lastcomment'] = '最新コメント';
$string['visiblecomment'] = '他の人に表示する';
$string['add_feedback_form.ispublic_help'] = '<h1>他の人に表示する</h1><p>この設定を有効にした場合、このコンテンツにアクセスできるすべての人があなたのコメントを閲覧できます。そうではない場合、あなたおよびポートフォリオ作成者のみコメントを閲覧ができます。</p>';
...
$string['thiscommentisprivate1'] = 'このコメントはプライベートです。';
...
$string['authorrequest'] = 'コメント投稿者が自分のコメントを他の人に表示するようリクエストしました。';
$string['privatetovisiblecomment'] = 'ポートフォリオオーナがあなたのコメントを他の人に表示するようリクエストしました。';
$string['youhaverequestedvisible'] = 'あなたはこのコメントを他の人に表示するようリクエストしました。';
$string['commentsnotincluded'] = 'コメントはこのエクスポートに含まれませんでした。';
$string['makecommentvisible'] = '他の人に表示する';
