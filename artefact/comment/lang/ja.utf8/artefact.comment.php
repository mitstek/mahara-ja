 ...
 * @updated    2016-10-06 13:57:27 UTC
...
$string['moderatecommentsdescription1'] = 'あなたに承認されるまでページのコメントは非公開のままにされます。ファイルおよび日誌エントリ等の個々のコメントはモデレーションから除外されます。';
...
$string['artefactdefaultpermissionsdescription'] = '選択されたアーティファクトタイプでは作成時にコメントの投稿が有効にされます。ユーザは個別のアーティファクトでこれらの設定をオーバーライドできます。';
