 ...
 * @updated    2026-05-21 00:29:18 UTC
...
$string['title_help'] = '<h1>セクションタイトル</h1><p>このフィールドを空白のままにした場合、プランのタイトルが使用されます。</p>';
$string['newerplans'] = '新しいプラン';
$string['noplansselectone1'] = 'まだプランはありません。ブロック設定でプランを選択してください。';
