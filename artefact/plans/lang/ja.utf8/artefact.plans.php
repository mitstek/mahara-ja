...
$string['showassignedview'] = 'タスクプレビュ';
$string['showassignedoutcome'] = 'ポートフォリオプレビュ';
...
$string['selectionplandescription'] = 'このテンプレートプランに基づいてグループ内でプランが作成された後、グループメンバは課題を完了するためこのプランのタスクを選択できます。このオプションはテンプレートが作成された場合のみ利用できます。';
$string['none'] = 'なし';
