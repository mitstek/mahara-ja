 ...
 * @updated    2017-03-21 12:53:30 UTC
...
$string['cancel'] = 'キャンセル';
$string['createandpublishdesc'] = 'ここでは日誌エントリを作成して他の人が閲覧できるようにします。';
$string['createasdraftdesc'] = 'ここでは日誌エントリを作成しますがあなたが公開するまで他の人は閲覧できません。';
...
$string['noimageshavebeenattachedtothispost'] = 'このエントリにイメージは追加されていません。イメージを挿入できるようにするには事前にイメージをアップロードするか添付してください。';
...
$string['thisisdraftdesc'] = 'あなたのエントリが下書である場合、あなた以外のユーザはエントリを閲覧できません。';
$string['title'] = 'タイトル';
$string['update'] = '更新';
...
$string['copyreference'] = '他のユーザはあなたの %s を自分のページに表示できる';
