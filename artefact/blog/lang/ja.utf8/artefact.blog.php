 ...
 * @updated    2026-05-20 00:37:36 UTC
...
$string['newblogpost1'] = '日誌: 新しいエントリ';
...
$string['nopostsemptystatetitle'] = 'この日誌にエントリはありません。';
$string['nopostsemptystatemessage'] = 'あなたの最初の日誌エントリを作成する';
...
$string['published_entries'] = '公開済みエントリ';
...
$string['editpost.draft_help'] = '<h1>下書き</h1>
<p>下書きエントリはあなたにのみ表示されます。</p><p>公開済みエントリはその日誌エントリが表示されるページにアクセスできるすべての人に表示されます。</p>';
$string['index_help'] = '<h1>日誌</h1>
<p>日誌はあなたの考えおよび体験を記録するためのブログのようなツールです。デフォルトでは日誌はあなたのみ閲覧できます。共有しているページに日誌または特定のエントリを追加することで他の人に閲覧およびコメントを許可できます。あなたは日誌をいくつでも作成できます。</p>';
$string['view_help'] = '<h1>日誌を表示する</h1>
<p>下書きおよび公開済みエントリの両方が表示されます。下書きエントリは公開済みエントリの上部に表示されます。</p><hr><h2>詳細</h2>
<p>日誌はあなたの考えおよび体験を記録するためのブログのようなツールです。デフォルトでは日誌はあなたのみ閲覧できます。共有しているページに日誌または特定のエントリを追加することで他の人に閲覧およびコメントを許可できます。あなたは日誌をいくつでも作成できます。</p>';
