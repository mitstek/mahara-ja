...
$string['name'] = '名称';
$string['newattachmentsexceedquota'] = 'この記事にアップロードした新しいファイルの合計サイズが、あなたのクオータを超過しました。あなたが追加した添付ファイルを削除することで記事を保存することができます。';
...
$string['thisisdraftdesc'] = 'あなたの記事を下書きにした場合、あなた以外のユーザは記事を閲覧することができません。';
$string['title'] = 'タイトル';
$string['update'] = '更新';
