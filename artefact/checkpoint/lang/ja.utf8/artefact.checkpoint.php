 ...
 * @updated    2026-05-21 00:02:48 UTC
...
$string['progress_checkpointfeedback'] = '%s チェックポイントフィードバックを追加する';
...
$string['typefeedback_help'] = '<h1>チェックポイントのフィードバック</h1><p>あなたのページ内「チェックポイント」セクションで受け取ったフィードバックに関する通知です。</p>';
$string['achievement_message_done_help'] = '<h1>達成レベル</h1>
<div id=\'achievement_level_info\'></div>';
$string['achievement_message_help'] = '<h1>達成レベル</h1>
<p>以下、高い順から低い順に並べた達成レベルです:</p>
<div id=\'achievement_level_info\'></div>';
