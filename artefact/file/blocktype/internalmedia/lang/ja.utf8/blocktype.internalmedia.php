 ...
 * @updated    2009-01-05 07:06:34 UTC
...
$string['configdesc'] = 'このブロックにユーザが埋め込むことのできるファイルタイプを設定してください。アーティファクトプラグインで無効にされているファイルタイプを有効にできませんので注意してください。すでにブロックで使用されているファイルタイプを無効にした場合、そのファイルは表示されなくなります。';
