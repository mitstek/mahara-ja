...
$string['useslimbox2desc1'] = 'この設定を有効にした場合、あなたのギャラリーにSlimbox 2が使用されます。あなたのギャラリーのイメージをクリックした場合、現在のページにオーバーレイ表示されます。';
$string['photoframe'] = 'フォトフレームを使用する';
$string['photoframedesc1'] = 'この設定を有効にした場合、ギャラリー内のそれぞれの写真のサムネイルの周りにフレームが描画されます。';
