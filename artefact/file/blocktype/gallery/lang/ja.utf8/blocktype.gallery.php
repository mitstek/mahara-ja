...
$string['flickrapikeydesc'] = 'Flickrのフォトセットを表示するにはあなたは有効なFlickr APIキーが必要です。<a href="http://www.flickr.com/services/api/keys/apply/" target="_blank">あなたのキーをオンラインで取得してください</a>。';
