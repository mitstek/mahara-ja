...
$string['fileinstructions'] = 'ビューに含めるため、あなたのイメージ、ドキュメントまたは他のファイルをアップロードしてください。ファイルまたはフォルダを移動するにはフォルダ上にドラッグ&ドロップしてください。';
$string['filethingdeleted'] = '%s が削除されました。';
$string['filetypes'] = 'アップロード可能なファイルタイプを設定する';
$string['filetypedescription'] = '<p>あなたはここでユーザがアップロードできるファイルを設定することができます。この設定ではどのようなファイルをアップロードするかコントロールします。あなたがウイルスチェックを有効にしている場合、アップロードするファイルの種類と共にウイルスもチェックします。</p><p>「不明なアプリケーション」はいくつかのムービーファイルおよびアーカイブファイル (gzip等) をアップロードするため必要ですので、注意してください。<p>';
$string['folder'] = 'フォルダ';
