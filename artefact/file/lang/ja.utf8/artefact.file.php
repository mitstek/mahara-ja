 ...
 * @updated    2016-09-06 13:37:19 UTC
...
$string['quotanotifyadmindescr1'] = 'この設定を有効にした場合、ユーザが通知閾値に達した時点でサイト管理者に通知されます。';
...
$string['downloadfolderzipdescription1'] = 'この設定を有効にした場合、ユーザは「フォルダ」ブロックに表示されたフォルダをZIPファイルとしてダウンロードすることができます。';
