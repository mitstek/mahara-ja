...
$string['filenamefieldisrequired1'] = 'ファイル/フォルダ名は必須入力です。';
...
$string['fileuploadinstructions1'] = 'あなたは複数ファイルを選択して一度にアップロードすることができます。';
...
$string['adm_group_notificationmessage'] = 'グループ %s がファイルクオータの %s% パーセントに到達しました (ファイルクオータ: %s)。';
$string['textlinktouser'] = '%s のプロファイルを編集する';
$string['quotanotifylimittitle1'] = 'クオータ通知閾値';
$string['quotanotifylimitdescr1'] = 'ユーザのアップロードクオータがこのパーセンテージまで満杯になった場合、ユーザ (およびサイト管理者) にアップロード制限に到達しようとしている旨、通知が送信されます。ユーザはスペースを空けるためファイルを削除またはクオータを増やすよう管理者に連絡することができます。';
...
$string['insufficientquotaforunzip'] = 'このファイルを展開するにはあなたの残りファイルクオータが小さすぎます。あなたはスペースを空けるためにファイルを削除すること、あなたのクオータを増やすために管理者に連絡することができます。';
