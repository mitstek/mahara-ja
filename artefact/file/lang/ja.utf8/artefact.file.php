 ...
 * @updated    2009-01-05 07:06:43 UTC
...
$string['filetypedescription'] = '<p>あなたはここでユーザがアップロードできるファイルを設定することができます。この設定ではどのようなファイルをアップロードするかコントロールします。あなたがウイルスチェックを有効にしている場合、アップロードするファイルの種類と共にウイルスもチェックします。</p><p>「不明なアプリケーション」はいくつかのムービーファイルおよびアーカイブファイル (gzip等) をアップロードするため必要ですので注意してください。<p>';
$string['folder'] = 'フォルダ';
