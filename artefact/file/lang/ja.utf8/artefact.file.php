 ...
 * @updated    2026-06-04 06:02:02 UTC
...
$string['pluginconfig.updateuserquotas_help'] = '<h1>アカウントクオータを更新する</h1><p>上のデフォルトクォータを既存のすべてのアカウントに適用します。</p>';
$string['institutionoverride1'] = 'インスティテューションオーバーライド';
$string['pluginconfig.institutionaloverride_help'] = '<h1>インスティテューションオーバーライド</h1><p>この機能を有効にした場合、インスティテューション管理者はアカウントごとにファイルクオータを設定したり、インスティテューションのデフォルトのクオータを設定できるようになります。</p>';
$string['maxquotaenabled'] = 'サイト全体の最大クオータ';
...
$string['pluginconfig.maxquotaenabled_help'] = '<h1>サイト全体の最大クオータ</h1><p>管理者が割り当てられる最大クォータを設定します。既存のアカウントのクォータには影響しません。</p>';
...
$string['pluginconfig.updategroupquotas_help'] = '上のデフォルトのクォータを既存のすべてのグループに適用します。';
...
$string['filespagedescription2'] = 'あなたのファイルを管理します。ファイルまたはフォルダのアイコンを別のフォルダのアイコンの上にドラッグ&ドロップして移動できます。';
$string['groupfilespagedescription2'] = 'ファイルまたはフォルダのアイコンを別のフォルダのアイコンの上にドラッグ&ドロップして移動できます。';
$string['institutionfilespagedescription3'] = 'このインスティテューションのファイルを管理します。インスティテューションメンバもこれらを利用できます。';
...
$string['usecustomagreement'] = 'カスタム同意';
$string['pluginconfig.usecustomagreement_help'] = '<h1>カスタム同意</h1>
<p>この設定を有効にした場合、以下にあなたのテキストを入力してください。ファイルをアップロードする際にすべての人に表示されます。</p>';
...
$string['pluginconfig.quotanotifylimit_help'] = '<h1>クオータ通知閾値</h1><p>人のクオータがこの割合に達した場合、その人 (および設定によりサイト管理者) に通知が送信されます。人はファイルを削除して空き容量を確保するか、管理者に連絡してクオータの増量を依頼できます。</p>';
$string['quotanotifyadmin1'] = 'サイト管理者通知';
$string['pluginconfig.quotanotifyadmin_help'] = '<h1>サイト管理者通知</h1><p>この設定を有効にした場合、人がクオータ通知閾値に達した際にサイト管理者に通知されます。</p>';
...
$string['profileicons_help'] = '<h1>プロファイル画像</h1><p>サイト内のあなたの氏名横に表示されるプロファイル画像を最大5枚 (16×16～1170×1170ピクセル) までアップロードしてください。</p><p>デフォルトのプロファイル画像は他の人に表示されます。その他の画像はあなたのページで使用できます。プロファイル画像はあなたのファイルクオータの制限にカウントされます。</p>';
...
$string['imagetitle_help'] = '<h1>イメージタイトル</h1><p>ページの「個人情報」セクションであなたのプロファイル画像を選択した場合、イメージタイトルが表示されます。</p>';
$string['standardavatartitle'] = '標準または外部アバタ';
$string['standardavatarnote1'] = '標準または外部プロファイル画像をデフォルトに設定する';
$string['standardavatarnote_delete'] = '標準または外部プロファイル画像は削除できません。';
...
$string['total_files_folders'] = '合計 %s, %s';
...
$string['pluginconfig.folderdownloadzip_help'] = '<h1>フォルダをZIPファイルとしてダウンロードする</h1><p>この設定を有効にした場合、閲覧者は「フォルダ」セクションに表示されているフォルダをZIPファイルとしてダウンロードできるようになります。</p>';
$string['instconf.folderdownloadzip_help'] = '<h1>ダウンロードリンクを表示する</h1><p>この設定を有効にした場合、閲覧者はこのフォルダをZIPファイルとしてダウンロードできるようになります。</p>';
...
$string['notrendertopdffiles'] = 'ァイルが追加されました:';
...
$string['index_help'] = '<h1>ファイル</h1>
<p>あなたのポートフォリオで使用するファイルおよびフォルダをここで保存および整理してください。</p><p>あなたは一度に複数のファイルをアップロードできます。また、ファイルおよびフォルダをドラッグ＆ドロップして整理し直しできます。</p>';
$string['sitefiles_help'] = '<h1>サイトファイル</h1>
<p>サイトファイルは個人ファイルと同様に機能しますが、すべてのアカウント保持者が利用できます。「public」フォルダ内のファイルはURL経由で誰でもアクセスできます。</p>';
$string['groupfiles_help'] = '<h1>グループファイル</h1>
<p>グループに追加されたファイルは通常すべてのグループメンバが利用可能です。また、グループポートフォリオ、フォーラム投稿およびパーソナルポートフォリオで使用できます。グループポートフォリオまたはパーソナルポートフォリオで使用されているグループファイルが削除された場合、そのポートフォリオでは利用できなくなります。</p>';
$string['isdecorative_help'] = '<h1>装飾イメージ</h1>
<p>あなたはイメージが装飾目的のみであるかどうか指定できます。これはaltテキストが空になるため、スクリーンリーダが無視することを意味します。また、キャプションも表示されません。</p><hr><h2>詳細</h2>
...
$string['pluginconfig.profileiconwidth_help'] = 'プロファイル画像の最大幅 (ピクセル) です。プロファイル画像エリアにアップロードされた画像すべてはこのサイズにリサイズされます。';
$string['pluginconfig.profileiconheight_help'] = '<h1>高さ</h1>
<p>プロファイル画像の最大高 (ピクセル) です。プロファイル画像エリアにアップロードされた画像すべてはこのサイズにリサイズされます。</p>';
$string['files_filebrowser.resizeonuploaduseroption_help'] = '<h1>アップロード時に大きなイメージをリサイズする</h1>
<p>この設定を有効にした場合、指定したサイズを超えるイメージはアップロード時にリサイズされます。大きなイメージは読み込みに時間を要します。また、あなたのクオータをすぐに使い切ってしまうため、ブラウザで表示するイメージにはこの設定をお勧めします。</p><p>一般的な画面では画質の低下は目立ちません。あなたが印刷用にイメージを共有する場合、サイズを変更せずにアップロードしてください。あなたはアカウント設定でこのオプションのデフォルト設定を変更できます。</p>';
$string['files_filebrowser_edit_license_help'] = '<h1>ライセンス</h1>
<p>あなたがアップロードまたは作成するコンテンツのライセンスを選択してください。</p>
<hr>
<h2>詳細</h2>
<p>あなた自身のコンテンツに関して、他の人がどのように再利用できるか選択してください。他の人が作成したコンテンツに関して、あなたが再利用を許可されているライセンスを選択してください。</p>
<p>不明な点がある場合、コンテンの作成者またはあなたの組織にご確認ください。デフォルトのライセンスは標準的な著作権 (「All rights reserved」) ですが、あなたの組織によっては異なるライセンスが求められる場合があります。判断に迷う場合、あなたの組織の法務部門にご相談ください。</p>';
$string['addactivities_filebrowser_license_help'] = '<h1>ライセンス</h1>
<p>あなたがアップロードまたは作成するコンテンツのライセンスを選択してください。</p>
<hr>
<h2>詳細</h2>
<p>あなた自身のコンテンツに関して、他の人がどのように再利用できるか選択してください。他の人が作成したコンテンツに関して、あなたが再利用を許可されているライセンスを選択してください。</p>
<p>不明な点がある場合、コンテンの作成者またはあなたの組織にご確認ください。デフォルトのライセンスは標準的な著作権 (「All rights reserved」) ですが、あなたの組織によっては異なるライセンスが求められる場合があります。判断に迷う場合、あなたの組織の法務部門にご相談ください。</p>';
$string['edittopic_filebrowser.edittopic_filebrowser_license_help'] = '<h1>ライセンス</h1>
<p>あなたがアップロードまたは作成するコンテンツのライセンスを選択してください。</p>
<hr>
<h2>詳細</h2>
<p>あなた自身のコンテンツに関して、他の人がどのように再利用できるか選択してください。他の人が作成したコンテンツに関して、あなたが再利用を許可されているライセンスを選択してください。</p>
<p>不明な点がある場合、コンテンの作成者またはあなたの組織にご確認ください。デフォルトのライセンスは標準的な著作権 (「All rights reserved」) ですが、あなたの組織によっては異なるライセンスが求められる場合があります。判断に迷う場合、あなたの組織の法務部門にご相談ください。</p>';
$string['files_filebrowser.files_filebrowser_license_help'] = '<h1>ライセンス</h1>
<p>あなたがアップロードまたは作成するコンテンツのライセンスを選択してください。</p>
<hr>
<h2>詳細</h2>
<p>あなた自身のコンテンツに関して、他の人がどのように再利用できるか選択してください。他の人が作成したコンテンツに関して、あなたが再利用を許可されているライセンスを選択してください。</p>
