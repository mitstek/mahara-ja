 ...
 * @updated    2016-09-06 13:36:11 UTC
...
$string['resizeonuploadenabledescription2'] = 'この設定を有効にした場合、最大幅および高さ設定を超える場合、アップロード時にイメージをリサイズします。';
...
$string['updateuserquotasdesc1'] = 'この設定を有効にした場合、あなたが上で選択したデフォルトクオータを既存のユーザすべてに適用します。';
$string['institutionoverride1'] = 'インスティテューションオーバーライド';
$string['institutionoverridedescription1'] = 'この設定を有効にした場合、インスティテューション管理者がユーザファイルクオータおよびそれぞれのインスティテューションのデフォルトクオータを設定できるようにします。';
...
$string['updategroupquotasdesc1'] = 'この設定を有効にした場合、あなたが上で選択したデフォルトクオータを既存のグループすべてに適用します。';
...
$string['quotanotifyadmindescr2'] = 'この設定を有効にした場合、ユーザが通知閾値に達した時点でサイト管理者に通知します。';
...
$string['downloadfolderzipdescription2'] = 'この設定を有効にした場合、ユーザは「フォルダ」ブロックに表示されたフォルダをZIPファイルとしてダウンロードできます。';
