 ...
 * @updated    2016-09-06 13:40:17 UTC
...
$string['fileinstructions'] = 'ページに含めるためあなたのイメージ、ドキュメントまたは他のファイルをアップロードしてください。ファイルまたはフォルダを移動するにはフォルダ上にドラッグ&ドロップしてください。';
...
$string['uploadedprofileiconsuccessfully'] = '新しいプロファイル画像が正常にアップロードされました。';
...
$string['profileiconsdeletedsuccessfully'] = 'プロファイル画像が正常に削除されました。';
