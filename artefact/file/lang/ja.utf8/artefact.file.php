 ...
 * @updated    2016-09-06 13:44:20 UTC
...
$string['defaultquotadescription'] = 'あなたは新しいユーザがクオータとして持つことのできるディスクスペース総量をここで設定できます。既存のユーザのクオータは変更されません。';
...
$string['fileattached'] = 'このファイルはあなたのポートフォリオにある他の %s 件のアイテムに添付されています。';
...
$string['fileinstructions'] = 'ビューに含めるためあなたのイメージ、ドキュメントまたは他のファイルをアップロードしてください。ファイルまたはフォルダを移動するにはフォルダ上にドラッグ&ドロップしてください。';
...
$string['mpg'] = 'MPGムービ';
$string['ram'] = 'RAM Real Playerムービ';
$string['rpm'] = 'RPM Real Playerムービ';
$string['rm'] = 'RM Real Playerムービ';
$string['cantcreatetempprofileiconfile'] = '一時プロファイルアイコンイメージを %s に書き込めませんでした。';
...
$string['onlyfiveprofileicons'] = 'あなたは5つのプロファイルアイコンのみアップロードできます。';
$string['or'] = 'または';
$string['profileiconuploadexceedsquota'] = 'このプロファイルアイコンをアップロードすることであなたのディスククオータを超えてしまいます。あなたがアップロードしたファイルの一部を削除してください。';
...
$string['profileiconsiconsizenotice'] = 'あなたは最大<strong>5つ</strong>のプロファイルアイコンをアップロードできます。アイコンのアップロード後、あなたのデフォルトアイコンとして表示するアイコンを1つ選択してください。16x16 から%sx%s ピクセルの間であなたのアイコンを作成してください。';
