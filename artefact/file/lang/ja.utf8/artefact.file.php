...
$string['quotanotifylimitdescr1'] = 'ユーザのアップロードクオータがこのパーセンテージまで満杯になった場合、ユーザ (およびサイト管理者) にアップロード制限に到達しようとしている旨、通知が送信されます。ユーザはスペースを空けるためファイルを削除またはクオータを増やすよう管理者に連絡できます。';
