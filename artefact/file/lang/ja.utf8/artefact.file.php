...
$string['filetypedescription'] = '<p>あなたはここでユーザがアップロードできるファイルを設定できます。この設定ではどのようなファイルをアップロードするかコントロールします。あなたがウイルスチェックを有効にしている場合、アップロードするファイルの種類と共にウイルスもチェックします。</p><p>「不明なアプリケーション」は一部のムービファイルおよびアーカイブファイル (gzip等) をアップロードするため必要ですので注意してください。<p>';
$string['folder'] = 'フォルダ';
