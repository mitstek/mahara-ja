...
$string['quotanotifylimitdescr1'] = 'ユーザのアップロードクオータがこのパーセンテージまで満杯になった場合、アップロード制限に到達しようとしている旨、ユーザ (およびサイト管理者) に通知が送信されます。ユーザはスペースを空けるためファイルを削除するかクオータを増やすよう管理者に連絡できます。';
