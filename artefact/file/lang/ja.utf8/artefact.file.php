 ...
 * @updated    2016-09-06 13:39:47 UTC
...
$string['updateuserquotasdesc'] = 'この設定を有効にした場合、あなたが上で選択したデフォルトクオータが既存のユーザすべてに適用されます。';
...
$string['defaultgroupquotadescription'] = 'あなたは新しいグループがファイルエリアで使用できるディスクスペース容量を設定することができます。';
$string['updategroupquotas'] = 'グループクオータを更新する';
$string['updategroupquotasdesc'] = 'この設定を有効にした場合、あなたが上で選択したデフォルトクオータを既存のグループすべてに適用します。';
$string['deletingfailed'] = '削除に失敗しました: すでにファイルまたはフォルダは存在しません。';
...
$string['editingfailed'] = '編集に失敗しました: すでにファイルまたはフォルダは存在しません。';
...
$string['fileexistsoverwritecancel'] = 'このファイル名のファイルはすでに存在します。あなたは別のファイル名にするか既存のファイルに上書きすることができます。';
$string['filelistloaded'] = 'ファイルリストが読み込まれました。';
$string['filemoved'] = 'ファイルが正常に移動されました。';
$string['filenamefieldisrequired'] = 'ファイルフィールドは必須入力です。';
$string['fileinstructions'] = 'ページに含めるためあなたのイメージ、ドキュメントまたは他のファイルをアップロードしてください。あなたは一度にアップロードするため複数のファイルを選択することができます。フォルダを移動するにはフォルダ上にドラッグ&ドロップしてください。';
...
$string['Name'] = '名称';
$string['namefieldisrequired'] = '名称フィールドは必須入力です。';
...
$string['movingfailed'] = '移動に失敗しました: すでにファイルまたはフォルダは存在しません。';
...
$string['removingfailed'] = '削除に失敗しました: すでにファイルまたはフォルダは存在しません。';
$string['savechanges'] = '変更を保存する';
$string['selectafile'] = 'ファイルを選択する';
$string['selectingfailed'] = '選択に失敗しました: すでにファイルまたはフォルダは存在しません。';
$string['Size'] = 'サイズ';
$string['spaceused'] = '使用済みスペース';
$string['timeouterror'] = 'ファイルのアップロードに失敗しました: ファイルのアップロードを再度お試しください。';
$string['title'] = '名称';
$string['titlefieldisrequired'] = '名称フィールドは必須入力です。';
$string['Type'] = 'タイプ';
...
$string['uploadfileexistsoverwritecancel'] = 'この名称のファイルはすでに存在します。あなたがアップロードしようとしているファイルをリネームするか既存のファイルに上書きすることができます。';
...
$string['cantcreatetempprofileiconfile'] = '一時プロファイル画像イメージを %s に書き込むことができませんでした。';
...
$string['onlyfiveprofileicons'] = 'あなたは5つのプロファイル画像のみアップロードすることができます。';
$string['or'] = 'または';
