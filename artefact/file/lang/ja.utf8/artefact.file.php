...
$string['defaultquotadescription'] = 'あなたは新しいユーザがクオータとして持つことのできるディスクスペース総量をここで設定することができます。既存のユーザのクオータは、変更されません。';
...
$string['fileexistsoverwritecancel'] = 'このファイル名のファイルは、すでに登録されています。あなたは別のファイル名にするか、既存のファイルに上書きすることができます。';
...
$string['filetypedescription'] = '<p>あなたはここでユーザがアップロードできるファイルを設定することができます。この設定では、どのようなファイルをアップロードするかコントロールします。あなたがウイルスチェックを有効にしている場合、アップロードするファイルの種類と共にウイルスもチェックします。</p><p>「不明なアプリケーション」は、いくつかのムービーファイルおよびアーカイブファイル (gzip等) をアップロードするため必要ですので、注意してください。<p>';
$string['folder'] = 'フォルダ';
