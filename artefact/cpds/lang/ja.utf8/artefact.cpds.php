 ...
 * @updated    2026-05-29 05:32:57 UTC
...
$string['location'] = '場所';
$string['location_help'] = '<h1>場所</h1><p>CPD活動にはどこで参加しましたか? オンラインでも、実際の場所でも構いません。</p>';
$string['organisation'] = '組織';
$string['organisation_help'] = '<h1>組織</h1><p>あなたが活動を完了した組織の名称を入力してください。</p>';
$string['contactname'] = '担当者';
$string['contactname_help'] = '<h1>担当者</h1><p>この活動に関する連絡先となる人の氏名を入力してください。</p>';
$string['contacttitle'] = '担当者役職';
$string['contacttitle_help'] = '<h1>担当者役職</h1><p>担当者の役職を入力してください (例: プロジェクトマネージャ、プロダクトマネージャ、スーパーバイザ)。</p>';
$string['contactemail'] = '担当者メール';
$string['contactemail_help'] = '<h1>担当者メール</h1><p>担当者のメールアドレスを入力してください。</p>';
$string['contactphone'] = '担当者電話番号';
$string['contactphone_help'] = '<h1>担当者電話番号</h1><p>担当者の電話番号を入力してください。</p>';
