...
$string['mycpds'] = '継続的専門能力開発';
$string['newcpd'] = '新しいCPD活動';
$string['nocpdsselectone'] = 'CPD活動が選択されていません。表示するCPD活動を作成および選択してください。';
$string['cpd'] = 'CPD';
$string['cpds'] = 'CPD';
...
$string['noactivitiesaddone'] = 'まだCPDはありません。%s追加してください%s!';
...
$string['progress_cpdactivity'] = '%s のCPD活動を追加する';
