 ...
 * @updated    2026-05-26 07:32:14 UTC
...
$string['addactivities.experience_help'] = '<h1>体験</h1>
<p>あなたが活動内容を表示したいCPD体験を選択してください。</p>
<hr>
<h2>詳細</h2><p>あなたが特定のCPD活動に対して時間を登録している場合、ここでその活動を絞り込むことで必要時間数および完了時間数が自動的に表示されます。</p>
<p>情報はテーブルに表示されるため、あなたは追加した詳細すべてを確認できます。あなたの体験の進捗状況をより視覚的に把握したい場合、「CPD概要」セクションをページに配置してください。</p>';
$string['addactivities.category_help'] = '<h1>カテゴリ</h1>
<p>あなたの完了時間を表示したいカテゴリを選択してください。カテゴリを選択しない場合、あなたが選択した体験全体の時間が表示されます。</p>
<hr>
