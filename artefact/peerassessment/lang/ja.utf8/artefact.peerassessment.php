 ...
 * @updated    2026-05-21 00:05:58 UTC
...
$string['assessmentsubmitted1'] = 'あなたの評価が保存されました。';
$string['reallydeletethisassessment1'] = 'この評価を削除する';
$string['thisassessmentisprivate'] = '下書きとして保存されました。';
$string['assessmentremoved1'] = 'あなたの評価が削除されました。';
$string['assessmentremovedfailed1'] = 'あなたの評価を削除できませんでした。';
...
$string['verifypages'] = 'ページを検証する';
$string['progress_peerassessment'] = '%s 相互評価をページに追加する';
$string['progress_verify'] = '他の人の相互評価ページに %s 確認を与える';
$string['importedassessment'] = 'インポート済み相互評価';
$string['typeassessmentfeedback_help'] = '<h1>相互評価</h1><p>「評価」セクションにおける新しい相互評価の通知です。</p>';
