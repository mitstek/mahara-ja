 ...
 * @updated    2023-03-13 04:29:15 UTC
...
$string['multirecipientnotificationnotenabled'] = 'モジュール「multirecipientnotification」をインストールおよび有効化する必要があります。あなたが16.10.0より古いバージョンからMaharaをアップグレードしている場合、この部分を最初にアップグレードしてください。そして「管理メニュ」 → 「拡張機能」 → 「プラグイン管理」にアクセスしてモジュールがインストールおよび有効化されていることを確認してください。';
$string['subject'] = '件名';
