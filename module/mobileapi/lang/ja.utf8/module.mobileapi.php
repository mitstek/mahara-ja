 ...
 * @updated    2026-05-22 03:51:32 UTC
...
$string['pluginconf.manualtokens_help'] = '<h1>手動トークン生成</h1><p>この設定を有効にした場合、ユーザはウェブサービスのアクセストークンを手動生成してMaharaモバイルに貼り付けできます。</p><p>通常、アプリはトークンを自動生成しますが、LTI等の一部の認証方式ではこれはサポートされていません。</p>';
...
$string['servicenotallowed'] = 'あなたが提供した認証情報ではこの機能にアクセスするための権限を付与できません。';
...
$string['mytokenspagedesc'] = 'これらのアプリケーションはあなたのアカウントにアクセスできます。';
