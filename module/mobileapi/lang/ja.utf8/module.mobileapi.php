 ...
 * @updated    2016-10-12 17:01:00 UTC
...
$string['manualtokensdesc'] = 'アプリにコピー＆ペーストするためユーザは手動でウェブサービスアクセストークンを生成できます。通常、アプリはユーザのトークンを自動生成できる必要があります。しかし、いくつかの認証プラグインでは自動生成できない場合もあります。';
