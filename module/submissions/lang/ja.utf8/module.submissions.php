 ...
 * @updated    2022-07-26 21:14:40 UTC
...
$string['releasesubmission'] = '評価を完了して提出済みポートフォリオをリリースしてもよろしいですか?';
$string['fixsubmission'] = '提出を修正してもよろしいですか?';
...
$string['submissionstatuschangedexternally'] = '提出ステータスが外部から変更されました。';
...
$string['submissionexceptionmessage'] = '次の理由のため、このポートフォリオを評価のためにに提出できません:';
