 ...
 * @updated    2024-09-16 05:14:15 UTC
...
$string['titledesc'] = 'フレームワークのタイトルは短くしてください。タイトルは人がフレークワークを選択するためのドロップダウンメニューおよびスマートエビデンスページのタイトルとして表示されます。';
...
$string['missingrecordsdb'] = 'データベースに次のレコードは見つかりませんでした: %s';
