 ...
 * @updated    2016-09-02 17:18:39 UTC
...
$string['frameworksdesc'] = 'システムにインストールされているフレームワークの一覧です。有効時にコレクションと関連付けられていない限り、無効にされたフレームワークは表示されません。';
...
$string['matrixfiledesc'] = 'JSONにエンコードされたフレームワークを含む「.matrix」ファイルです。';
...
$string['manuallyremovematrices'] = 'インストールディレクトリ「 %s 」を削除することができません。手動で削除してください。';
...
$string['annotationclash'] = 'この標準に関してすでにページにアノテーションブロックがあります。';
