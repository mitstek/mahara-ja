...
$string['monitormodulenotactive'] = 'モニタプラグインは有効ではありません。「管理メニュ」 → 「拡張機能」 → 「プラグイン管理」ページに移動してプラグインをインストールまたは有効にしてください。';
...
$string['ldapsuspendeduserstabletitle'] = '午前零時以降、LDAPユーザ同期により一時停止にできるLDAPユーザのパーセンテージ';
$string['ldapsuspendeduserspercentage'] = 'LDAP一時停止ユーザのパーセンテージ';
$string['ldapsuspendeduserspercentagedescription'] = '問題であるとフラグ付けされる前、午前零時以降、LDAPユーザ同期により一時停止にできるユーザの最大パーセンテージです。';
$string['item'] = 'アイテム';
$string['status'] = 'ステータス';
$string['details'] = '詳細';
